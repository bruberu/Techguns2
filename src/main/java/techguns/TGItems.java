...
public class TGItems implements ITGInitializer {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        ASSAULTRIFLE_MAGAZINE_EMPTY = SHARED_ITEM.addsharedVariant("assaultriflemagazineempty", true,
                TGSlotType.AMMOSLOT);
        ...
        RIFLE_ROUNDS_STACK_INCENDIARY = SHARED_ITEM.addsharedVariant("rifleroundsstack_incendiary",
                TGSlotType.AMMOSLOT);
        ...
        ASSAULTRIFLE_MAGAZINE_INCENDIARY = SHARED_ITEM.addsharedVariant("assaultriflemagazine_incendiary", true,
                TGSlotType.AMMOSLOT);
        ...
        OREDRILLHEAD_STEEL = SHARED_ITEM.addsharedVariant("oredrillsmall_steel", false, TGSlotType.DRILL_SMALL, 1,
                true);
        OREDRILLHEAD_OBSIDIANSTEEL = SHARED_ITEM.addsharedVariant("oredrillsmall_obsidiansteel", false,
                TGSlotType.DRILL_SMALL, 1, true);
        OREDRILLHEAD_CARBON = SHARED_ITEM.addsharedVariant("oredrillsmall_carbon", false, TGSlotType.DRILL_SMALL, 1,
                true);

        OREDRILLHEAD_MEDIUM_STEEL = SHARED_ITEM.addsharedVariant("oredrillmedium_steel", false, TGSlotType.DRILL_MEDIUM,
                1, true);
        OREDRILLHEAD_MEDIUM_OBSIDIANSTEEL = SHARED_ITEM.addsharedVariant("oredrillmedium_obsidiansteel", false,
                TGSlotType.DRILL_MEDIUM, 1, true);
        OREDRILLHEAD_MEDIUM_CARBON = SHARED_ITEM.addsharedVariant("oredrillmedium_carbon", false,
                TGSlotType.DRILL_MEDIUM, 1, true);

        OREDRILLHEAD_LARGE_STEEL = SHARED_ITEM.addsharedVariant("oredrilllarge_steel", false, TGSlotType.DRILL_LARGE, 1,
                true);
        OREDRILLHEAD_LARGE_OBSIDIANSTEEL = SHARED_ITEM.addsharedVariant("oredrilllarge_obsidiansteel", false,
                TGSlotType.DRILL_LARGE, 1, true);
        OREDRILLHEAD_LARGE_CARBON = SHARED_ITEM.addsharedVariant("oredrilllarge_carbon", false, TGSlotType.DRILL_LARGE,
                1, true);
        ...
        UPGRADE_PROTECTION_1 = SHARED_ITEM.addsharedVariant("upgrade_protection_1", false, TGSlotType.ARMOR_UPGRADE, 1,
                true);
        UPGRADE_PROJECTILE_PROTECTION_1 = SHARED_ITEM.addsharedVariant("upgrade_projectile_protection_1", false,
                TGSlotType.ARMOR_UPGRADE, 1, true);
        UPGRADE_BLAST_PROTECTION_1 = SHARED_ITEM.addsharedVariant("upgrade_blast_protection_1", false,
                TGSlotType.ARMOR_UPGRADE, 1, true);

        UPGRADE_PROTECTION_2 = SHARED_ITEM.addsharedVariant("upgrade_protection_2", false, TGSlotType.ARMOR_UPGRADE, 1,
                true);
        UPGRADE_PROJECTILE_PROTECTION_2 = SHARED_ITEM.addsharedVariant("upgrade_projectile_protection_2", false,
                TGSlotType.ARMOR_UPGRADE, 1, true);
        UPGRADE_BLAST_PROTECTION_2 = SHARED_ITEM.addsharedVariant("upgrade_blast_protection_2", false,
                TGSlotType.ARMOR_UPGRADE, 1, true);

        UPGRADE_PROTECTION_3 = SHARED_ITEM.addsharedVariant("upgrade_protection_3", false, TGSlotType.ARMOR_UPGRADE, 1,
                true);
        UPGRADE_PROJECTILE_PROTECTION_3 = SHARED_ITEM.addsharedVariant("upgrade_projectile_protection_3", false,
                TGSlotType.ARMOR_UPGRADE, 1, true);
        UPGRADE_BLAST_PROTECTION_3 = SHARED_ITEM.addsharedVariant("upgrade_blast_protection_3", false,
                TGSlotType.ARMOR_UPGRADE, 1, true);
    ...
    public void init(FMLInitializationEvent event) {
        ...
        setAmmoTypeEntryForMagazine(ASSAULTRIFLE_MAGAZINE_INCENDIARY, AmmoTypes.ASSAULT_RIFLE_MAGAZINE,
    ...
    public static void setAmmoTypeEntryForMagazine(ItemStack fullMag, AmmoType ammoType, String variant) {
        ...
        entry.setAmmoType(ammoType.getBullet(ammoType.getIDforVariantKey(variant))[0], ammoType.getEmptyMag()[0],
                ammoType.getBulletsPerMag());
    }
    ...
    public static boolean isMachineUpgrade(ItemStack stack) {
        return !stack.isEmpty() && stack.getItem() == SHARED_ITEM &&
                stack.getItemDamage() == MACHINE_UPGRADE_STACK.getItemDamage();
    }
}
