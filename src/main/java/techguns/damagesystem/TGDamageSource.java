...
public class TGDamageSource extends EntityDamageSource {
    ...
    /**
     * set to true when this damagesource was converted from another damage source, with new TGDamageSource(DamageSource
     * src)
     */
    ...
    public static TGDamageSource causeLethalRadPoisoningDamage(Entity projectile, Entity shooter, DeathType deathType) {
        TGDamageSource src = new TGDamageSource("tg_rad_poisoning", projectile, shooter, DamageType.UNRESISTABLE,
                deathType);
        src.ignoreHurtresistTime = true;
        src.knockbackOnShieldBlock = false;
        src.goreChance = 1.0f;
    ...
    public ITextComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
        ...
        if (this.attacker == null && this.damageSourceEntity == null) {
            ...
            itextcomponent = this.attacker == null ? this.damageSourceEntity.getDisplayName() :
                    this.attacker.getDisplayName();
            itemstack = this.attacker instanceof EntityLivingBase ?
                    ((EntityLivingBase) this.attacker).getHeldItemMainhand() : ItemStack.EMPTY;
        }
    ...
    public static TGDamageSource copyWithNewEnt(TGDamageSource other, Entity damagingEntity, Entity attacker) {
        TGDamageSource newSrc = new TGDamageSource(other.getDamageType(), damagingEntity, attacker, other.damageType,
                other.deathType);
    ...
    public TGDamageSource(String name, Entity damagingEntity, Entity attacker, DamageType damageType,
                          DeathType deathType) {
