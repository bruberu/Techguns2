...
public class TGFluids implements ITGInitializer {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        addedAcid = FluidRegistry
                .registerFluid(new Fluid("creeper_acid", new ResourceLocation(Techguns.MODID, "blocks/acid_still"),
                        new ResourceLocation(Techguns.MODID, "blocks/acid_flow")).setGaseous(false).setLuminosity(0)
                                .setUnlocalizedName("creeperAcid").setDensity(100));
        ACID = FluidRegistry.getFluid("creeper_acid");
        if (addedAcid) {

            BLOCK_FLUID_ACID = new BlockFluidAcid(ACID, Material.WATER)
                    .setRegistryName(new ResourceLocation(Techguns.MODID, "block_creeper_acid"))
                    .setTranslationKey(Techguns.MODID + ".block_creeper_acid").setCreativeTab(Techguns.tabTechgun);
        }

        addedMilk = FluidRegistry
                .registerFluid(new Fluid("milk", new ResourceLocation(Techguns.MODID, "blocks/milk_still"),
                        new ResourceLocation(Techguns.MODID, "blocks/milk_flow")).setUnlocalizedName("milk"));
        MILK = FluidRegistry.getFluid("milk");
        if (addedMilk) {
            BLOCK_FLUID_MILK = new BlockFluidAcid(MILK, Material.WATER)
                    .setRegistryName(new ResourceLocation(Techguns.MODID, "block_milk"))
    ...
    public static void RecipeInit() {
         ...
         * FluidContainerRegistry.registerFluidContainer(FluidRegistry.getFluidStack("milk",
