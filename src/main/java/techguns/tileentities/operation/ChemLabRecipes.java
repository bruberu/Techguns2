...
public class ChemLabRecipes {
    ...
    public static void addRecipe(ItemStack input1, int amount1, ItemStack input2, int amount2, ItemStack bottle,
                                 int amount3, FluidStack fluidIn, FluidStack fluidOut, ItemStack output, boolean swap,
                                 int power) {
        recipes.add(new ChemLabRecipe(new ItemStackOreDict(input1), amount1, new ItemStackOreDict(input2), amount2,
                bottle, amount3, fluidIn, swap, output, fluidOut, power));
    }

    public static void addRecipe(String input1, int amount1, String input2, int amount2, ItemStack bottle, int amount3,
                                 FluidStack fluidIn, FluidStack fluidOut, ItemStack output, boolean swap, int power) {
        recipes.add(new ChemLabRecipe(new ItemStackOreDict(input1), amount1, new ItemStackOreDict(input2), amount2,
                bottle, amount3, fluidIn, swap, output, fluidOut, power));
    }

    public static void addRecipe(String input1, int amount1, ItemStack input2, int amount2, ItemStack bottle,
                                 int amount3, FluidStack fluidIn, FluidStack fluidOut, ItemStack output, boolean swap,
                                 int power) {
        recipes.add(new ChemLabRecipe(new ItemStackOreDict(input1), amount1, new ItemStackOreDict(input2), amount2,
                bottle, amount3, fluidIn, swap, output, fluidOut, power));
    ...
    public static void addRecipe(ItemStack input1, int amount1, String input2, int amount2, ItemStack bottle,
                                 int amount3, FluidStack fluidIn, FluidStack fluidOut, ItemStack output, boolean swap,
                                 int power) {
        recipes.add(new ChemLabRecipe(new ItemStackOreDict(input1), amount1, new ItemStackOreDict(input2), amount2,
                bottle, amount3, fluidIn, swap, output, fluidOut, power));
    ...
    public static void addRecipe(ItemStackOreDict input1, int amount1, ItemStackOreDict input2, int amount2,
                                 ItemStack bottle, int amount3, FluidStack fluidIn, FluidStack fluidOut,
                                 ItemStack output, boolean swap, int power) {
        recipes.add(new ChemLabRecipe(input1, amount1, input2, amount2, bottle, amount3, fluidIn, swap, output,
                fluidOut, power));
    }
    ...
    public static class ChemLabRecipe implements IMachineRecipe {
        ...
        public boolean isItemPartOfRecipe(ItemStack item) {
            return (!this.slot1.isEmpty() && this.slot1.isEqualWithOreDict(item)) ||
                    (!this.slot2.isEmpty() && this.slot2.isEqualWithOreDict(item)) ||
                    (!this.slot3.isEmpty() && ItemUtil.isItemEqual(this.slot3, item));
        }

        public ChemLabRecipe(ItemStackOreDict slot1, int amount1, ItemStackOreDict slot2, int amount2, ItemStack bottle,
                             int amount3, FluidStack fluidIn,
        ...
        public ChemRecipeType isValidInput(ItemStack slot1, ItemStack slot2, ItemStack slot3, FluidStack fluidIn) {
            ...
            if (this.slot1.isEqualWithOreDict(slot1) && this.slot2.isEqualWithOreDict(slot2) &&
                    ((!this.slot3.isEmpty() && OreDictionary.itemMatches(this.slot3, slot3, true)) ||
                            (this.slot3.isEmpty() && slot3.isEmpty()))) {
        ...
        private boolean checkAmounts(ItemStack slot1, ItemStack slot2, ItemStack slot3, boolean swapped12) {
            ...
            return isEnoughOrNull(i1, this.amounts[0]) && isEnoughOrNull(i2, this.amounts[1]) &&
                    isEnoughOrNull(slot3, this.amounts[2]);
        }
