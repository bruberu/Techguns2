...
public class BlastFurnaceRecipes {
    ...
    public static void addRecipe(ItemStack slot1, ItemStack slot2, ItemStack output, int powerPerTick, int duration) {
        recipes.add(new BlastFurnaceRecipe(new ItemStackOreDict(slot1), slot1.getCount(), new ItemStackOreDict(slot2),
                slot2.getCount(), output, powerPerTick, duration));
    }

    public static void addRecipe(String slot1, int amount1, ItemStack slot2, ItemStack output, int powerPerTick,
                                 int duration) {
        recipes.add(new BlastFurnaceRecipe(new ItemStackOreDict(slot1, amount1), amount1, new ItemStackOreDict(slot2),
                slot2.getCount(), output, powerPerTick, duration));
    }

    public static void addRecipe(ItemStack slot1, String slot2, int amount2, ItemStack output, int powerPerTick,
                                 int duration) {
        recipes.add(new BlastFurnaceRecipe(new ItemStackOreDict(slot1), slot1.getCount(),
                new ItemStackOreDict(slot2, amount2), amount2, output, powerPerTick, duration));
    }

    public static void addRecipe(String slot1, int amount1, String slot2, int amount2, ItemStack output,
                                 int powerPerTick, int duration) {
        recipes.add(new BlastFurnaceRecipe(new ItemStackOreDict(slot1, amount1), amount1,
                new ItemStackOreDict(slot2, amount2), amount2, output, powerPerTick, duration));
    }
