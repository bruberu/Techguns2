...
public class AmmoPressBuildPlans {
    ...
    public static void init(ArrayList<String> metal1_names, ArrayList<String> metal2_names,
                            ArrayList<String> powder_names) {
    ...
    public static ItemStack[] getPossibleResults() {
        return new ItemStack[] { TGItems.newStack(TGItems.PISTOL_ROUNDS, AMMOUNT_PISTOL),
                TGItems.newStack(TGItems.SHOTGUN_ROUNDS, AMMOUNT_SHOTGUN),
                TGItems.newStack(TGItems.RIFLE_ROUNDS, AMMOUNT_RIFLE),
                TGItems.newStack(TGItems.SNIPER_ROUNDS, AMMOUNT_SNIPER) };
    }
    ...
    public static ItemStack getOutputFor(ItemStack metal1, ItemStack metal2, ItemStack powder, int plan) {
        if (isValidFor(metal1, 0) && isValidFor(metal2, 1) && isValidFor(powder, 2)) {
            ...
            if (metal1.getCount() >= 1 && metal2.getCount() >= 2 && powder.getCount() >= 1) {
                ...
                switch (plan) {
                    case 0:
                        return new ItemStack(TGItems.PISTOL_ROUNDS.getItem(), AMMOUNT_PISTOL,
                                TGItems.PISTOL_ROUNDS.getItemDamage());
                    case 1:
                        return new ItemStack(TGItems.SHOTGUN_ROUNDS.getItem(), AMMOUNT_SHOTGUN,
                                TGItems.SHOTGUN_ROUNDS.getItemDamage());
                    case 2:
                        return new ItemStack(TGItems.RIFLE_ROUNDS.getItem(), AMMOUNT_RIFLE,
                                TGItems.RIFLE_ROUNDS.getItemDamage());
                    case 3:
                        return new ItemStack(TGItems.SNIPER_ROUNDS.getItem(), AMMOUNT_SNIPER,
                                TGItems.SNIPER_ROUNDS.getItemDamage());
                }
    ...
    public static class AmmoPressMachineRecipe implements IMachineRecipe {
        ...
        public List<List<ItemStack>> getItemOutputs() {
            ...
            switch (plan) {
                case 0:
                    stack = new ItemStack(TGItems.PISTOL_ROUNDS.getItem(), AMMOUNT_PISTOL,
                            TGItems.PISTOL_ROUNDS.getItemDamage());
                    break;
                case 1:
                    stack = new ItemStack(TGItems.SHOTGUN_ROUNDS.getItem(), AMMOUNT_SHOTGUN,
                            TGItems.SHOTGUN_ROUNDS.getItemDamage());
                    break;
                case 2:
                    stack = new ItemStack(TGItems.RIFLE_ROUNDS.getItem(), AMMOUNT_RIFLE,
                            TGItems.RIFLE_ROUNDS.getItemDamage());
                    break;
                case 3:
                    stack = new ItemStack(TGItems.SNIPER_ROUNDS.getItem(), AMMOUNT_SNIPER,
                            TGItems.SNIPER_ROUNDS.getItemDamage());
                    break;
            }
            output.add(stack);
