...
@Mod(modid = Techguns.MODID,
     version = Techguns.VERSION,
     name = Techguns.NAME,
     acceptedMinecraftVersions = Techguns.MCVERSION,
     guiFactory = Techguns.GUI_FACTORY,
     updateJSON = Techguns.UPDATEURL,
     dependencies = Techguns.DEPENDENCIES)
public class Techguns {
    ...
    public static final String DEPENDENCIES = "required:forge@[" + FORGE_BUILD +
            ",);after:ftblib;after:chisel;after:patchouli";
    ...
    public void preinit(FMLPreInitializationEvent event) {
        ...
        if (TGConfig.doOreGenTitanium || TGConfig.doOreGenUranium || TGConfig.doOreGenLead || TGConfig.doOreGenTin ||
                TGConfig.doOreGenCopper) {
