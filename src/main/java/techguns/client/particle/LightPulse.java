...
public class LightPulse {
    ...
    public LightPulse(double x, double y, double z, int fade_in, int fade_out, float rad_large, float rad_small,
    ...
    public LightPulse(double x, double y, double z, int lifetime, float rad_start, float rad_end, float r, float g,
                      float b) {
        this.fade_in = 0;
