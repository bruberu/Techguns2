...
public class DeathEffect {
    ...
    static {
        ...
        goreStats.put(EntityVillager.class,
                (new GoreData(new ModelGibsVillager(new ModelVillager(0.0f)), 150, 21, 51)));
        goreStats.put(EntityCow.class, (new GoreData(new ModelGibsQuadruped(new ModelCow()), 170, 26, 37)));
        goreStats.put(EntitySheep.class,
                (new GoreData(new ModelGibsQuadruped(new ModelSheep1()), 170, 26, 37)).setFXscale(0.8f));
        goreStats.put(EntityChicken.class,
                (new GoreData(new ModelGibsGeneric(new ModelChicken()), 170, 26, 37)).setFXscale(0.5f));
        ...
        goreStats.put(EntityPig.class,
                (new GoreData(new ModelGibsQuadruped(new ModelPig()), 170, 26, 37)).setFXscale(0.8f));
        goreStats.put(EntitySpider.class, (new GoreData(new ModelGibsGeneric(new ModelSpider()), 85, 156, 17)));
        goreStats.put(EntityCaveSpider.class,
                (new GoreData(new ModelGibsGeneric(new ModelSpider()), 85, 156, 17)).setFXscale(0.7f));
        //
        ...
        goreStats.put(SuperMutantBasic.class,
                (new GoreData(new ModelGibsBiped(new ModelSuperMutant()), 109, 60, 25)).setFXscale(1.2f));
        goreStats.put(SuperMutantElite.class,
                (new GoreData(new ModelGibsBiped(new ModelSuperMutant()), 109, 60, 25)).setFXscale(1.2f));
        goreStats.put(SuperMutantHeavy.class,
                (new GoreData(new ModelGibsBiped(new ModelSuperMutant()), 109, 60, 25)).setFXscale(1.2f));
        ...
        goreStats.put(EntityEvoker.class,
                (new GoreData(new ModelGibsIllager(new ModelIllager(0.0F, 0.0F, 64, 64)), 110, 21, 41)));
        goreStats.put(EntityHusk.class, (new GoreData(modelBiped, 110, 21, 41)));
        goreStats.put(EntityPolarBear.class,
                (new GoreData(new ModelGibsQuadruped(new ModelPolarBear()), 170, 26, 37)).setFXscale(0.8f));
        goreStats.put(EntityMagmaCube.class, (new GoreData(new ModelGibsSlime(), 92, 26, 0)));
        goreStats.put(EntityParrot.class,
                (new GoreData(new ModelGibsGeneric(new ModelParrot()), 170, 26, 37)).setFXscale(0.5f));
        goreStats.put(EntityRabbit.class,
                (new GoreData(new ModelGibsGeneric(new ModelRabbit()), 170, 26, 37)).setFXscale(0.3f));
        goreStats.put(EntityStray.class, (new GoreData(new ModelGibsBiped(new ModelSkeleton()), 255, 255, 255)));
        goreStats.put(EntitySilverfish.class,
                (new GoreData(new ModelGibsGeneric(new ModelSilverfish()), 90, 16, 27)).setFXscale(0.4f));
        goreStats.put(EntityVindicator.class,
                (new GoreData(new ModelGibsIllager(new ModelIllager(0.0F, 0.0F, 64, 64)), 110, 21, 41)));
        ...
        goreStats.put(EntityWitherSkeleton.class,
                (new GoreData(new ModelGibsBiped(new ModelSkeleton()), 50, 50, 50).setFXscale(1.4f)));
        ...
        genericGore = (new GoreData(modelBiped, 160, 21, 31))
                .setTexture(new ResourceLocation(Techguns.MODID, "textures/entity/gore.png"));
        genericGore.setRandomScale(0.5f, 0.8f);
        // ModelHorse horse = new ModelHorse();
        // goreStats.put(EntityHorse.class, new GoreData(new ModelGibsHorse(horse), horse.boxList.size(), new
        // ResourceLocation("textures/entity/horse/horse_brown.png"), 0.66f, 150,21,51));
    }
    ...
    public static void createDeathEffect(EntityLivingBase entity, DeathType deathtype, float motionX, float motionY,
                                         float motionZ) {
        // GetEntityType
