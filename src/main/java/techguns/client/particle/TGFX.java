...
public class TGFX {
    ...
    public static List<TGParticleSystem> createFX(World world, String fx, double posX, double posY, double posZ,
                                                  double motionX, double motionY, double motionZ) {
        if (FXList.containsKey(fx.toLowerCase())) {
            TGFXType fxtype = FXList.get(fx.toLowerCase());
            List<TGParticleSystem> list = fxtype.createParticleSystems(world, posX, posY, posZ, motionX, motionY,
                    motionZ);
            return list;
        } else {
                        ...
                        if (sc.hasNext() && !(next = sc.next()).equals("")) {
                            ...
                            switch (key.toLowerCase()) {
                                ...
                                case "alpha":
                                    ...
                                    break;
                                case "color":
                                    type.colorEntries.add(
                                            new ColorEntry(sc.nextInt(), sc.nextInt(), sc.nextInt(), sc.nextFloat()));
                                    break;
                                case "particlecount":
