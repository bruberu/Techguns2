...
public class ClientProxy extends CommonProxy {
    ...
    // protected static Field ItemRender_field_itemStackMainHand = ReflectionHelper.findField(ItemRenderer.class,
    // "itemStackMainHand", "field_187467_d");
    // protected static Field ItemRender_field_itemStackOffHand = ReflectionHelper.findField(ItemRenderer.class,
    // "itemStackOffHand", "field_187468_e");

    protected GuiHandlerRegister guihandler = new GuiHandlerRegister();

    public static Field Field_ItemRenderer_equippedProgressMainhand = ObfuscationReflectionHelper
            .findField(ItemRenderer.class, "field_187469_f"); // ReflectionHelper.findField(ItemRenderer.class,
                                                              // "equippedProgressMainHand", "field_187469_f");
    public static Field Field_ItemRenderer_equippedProgressOffhand = ObfuscationReflectionHelper
            .findField(ItemRenderer.class, "field_187471_h");// ReflectionHelper.findField(ItemRenderer.class,
                                                             // "equippedProgressOffHand", "field_187471_h");
    public static Field Field_ItemRenderer_prevEquippedProgressMainhand = ObfuscationReflectionHelper
            .findField(ItemRenderer.class, "field_187470_g");// ReflectionHelper.findField(ItemRenderer.class,
                                                             // "prevEquippedProgressMainHand", "field_187470_g");
    public static Field Field_ItemRenderer_prevEquippedProgressOffhand = ObfuscationReflectionHelper
            .findField(ItemRenderer.class, "field_187472_i");// ReflectionHelper.findField(ItemRenderer.class,
                                                             // "prevEquippedProgressOffHand", "field_187472_i");

    protected static Field RenderPlayer_LayerRenderers = ObfuscationReflectionHelper.findField(RenderLivingBase.class,
            "field_177097_h");// ReflectionHelper.findField(RenderLivingBase.class, "layerRenderers", "field_177097_h");
    ...
    /*
     * public static ModelBiped[] armorModels = {new ModelSteamArmor(0), new ModelSteamArmor(1), new
     * ModelT3PowerArmor(0),new ModelT3PowerArmor(1),
     * new ModelExoSuit(0,1.0f), new ModelExoSuit(1,0.5f),new ModelExoSuit(0,0.75f), new ModelBeret(), new
     * ModelArmorCoat(0,1.0f),
     * new ModelArmorCoat(1,0.51f), new ModelArmorCoat(2,0.49f), new ModelArmorCoat(3,0.75f), new
     * ModelSteamArmor(0,0.01f), new ModelT3PowerArmor(0, 0.01f) };
     */
    ...
    public void init(FMLInitializationEvent event) {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(AmmoPressTileEnt.class,
                new RenderMachine(new ModelAmmoPress(),
                        new ResourceLocation(Techguns.MODID, "textures/blocks/ammopress.png")));

        ClientRegistry.bindTileEntitySpecialRenderer(MetalPressTileEnt.class,
                new RenderMachine(new ModelMetalPress(),
                        new ResourceLocation(Techguns.MODID, "textures/blocks/metalpress.png")));

        ClientRegistry.bindTileEntitySpecialRenderer(ChemLabTileEnt.class,
                new RenderMachine(new ModelChemLab(),
                        new ResourceLocation(Techguns.MODID, "textures/blocks/chemlab.png")));
    ...
    protected void initGuiHandler() {
        ...
        guihandler.<RepairBenchTileEnt>addEntry(RepairBenchTileEnt.class, RepairBenchGui::new,
                RepairBenchContainer::new);
        ...
        guihandler.<FabricatorTileEntMaster>addEntry(FabricatorTileEntMaster.class, FabricatorGui::new,
                FabricatorContainer::new);
        guihandler.<ChargingStationTileEnt>addEntry(ChargingStationTileEnt.class, ChargingStationGui::new,
                ChargingStationContainer::new);
        guihandler.<ReactionChamberTileEntMaster>addEntry(ReactionChamberTileEntMaster.class, ReactionChamberGui::new,
                ReactionChamberContainer::new);
        guihandler.<DungeonScannerTileEnt>addEntry(DungeonScannerTileEnt.class, DungeonScannerGui::new,
                DungeonScannerContainer::new);
        guihandler.<DungeonGeneratorTileEnt>addEntry(DungeonGeneratorTileEnt.class, DungeonGeneratorGui::new,
                DungeonGeneratorContainer::new);
        guihandler.<Door3x3TileEntity>addEntry(Door3x3TileEntity.class, Door3x3Gui::new, Door3x3Container::new);
        guihandler.<ExplosiveChargeTileEnt>addEntry(ExplosiveChargeTileEnt.class, ExplosiveChargeGui::new,
                ExplosiveChargeContainer::new);
        guihandler.<ExplosiveChargeAdvTileEnt>addEntry(ExplosiveChargeAdvTileEnt.class, ExplosiveChargeGui::new,
                ExplosiveChargeContainer::new);
        guihandler.<OreDrillTileEntMaster>addEntry(OreDrillTileEntMaster.class, OreDrillGui::new,
                OreDrillContainer::new);
        guihandler.<BlastFurnaceTileEnt>addEntry(BlastFurnaceTileEnt.class, BlastFurnaceGui::new,
                BlastFurnaceContainer::new);
        guihandler.<GrinderTileEnt>addEntry(GrinderTileEnt.class, GrinderGui::new, GrinderContainer::new);
        guihandler.<UpgradeBenchTileEnt>addEntry(UpgradeBenchTileEnt.class, UpgradeBenchGui::new,
                UpgradeBenchContainer::new);
    }
    ...
    public void registerItemRenderers() {
         ...
         * 
         */
        sharedRenderer.addRenderForType("assaultriflemagazine",
                new RenderItemBase(new ModelARMagazine(false),
                        new ResourceLocation(Techguns.MODID, "textures/guns/ar_mag.png")).setBaseScale(1.25f)
                                .setGUIScale(0.85f).setBaseTranslation(0, -0.2f, 0)
                                .setTransformTranslations(m4magTranslations));
        sharedRenderer.addRenderForType("assaultriflemagazineempty",
                new RenderItemBase(new ModelARMagazine(true),
                        new ResourceLocation(Techguns.MODID, "textures/guns/ar_mag.png")).setBaseScale(1.25f)
                                .setGUIScale(0.85f).setBaseTranslation(0, -0.2f, 0)
                                .setTransformTranslations(m4magTranslations));

        sharedRenderer.addRenderForType("assaultriflemagazine_incendiary",
                new RenderItemBase(new ModelARMagazine(false),
                        new ResourceLocation(Techguns.MODID, "textures/guns/ar_mag_inc.png")).setBaseScale(1.25f)
                                .setGUIScale(0.85f).setBaseTranslation(0, -0.2f, 0)
                                .setTransformTranslations(m4magTranslations));

        sharedRenderer.addRenderForType("lmgmagazine",
                new RenderItemLMGMag(new ModelLmgMag(false),
                        new ResourceLocation(Techguns.MODID, "textures/guns/lmg_mag.png")).setBaseScale(1.25f)
                                .setGUIScale(0.75f).setBaseTranslation(0, 0f, 0.2f)
                                .setTransformTranslations(lmgmagTranslations));
        sharedRenderer.addRenderForType("lmgmagazineempty",
                new RenderItemLMGMag(new ModelLmgMag(true),
                        new ResourceLocation(Techguns.MODID, "textures/guns/lmg_mag.png")).setBaseScale(1.25f)
                                .setGUIScale(0.75f).setBaseTranslation(0, 0f, 0.2f)
                                .setTransformTranslations(lmgmagTranslations));

        sharedRenderer.addRenderForType("lmgmagazine_incendiary",
                new RenderItemLMGMag(new ModelLmgMag(false),
                        new ResourceLocation(Techguns.MODID, "textures/guns/lmg_mag_inc.png")).setBaseScale(1.25f)
                                .setGUIScale(0.75f).setBaseTranslation(0, 0f, 0.2f)
                                .setTransformTranslations(lmgmagTranslations));

        sharedRenderer.addRenderForType("as50magazine",
                new RenderItemBase(new ModelAS50Mag(false),
                        new ResourceLocation(Techguns.MODID, "textures/guns/as50_mag.png")).setBaseScale(1.5f)
                                .setGUIScale(0.75f).setBaseTranslation(0.0325f, -0.2f, 0.33f)
                                .setTransformTranslations(as50magTranslations));
        sharedRenderer.addRenderForType("as50magazineempty",
                new RenderItemBase(new ModelAS50Mag(true),
                        new ResourceLocation(Techguns.MODID, "textures/guns/as50_mag.png")).setBaseScale(1.5f)
                                .setGUIScale(0.75f).setBaseTranslation(0.0325f, -0.2f, 0.33f)
                                .setTransformTranslations(as50magTranslations));

        sharedRenderer.addRenderForType("as50magazine_incendiary",
                new RenderItemBase(new ModelAS50Mag(false),
                        new ResourceLocation(Techguns.MODID, "textures/guns/as50_mag_inc.png")).setBaseScale(1.5f)
                                .setGUIScale(0.75f).setBaseTranslation(0.0325f, -0.2f, 0.33f)
                                .setTransformTranslations(as50magTranslations));
        sharedRenderer.addRenderForType("as50magazine_explosive",
                new RenderItemBase(new ModelAS50Mag(false),
                        new ResourceLocation(Techguns.MODID, "textures/guns/as50_mag_exp.png")).setBaseScale(1.5f)
                                .setGUIScale(0.75f).setBaseTranslation(0.0325f, -0.2f, 0.33f)
                                .setTransformTranslations(as50magTranslations));

        sharedRenderer.addRenderForType("rocket",
                new RenderItemBaseRocketItem(new ModelRocket(),
                        new ResourceLocation(Techguns.MODID, "textures/guns/rocket.png")).setBaseScale(1.5f)
                                .setGUIScale(0.5f).setBaseTranslation(0, 0, 0.1f)
                                .setTransformTranslations(rocketTranslations).setFirstPersonScale(0.35f));

        sharedRenderer.addRenderForType("rocket_nuke",
                new RenderItemBaseRocketItem(new ModelRocket(),
                        new ResourceLocation(Techguns.MODID, "textures/guns/rocket_nuke.png")).setBaseScale(1.5f)
                                .setGUIScale(0.5f).setBaseTranslation(0, 0, 0.1f)
                                .setTransformTranslations(rocketTranslations).setFirstPersonScale(0.35f));

        sharedRenderer.addRenderForType("rocket_high_velocity",
                new RenderItemBaseRocketItem(new ModelRocket(),
                        new ResourceLocation(Techguns.MODID, "textures/guns/rocket_hv.png")).setBaseScale(1.5f)
                                .setGUIScale(0.5f).setBaseTranslation(0, 0, 0.1f)
                                .setTransformTranslations(rocketTranslations).setFirstPersonScale(0.35f));

        ItemRenderHack.registerItemRenderer(TGItems.SHARED_ITEM, sharedRenderer);

        ItemRenderHack.registerItemRenderer(TGuns.m4,
                new RenderGunBase(new ModelM4(), 1).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.1f, 0)
                        .setGUIScale(0.35f).setMuzzleFx(ScreenEffect.muzzleFlash_rifle, 0, 0.18f, -1.29f, 0.75f, 0)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.1f, 4.0f).setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.ak47,
                new RenderGunBase(new ModelAK(), 1).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.1f, 0)
                        .setBaseScale(0.75f)
                        .setGUIScale(0.35f).setMuzzleFx(ScreenEffect.muzzleFlash_rifle, 0, 0.18f, -1.36f, 0.8f, 0)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.1f, 4.0f).setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.lmg,
                new RenderGunBase(new ModelLMG(), 1).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.1f, 0)
                        .setGUIScale(0.35f).setMuzzleFx(ScreenEffect.muzzleFlash_rifle, 0, 0.21f, -1.5f, 0.78f, 0)
                        .setMuzzleFXPos3P(0.13f, -0.98f).setRecoilAnim(GunAnimation.genericRecoil, 0.01f, 2.0f)
                        .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.handcannon,
                new RenderGunBase90(new ModelHandgun(), 1).setBaseTranslation(0, -0.2f, RenderItemBase.SCALE - 0.1f)
                        .setGUIScale(0.45f).setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0, 0.16f, -0.75f, 0.9f, 0)
                        .setReloadAnim(GunAnimation.breechReload, -0.15f, 55.0f)
                        .setReloadAnim3p(GunAnimation.breechReload, 0f, 55.0f).setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.sawedoff,
                new RenderGunBase90(new ModelSawedOff(), 1).setBaseTranslation(0, -0.2f, RenderItemBase.SCALE - 0.1f)
                        .setGUIScale(0.45f).setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0, 0.16f, -0.75f, 1.05f, 0)
                        .setReloadAnim(GunAnimation.breechReload, -0.15f, 55.0f)
                        .setReloadAnim3p(GunAnimation.breechReload, 0f, 55.0f).setTransformTranslations(new float[][] {
                                { 0f, 0f, 0f }, // First Person
        ...
        ItemRenderHack.registerItemRenderer(TGuns.thompson,
                new RenderGunBase90(new ModelThompson(), 1)
                        .setBaseTranslation(0, -0.2f, RenderItemBase.SCALE * 0.5f - 0.1f)
                        .setGUIScale(0.45f).setMuzzleFx(ScreenEffect.muzzleFlash_rifle, 0, 0.14f, -0.75f, 0.55f, 0)
                        .setMuzzleFXPos3P(0.1f, -0.59f).setMuzzleFlashJitter(0.02f, 0.02f, 5.0f, 0.1f));

        ItemRenderHack.registerItemRenderer(TGuns.boltaction,
                new RenderGunBase90(new ModelBoltaction(), 1).setBaseTranslation(0, -0.2f, RenderItemBase.SCALE - 0.1f)
                        .setBaseScale(1.35f)
                        .setGUIScale(0.35f).setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0, 0.21f, -1.48f, 0.9f, 0)
                        .setScope(ScreenEffect.sniperScope).setTransformTranslations(new float[][] {
                                { 0f, -0.02f, -0.09f }, // First Person
        ...
        ItemRenderHack.registerItemRenderer(TGuns.biogun,
                new RenderGunBase90(new ModelBiogun(), 1).setBaseTranslation(0.35f, -0.2f, RenderItemBase.SCALE - 0.1f)
                        .setGUIScale(0.45f).setMuzzleFx(ScreenEffect.muzzleGreenFlare, 0, 0.23f, -0.51f, 0.55f, 0)
                        .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.flamethrower,
                new RenderGunFlamethrower(new ModelFlamethrower(), 1)
                        .setBaseTranslation(0, -0.2f, RenderItemBase.SCALE - 0.1f)
                        .setGUIScale(0.45f).setMuzzleFx(ScreenEffect.FlamethrowerMuzzleFlash, 0, 0.16f, -0.9f, 0.45f, 0)
                        .setTransformTranslations(new float[][] {
                                { 0f, 0f, 0f }, // First Person
                                { 0f, 0f, -0.08f }, // Third Person
                                { 0.05f, 0f, 0f }, // GUI
        ...
        ItemRenderHack.registerItemRenderer(TGuns.pistol,
                new RenderGunBase(new ModelPistol(), 2).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.3f, -0.4f)
                        .setBaseScale(1.2f).setGUIScale(0.9f)
                        .setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0.03f, 0.2f, -0.5f, 0.55f, -0.03f)
                        .setTransformTranslations(new float[][] {
                                ...
                                { 0, 0, 0f } // frame
                        }).setRecoilAnim(GunAnimation.genericRecoil, 0.025f, 12.0f)
                        .setMuzzleFlashJitter(0.01f, 0.01f, 5.0f, 0.05f).setMuzzleFXPos3P(0.07f, -0.26f));

        ItemRenderHack.registerItemRenderer(TGuns.rocketlauncher,
                new RenderRocketLauncher(new ModelRocketLauncher(), 2)
                        .setBaseTranslation(-0.4f, -0.2f, -RenderItemBase.SCALE * 0.5f)
                        .setGUIScale(0.45f).setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0, 0.39f, -0.6f, 0.87f, 0)
                        .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.minigun, new RenderGunBase90(new ModelMinigun(), 2)
                .setBaseTranslation(0, -0.2f, RenderItemBase.SCALE * 0.5f).setBaseScale(1.2f)
                .setGUIScale(0.3f).setMuzzleFx(ScreenEffect.muzzleFlash_minigun, -0.04f, 0.05f, -1.25f, 0.8f, 0.04f)
                .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.combatshotgun,
                new RenderGunBase90(new ModelCombatShotgun(), 2)
                        .setBaseTranslation(0, -0.2f, RenderItemBase.SCALE - 0.1f)
                        .setGUIScale(0.45f).setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0, 0.21f, -0.91f, 0.75f, 0)
                        .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.revolver,
                new RenderGunBase90(new ModelRevolver(), 1)
                        .setBaseTranslation(-0.35f, -0.2f, RenderItemBase.SCALE * 0.5f - 0.1f)
                        .setBaseScale(0.75f).setGUIScale(0.75f)
                        .setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0, 0.25f, -0.41f, 0.5f, 0)
                        .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.grimreaper,
                new RenderGunBase90(new ModelGrimReaper(), 1)
                        .setBaseTranslation(0.3f, -0.2f, RenderItemBase.SCALE * 0.5f)
                        .setGUIScale(0.3f).setChargeTranslationAmount(0.025f)
                        .setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0, 0.39f, -0.61f, 0.75f, 0)
                        .setTransformTranslations(new float[][] {
                                ...
                                { 0.0f, 0.1f, 0 }, // Ground
                                { 0, 0, 0f } // frame
                        }).setMuzzleFXPos3P(0.24f, -0.56f).setBaseScale(1.25f).setFirstPersonScale(0.4f)
                        .setGroundAndFrameScale(0.35f));

        ItemRenderHack.registerItemRenderer(TGuns.pdw,
                new RenderGunBase90(new ModelPDW(), 1).setBaseTranslation(0, -0.2f, RenderItemBase.SCALE * 1.5f - 0.1f)
                        .setGUIScale(0.55f).setMuzzleFx(ScreenEffect.muzzleFlash_blue, 0, 0.13f, -0.58f, 0.55f, 0)
                        .setTransformTranslations(new float[][] {
                                ...
                                { 0f, 0f, 0f }, // Ground
                                { 0f, 0f, -0.05f } // frame
                        }).setMuzzleFXPos3P(0.11f, -0.41f).setMuzzleFlashJitter(0.01f, 0.01f, 5.0f, 0.1f)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.06f, 4.0f));

        ItemRenderHack.registerItemRenderer(TGuns.as50,
                new RenderGunBase(new ModelAS50(), 1).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.1f, 0)
                        .setBaseScale(0.85f).setGUIScale(0.30f)
                        .setMuzzleFx(ScreenEffect.muzzleFlash_rifle, 0, 0.29f, -1.82f, 1.15f, 0)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.25f, 4.0f).setTransformTranslations(new float[][] {
                                { 0f, 0.06f, -0.1f }, // First Person
                                { 0f, 0.0f, -0.05f }, // Third Person
                                { 0.13f, -0.09f, -0.05f }, // GUI
                                { 0f, 0f, 0f }, // Ground
                                { 0f, -0.2f, -0.05f } // frame
                        }).setMuzzleFXPos3P(0.17f, -1.29f).setScope(ScreenEffect.sniperScope)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.25f, 5.0f)
                        .setScopeRecoilAnim(GunAnimation.scopeRecoil, 0.2f, 2.0f));

        ItemRenderHack.registerItemRenderer(TGuns.m4_infiltrator,
                new RenderGunBase(new ModelM4Infiltrator(), 1).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.1f, 0)
                        .setGUIScale(0.35f)
                        /* .setMuzzleFx(ScreenEffect.muzzleFlash_rifle, 0, 0.18f, -1.5f, 0.5f,0) */.setRecoilAnim(
                                GunAnimation.genericRecoil, 0.1f, 4.0f)
                        .setTransformTranslations(new float[][] {
                                { 0f, 0f, -0.05f }, // First Person
                                { 0f, 0.01f, -0.1f }, // Third Person
                                { 0f, 0f, 0f }, // GUI
                                { 0f, 0f, 0f }, // Ground
                                { 0f, 0f, -0.05f } // frame
                        }).setMuzzleFXPos3P(0.14f, -1.15f).setScope(ScreenEffect.sniperScope)
                        .setScopeRecoilAnim(GunAnimation.scopeRecoil, 0.05f, 1.0f));

        ItemRenderHack.registerItemRenderer(TGuns.goldenrevolver,
                new RenderGunBase90(new ModelGoldenRevolver(), 1)
                        .setBaseTranslation(-0.35f, -0.2f, RenderItemBase.SCALE * 0.5f - 0.1f)
                        .setBaseScale(0.75f).setGUIScale(0.75f)
                        .setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0, 0.25f, -0.41f, 0.5f, 0)
                        .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.pulserifle,
                new RenderGunBase90(new ModelPulseRifle(), 1)
                        .setBaseTranslation(0, -0.2f, RenderItemBase.SCALE * 1.5f - 0.09f)
                        .setGUIScale(0.45f).setMuzzleFx(ScreenEffect.muzzleFlash_blue, 0, 0.22f, -0.76f, 0.6f, 0)
                        .setTransformTranslations(new float[][] {
                                ...
                                { 0f, 0f, 0f }, // Ground
                                { 0f, 0f, -0.05f } // frame
                        }).setMuzzleFXPos3P(0.1f, -0.50f).setScope(ScreenEffect.techScope, 2.125f)
                        .setScopeRecoilAnim(GunAnimation.scopeRecoil, 0.10f, 1.5f)
                        .setRecoilAnim(GunAnimation.pulseRifleRecoil, 0.25f, 10.0f));

        ItemRenderHack.registerItemRenderer(TGuns.teslagun,
                new RenderGunBase90(new ModelTeslaGun(), 1)
                        .setBaseTranslation(0.25f, -0.2f, RenderItemBase.SCALE - 0.09f)
                        .setGUIScale(0.45f).setMuzzleFx(ScreenEffect.muzzleFlashLightning, 0, 0.26f, -0.67f, 0.5f, 0)
                        .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.netherblaster, new RenderGunBase(new ModelNetherBlaster(), 1)
                .setBaseTranslation(0f, -0.2f, RenderItemBase.SCALE - 0.09f)
                .setGUIScale(0.60f).setMuzzleFx(ScreenEffect.muzzleFlashFireball_alpha, 0, 0.29f, -0.33f, 0.5f, 0)
                .setTransformTranslations(new float[][] {
                        { 0f, 0.15f, 0.04f }, // First Person
        ...
        ItemRenderHack.registerItemRenderer(TGuns.lasergun,
                new RenderGunBase90(new ModelLasergun(), 1)
                        .setBaseTranslation(0.25f, -0.2f, RenderItemBase.SCALE * 0.5f - 0.10f)
                        .setBaseScale(1.1f).setGUIScale(0.40f)
                        .setMuzzleFx(ScreenEffect.muzzleFlashLaser, 0, 0.30f, -1.06f, 0.5f, 0)
                        .setTransformTranslations(new float[][] {
                                { 0f, 0.15f, 0.04f }, // First Person
        ...
        ItemRenderHack.registerItemRenderer(TGuns.alienblaster,
                new RenderGunBase(new ModelAlienBlaster(), 1)
                        .setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.3f, -0.2f)
                        .setBaseScale(0.75f).setGUIScale(0.75f)
                        .setMuzzleFx(ScreenEffect.muzzleFlashAlienBlaster, 0f, 0.28f, -0.52f, 0.55f, 0f)
                        .setTransformTranslations(new float[][] {
                        ...
                        }).setRecoilAnim(GunAnimation.genericRecoil, 0.025f, 10.0f).setMuzzleFXPos3P(0.07f, -0.36f)
                        .setReloadAnim(GunAnimation.breechReload, -0.15f, 55.0f)
                        .setReloadAnim3p(GunAnimation.breechReload, 0f, 55.0f));

        ItemRenderHack.registerItemRenderer(TGuns.blasterrifle,
                new RenderGunBase(new ModelBlasterRifle(), 1).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.1f, 0)
                        .setBaseScale(0.9f).setGUIScale(0.45f)
                        .setMuzzleFx(ScreenEffect.muzzleFlashLaser, 0, 0.24f, -0.93f, 0.75f, 0)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.1f, 4.0f).setTransformTranslations(new float[][] {
        ...
        ResourceLocation[] powerhammer_textures = {
                new ResourceLocation(Techguns.MODID, "textures/guns/powerHammer.png"),
                new ResourceLocation(Techguns.MODID, "textures/guns/powerHammer_obsidian.png"),
                new ResourceLocation(Techguns.MODID, "textures/guns/powerHammer_carbon.png") };
        ItemRenderHack.registerItemRenderer(TGuns.powerhammer,
                new RenderMiningToolMultiTexture(new ModelPowerHammer(), 2, powerhammer_textures)
                        .setBaseTranslation(0.15f, -0.2f, RenderItemBase.SCALE - 0.09f)
                        .setBaseScale(1.25f).setGUIScale(0.45f).setMuzzleFx(null, 0, 0.26f, -0.67f, 0.5f, 0)
                        .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.grenadelauncher,
                new RenderGunBaseObj(new ModelBaseBakedGrenadeLauncher(
                        new ResourceLocation(Techguns.MODID, "textures/guns/grenadelauncher.png"),
                        new ModelResourceLocation(TGuns.grenadelauncher.getRegistryName(), "inventory"),
                        new ModelResourceLocation(TGuns.grenadelauncher.getRegistryName() + "_1", "inventory")), 1,
                        90.0f)
                                .setBaseTranslation(0f, 0f, 0f)
                                .setBaseScale(0.125f).setGUIScale(0.45f)
                                .setMuzzleFx(ScreenEffect.muzzleFlash_gun, 0, 0.22f, -0.63f, 0.5f, 0)
                                .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.aug,
                new RenderGunBase(new ModelAUG(), 2).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.1f, 0.1f)
                        .setGUIScale(0.35f).setMuzzleFx(ScreenEffect.muzzleFlash_rifle, 0, 0.19f, -1.45f, 0.75f, 0)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.1f, 4.0f).setTransformTranslations(new float[][] {
                        ...
                        }).setMuzzleFXPos3P(0.12f, -0.87f).setMuzzleFlashJitter(0.02f, 0.02f, 5.0f, 0.1f)
                        .setScope(ScreenEffect.sniperScope).setScopeRecoilAnim(GunAnimation.scopeRecoil, 0.075f, 1.0f));

        ItemRenderHack.registerItemRenderer(TGuns.sonicshotgun,
                new RenderGunBase90(new ModelSonicShotgun(), 1)
                        .setBaseTranslation(0, -0.2f, RenderItemBase.SCALE * 0.5f - 0.10f)
                        .setBaseScale(1.0f).setGUIScale(0.35f)
                        .setMuzzleFx(ScreenEffect.muzzleFlashSonic, 0, 0.28f, -0.98f, 0.5f, 0)
                        .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.chainsaw,
                new RenderGunChainsaw(new ModelChainsaw(), 2)
                        .setBaseTranslation(-0.4f, -0.2f, RenderItemBase.SCALE - 0.09f)
        ...
        ItemRenderHack.registerItemRenderer(TGuns.scatterbeamrifle,
                new RenderGunBase(new ModelLasergun2(), 1).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.1f, 0.1f)
                        .setGUIScale(0.35f).setMuzzleFx(ScreenEffect.muzzleFlashLaser, 0, 0.22f, -1.09f, 0.75f, 0)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.1f, 4.0f).setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.nucleardeathray,
                new RenderGunBase90(new ModelNDR(), 1)
                        .setBaseTranslation(1f, -0.2f, RenderItemBase.SCALE * 1.5f - 0.09f)
                        .setBaseScale(1.2f).setGUIScale(0.40f)
                        .setMuzzleFx(ScreenEffect.muzzleFlashNukeBeam, 0, 0.19f, -0.91f, 0.65f, 0)
                        .setTransformTranslations(new float[][] {
                                { 0f, 0.02f, 0.09f }, // First Person
        ...
        ItemRenderHack.registerItemRenderer(TGuns.scar,
                new RenderGunBase(new ModelScar(), 2).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.1f, 0.1f)
                        .setGUIScale(0.35f).setMuzzleFx(ScreenEffect.muzzleFlash_rifle, 0, 0.23f, -1.48f, 0.78f, 0)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.1f, 4.0f).setTransformTranslations(new float[][] {
                        ...
                        }).setMuzzleFXPos3P(0.14f, -1.04f).setMuzzleFlashJitter(0.02f, 0.02f, 5.0f, 0.1f)
                        .setScope(ScreenEffect.sniperScope).setScopeRecoilAnim(GunAnimation.scopeRecoil, 0.05f, 2.0f));

        ItemRenderHack.registerItemRenderer(TGuns.vector,
                new RenderGunBase(new ModelVector(), 1).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.57f, -0.2f)
                        .setBaseScale(1.1f).setGUIScale(0.45f)
                        .setMuzzleFx(ScreenEffect.muzzleFlash_rifle, 0, 0.10f, -0.72f, 0.60f, 0)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.05f, 2.0f).setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.mac10,
                new RenderGunBase(new ModelMac10(), 1).setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.45f, -0.3f)
                        .setBaseScale(1.2f).setGUIScale(0.55f)
                        .setMuzzleFx(ScreenEffect.muzzleFlash_rifle, 0, 0.23f, -0.46f, 0.5f, 0)
                        .setRecoilAnim(GunAnimation.genericRecoil, 0.06f, 3.0f).setTransformTranslations(new float[][] {
                                { 0f, 0f, -0.05f }, // First Person
        ...
        ItemRenderHack.registerItemRenderer(TGuns.mibgun,
                new RenderGunBase(new ModelMibGun(), 1)
                        .setBaseTranslation(/* RenderItemBase.SCALE*0.5f */0f, -0.56f, -0.02f)
                        .setBaseScale(1.2f).setGUIScale(0.75f)
                        .setMuzzleFx(ScreenEffect.muzzleFlashMibGun, 0f, 0.26f, -0.42f, 0.55f, 0f)
                        .setTransformTranslations(new float[][] {
                                ...
                                { 0.02f, -0.08f, 0 }, // Ground
                                { -0.04f, -0.09f, 0f } // frame
                        }).setRecoilAnim(GunAnimation.genericRecoil, 0.025f, 10.0f).setMuzzleFXPos3P(0.06f, -0.31f)
                        .setReloadAnim(GunAnimation.breechReload, -0.15f, 55.0f)
                        .setReloadAnim3p(GunAnimation.breechReload, 0f, 55.0f));

        ItemRenderHack.registerItemRenderer(TGuns.gaussrifle, new RenderGunBaseObj(
                new ModelBaseBaked(new ResourceLocation(Techguns.MODID, "textures/guns/gaussrifle.png"),
                        new ModelResourceLocation(TGuns.gaussrifle.getRegistryName(), "inventory")),
                1, -90f)
                        .setBaseTranslation(0.6f, 0f, RenderItemBase.SCALE * 0.5f - 0.09f)
                        .setBaseScale(0.9f).setGUIScale(0.25f)
                        .setMuzzleFx(ScreenEffect.muzzleFlashSonic, 0, 0.21f, -1.56f, 1.0f, 0)
                        .setTransformTranslations(new float[][] {
                                ...
                                { 0f, 0f, 0.f }, // Ground
                                { 0f, 0f, -0.05f } // frame
                        }).setMuzzleFXPos3P(0.09f, -1.26f).setRecoilAnim(GunAnimation.genericRecoil, 0.25f, 7.5f)
                        .setScope(ScreenEffect.techScope, 2.125f)
                        .setScopeRecoilAnim(GunAnimation.scopeRecoil, 0.15f, 1.0f));

        ItemRenderHack.registerItemRenderer(TGuns.guidedmissilelauncher,
        ...
        ResourceLocation[] drill_textures = {
                new ResourceLocation(Techguns.MODID, "textures/guns/miningdrill_obsidian.png"),
                new ResourceLocation(Techguns.MODID, "textures/guns/miningdrill_carbon.png") };
        ItemRenderHack.registerItemRenderer(TGuns.miningdrill,
                new RenderMiningToolMultiTexture(new ModelMiningDrill(), 2, drill_textures)
                        .setBaseTranslation(0, -0.2f, -RenderItemBase.SCALE * 0.5f).setBaseScale(2.0f)
        ...
        ItemRenderHack.registerItemRenderer(TGuns.tfg,
                new RenderGunBase90(new ModelTFG(), 1).setBaseTranslation(-0.46f, -0.38f, RenderItemBase.SCALE - 0.125f)
                        .setBaseScale(1.20f).setGUIScale(0.30f)
                        .setMuzzleFx(ScreenEffect.muzzleFlashTFG, 0.0f, 0.18f, -0.87f, 0.9f, 0)
                        .setTransformTranslations(new float[][] {
                        ...
                        }).setMuzzleFXPos3P(0.09f, -1.14f).setChargeTranslationAmount(0.05f)
                        .setFirstPersonScale(0.45f));

        ItemRenderHack.registerItemRenderer(TGuns.shishkebap,
                new RenderGunBase(new ModelShishkebap(), 1).setBaseTranslation(0, 0, 0).setBaseScale(1.0f)
                        .setGUIScale(0.3f).setTransformTranslations(new float[][] {
                                ...
                                { 0f, 0f, 0f }, // Ground
                                { 0f, 0.0f, 0.0f } // frame
                        }).setAmbientParticleFX("ScreenTestFX").setReloadAnim(GunAnimation.breechReload, -0.15f, 55.0f)
                        .setReloadAnim3p(GunAnimation.breechReload, 0f, 55.0f));

        ItemRenderHack.registerItemRenderer(TGuns.laserpistol,
                new RenderGunBase(new ModelLaserPistol(), 1)
                        .setBaseTranslation(RenderItemBase.SCALE * 0.5f, -0.3f, -0.4f)
                        .setBaseScale(1.2f).setGUIScale(0.7f)
                        .setMuzzleFx(ScreenEffect.muzzleFlashLaser, 0.03f, 0.2f, -0.5f, 0.55f, -0.03f)
                        .setTransformTranslations(new float[][] {
                                { 0, 0.09f, -0.02f }, // First Person
                                { 0.0f, -0.03f, 0.0f }, // Third Person
                                { 0.02f, -0.08f, 0 }, // GUI
        ...
        ItemRenderHack.registerItemRenderer(TGArmors.steam_Helmet,
                new RenderArmorItem(new ModelSteamArmor(0),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/steam_armor.png"),
                        EntityEquipmentSlot.HEAD));
        ItemRenderHack.registerItemRenderer(TGArmors.steam_Chestplate,
                new RenderArmorItem(new ModelSteamArmor(0),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/steam_armor.png"),
                        EntityEquipmentSlot.CHEST));
        ItemRenderHack.registerItemRenderer(TGArmors.steam_Leggings,
                new RenderArmorItem(new ModelSteamArmor(1),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/steam_armor.png"),
                        EntityEquipmentSlot.LEGS));
        ItemRenderHack.registerItemRenderer(TGArmors.steam_Boots,
                new RenderArmorItem(new ModelSteamArmor(0),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/steam_armor.png"),
                        EntityEquipmentSlot.FEET));

        ItemRenderHack.registerItemRenderer(TGArmors.t3_power_Helmet,
                new RenderArmorItem(new ModelT3PowerArmor(0),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/powerarmor.png"),
                        EntityEquipmentSlot.HEAD));
        ItemRenderHack.registerItemRenderer(TGArmors.t3_power_Chestplate,
                new RenderArmorItem(new ModelT3PowerArmor(0),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/powerarmor.png"),
                        EntityEquipmentSlot.CHEST));
        ItemRenderHack.registerItemRenderer(TGArmors.t3_power_Leggings,
                new RenderArmorItem(new ModelT3PowerArmor(1),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/powerarmor.png"),
                        EntityEquipmentSlot.LEGS));
        ItemRenderHack.registerItemRenderer(TGArmors.t3_power_Boots,
                new RenderArmorItem(new ModelT3PowerArmor(0),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/powerarmor.png"),
                        EntityEquipmentSlot.FEET));

        ItemRenderHack.registerItemRenderer(TGArmors.t4_power_Helmet,
                new RenderArmorItem(new ModelT4PowerArmorMk2(0),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/powerarmor_mk2_darkgrey.png"),
                        EntityEquipmentSlot.HEAD));
        ItemRenderHack.registerItemRenderer(TGArmors.t4_power_Chestplate,
                new RenderArmorItem(new ModelT4PowerArmorMk2(0),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/powerarmor_mk2_darkgrey.png"),
                        EntityEquipmentSlot.CHEST));
        ItemRenderHack.registerItemRenderer(TGArmors.t4_power_Leggings,
                new RenderArmorItem(new ModelT4PowerArmorMk2(1),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/powerarmor_mk2_darkgrey.png"),
                        EntityEquipmentSlot.LEGS));
        ItemRenderHack.registerItemRenderer(TGArmors.t4_power_Boots,
                new RenderArmorItem(new ModelT4PowerArmorMk2(0),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/powerarmor_mk2_darkgrey.png"),
                        EntityEquipmentSlot.FEET));

        ItemRenderHack.registerItemRenderer(TGuns.stielgranate,
                new RenderGrenade(new ModelStielgranate(),
                        new ResourceLocation(Techguns.MODID, "textures/guns/stielgranate.png")).setBaseScale(1f)
                                .setGUIScale(0.8f)
                                .setBaseTranslation(-RenderItemBase.SCALE * 0.5f, 0.48f, -RenderItemBase.SCALE)
                                .setTransformTranslations(new float[][] {
        ...
        ItemRenderHack.registerItemRenderer(TGuns.fraggrenade,
                new RenderGrenade(new ModelFragGrenade(true),
                        new ResourceLocation(Techguns.MODID, "textures/guns/frag_grenade_texture.png"), 90.0f)
                                .setBaseScale(1.25f).setGUIScale(1.35f)
                                .setBaseTranslation(-0.02f, 0.65f, -RenderItemBase.SCALE + 0.02f)
                                .setTransformTranslations(new float[][] {
                                        { 0f, -0.06f, 0f }, // First Person
        ...
        AdditionalSlotRenderRegistry.register(TGItems.GAS_MASK, new RenderAdditionalSlotItem(new ModelGasMask(),
                new ResourceLocation(Techguns.MODID, "textures/armors/gasmask.png")));
        AdditionalSlotRenderRegistry.register(TGItems.GLIDER, new RenderAdditionalSlotItem(new ModelGlider(),
                new ResourceLocation(Techguns.MODID, "textures/armors/glider.png")));
        AdditionalSlotRenderRegistry.register(TGItems.JUMPPACK,
                new RenderAdditionalSlotItem(new ModelJetPack(1), Techguns.MODID, "textures/armors/jetpack", 4));
        AdditionalSlotRenderRegistry.register(TGItems.JETPACK,
                new RenderAdditionalSlotItem(new ModelJetPack(0), Techguns.MODID, "textures/armors/jetpack", 4));
        AdditionalSlotRenderRegistry.register(TGItems.SCUBA_TANKS, new RenderAdditionalSlotItem(new ModelOxygenTanks(),
                new ResourceLocation(Techguns.MODID, "textures/armors/oxygentanks.png")));
        AdditionalSlotRenderRegistry.register(TGItems.NIGHTVISION_GOGGLES,
                new RenderAdditionalSlotItem(new ModelNightVisionGoggles(),
                        new ResourceLocation(Techguns.MODID, "textures/armors/nightvisiongoggles.png")));
        AdditionalSlotRenderRegistry.register(TGItems.ANTI_GRAV_PACK, new RenderAdditionalSlotItem(
                new ModelAntiGravPack(), Techguns.MODID, "textures/armors/antigravpack", 5));
        AdditionalSlotRenderRegistry.register(TGItems.TACTICAL_MASK, new RenderAdditionalSlotItem(
                new ModelFaceMask(true), Techguns.MODID, "textures/armors/tacticalmask", 4));

        RenderAdditionalSlotSharedItem sharedItemRenderer = new RenderAdditionalSlotSharedItem();
        sharedItemRenderer.addRenderForSharedItem(TGItems.OXYGEN_MASK.getItemDamage(), new RenderAdditionalSlotItem(
                new ModelFaceMask(true), new ResourceLocation(Techguns.MODID, "textures/armors/oxygenmask.png")));
        sharedItemRenderer.addRenderForSharedItem(TGItems.WORKING_GLOVES.getItemDamage(),
                new RenderAdditionalSlotItem(new ModelGloves(0.45f, false), new ModelGloves(0.45f, true),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/working_gloves.png"),
                        new ResourceLocation(Techguns.MODID, "textures/models/armor/working_gloves_slim.png")));

        AdditionalSlotRenderRegistry.register(TGItems.SHARED_ITEM, sharedItemRenderer);

        TGArmors.riot_shield.setTileEntityItemStackRenderer(new TileEntityItemRendererTGShield(new ModelRiotShield(),
                new ResourceLocation(Techguns.MODID, "textures/armors/riot_shield.png"),
                new ResourceLocation(Techguns.MODID, "textures/armors/riot_shield_black.png"),
                new ResourceLocation(Techguns.MODID, "textures/armors/riot_shield_darkgreen.png"),
                new ResourceLocation(Techguns.MODID, "textures/armors/riot_shield_grey.png")));

        TGArmors.ballistic_shield
                .setTileEntityItemStackRenderer(new TileEntityItemRendererTGShield(new ModelBallisticShield(),
                        new ResourceLocation(Techguns.MODID, "textures/armors/ballistic_shield.png"),
                        new ResourceLocation(Techguns.MODID, "textures/armors/ballistic_shield_black.png"),
                        new ResourceLocation(Techguns.MODID, "textures/armors/ballistic_shield_green.png"),
                        new ResourceLocation(Techguns.MODID, "textures/armors/ballistic_shield_grey.png")));

        TGArmors.advanced_shield.setTileEntityItemStackRenderer(new TileEntityItemRendererTGShield(
                new ModelAdvancedShield(), getTextures("textures/armors/advanced_shield", "silver", "green")));
    }

    @Override
    protected void registerEntityRenderers() {
        RenderingRegistry.registerEntityRenderingHandler(GenericProjectile.class,
                RenderGenericProjectile<GenericProjectile>::new);
        RenderingRegistry.registerEntityRenderingHandler(GenericProjectileIncendiary.class,
                RenderGenericProjectile<GenericProjectile>::new);
        ...
        RenderingRegistry.registerEntityRenderingHandler(FlamethrowerProjectile.class,
                RenderFlameThrowerProjectile::new);
        ...
        RenderingRegistry.registerEntityRenderingHandler(AdvancedBulletProjectile.class,
                RenderAdvancedBulletProjectile::new);
        RenderingRegistry.registerEntityRenderingHandler(GuidedMissileProjectile.class, RenderRocketProjectile::new);
        RenderingRegistry.registerEntityRenderingHandler(DeatomizerProjectile.class,
                RenderInvisibleProjectile<DeatomizerProjectile>::new);
        RenderingRegistry.registerEntityRenderingHandler(AlienBlasterProjectile.class,
                RenderInvisibleProjectile<AlienBlasterProjectile>::new);
        RenderingRegistry.registerEntityRenderingHandler(SonicShotgunProjectile.class,
                RenderSonicShotgunProjectile::new);
        RenderingRegistry.registerEntityRenderingHandler(CyberdemonBlasterProjectile.class,
                RenderInvisibleProjectile<CyberdemonBlasterProjectile>::new);
        RenderingRegistry.registerEntityRenderingHandler(PowerHammerProjectile.class,
                RenderInvisibleProjectile<PowerHammerProjectile>::new);
        RenderingRegistry.registerEntityRenderingHandler(ChainsawProjectile.class,
                RenderInvisibleProjectile<ChainsawProjectile>::new);
        ...
        RenderingRegistry.registerEntityRenderingHandler(TFGProjectile.class,
                RenderInvisibleProjectile<TFGProjectile>::new);
        RenderingRegistry.registerEntityRenderingHandler(GenericProjectileExplosive.class,
                RenderGenericProjectile<GenericProjectile>::new);
    ...
    public void setGunTextures(GenericGun gun, ResourceLocation path, int variations) {
        ...
        for (int i = 0; i < variations; i++) {
            gun.textures.add(
                    new ResourceLocation(path.getNamespace(), path.getPath() + (i != 0 ? ("_" + i) : "") + ".png"));
        }
    }

    @Override
    public void handleSoundEvent(EntityPlayer ply, int entityId, SoundEvent soundname, float volume, float pitch,
                                 boolean repeat, boolean moving,
        ...
        if (entity != null) {
            if (entity != ply || playOnOwnPlayer) {
                Minecraft.getMinecraft().getSoundHandler().playSound(
                        new TGSound(soundname, entity, volume, pitch, repeat, moving, gunPosition, soundCategory));
    ...
    public void playSoundOnEntity(Entity ent, SoundEvent soundname, float volume, float pitch, boolean repeat,
                                  boolean moving, boolean gunPosition, boolean playForOwnPlayer,
    ...
    public void playSoundOnEntity(Entity ent, SoundEvent soundname, float volume, float pitch, boolean repeat,
                                  boolean moving, boolean gunPosition, boolean playForOwnPlayer,
                                  TGSoundCategory category, EntityCondition condition) {
        if (playForOwnPlayer || ent != this.getPlayerClient()) {
    ...
    public void playSoundOnEntity(Entity ent, SoundEvent soundname, float volume, float pitch, boolean repeat,
        ...
        Minecraft.getMinecraft().getSoundHandler()
                .playSound(new TGSound(soundname, ent, volume, pitch, repeat, moving, gunPosition, category));
    }
    ...
    public void playSoundOnEntity(Entity ent, SoundEvent soundname, float volume, float pitch, boolean repeat,
                                  ...
                                  EntityCondition condition) {
        Minecraft.getMinecraft().getSoundHandler().playSound(
                new TGSound(soundname, ent, volume, pitch, repeat, moving, gunPosition, category, condition));
    }

    @Override
    public void playSoundOnPosition(SoundEvent soundname, float posx, float posy, float posz, float volume, float pitch,
                                    boolean repeat, TGSoundCategory soundCategory) {
        Minecraft.getMinecraft().getSoundHandler()
                .playSound(new TGSound(soundname, posx, posy, posz, volume, pitch, repeat, soundCategory));
    }

    @Override
    public void createFX(String name, World world, double posX, double posY, double posZ, double motionX,
    ...
    @Override
    public void createFX(String name, World world, double posX, double posY, double posZ, double motionX,
                         double motionY, double motionZ, float pitch, float yaw) {
        List<TGParticleSystem> systems = TGFX.createFX(world, name, posX, posY, posZ, motionX, motionY, motionZ);
        if (systems != null) {
    ...
    @Override
    public void createFXOnEntityWithOffset(String name, Entity ent, float offsetX, float offsetY, float offsetZ,
                                           boolean attachToHead, EntityCondition condition) {
        List<TGParticleSystem> systems = TGFX.createFXOnEntity(ent, name);
        if (systems != null) {
            for (TGParticleSystem s : systems) {
    ...
    @Override
    public void createLightPulse(double x, double y, double z, int lifetime, float rad_start, float rad_end, float r,
                                 float g, float b) {
    ...
    @Override
    public void createLightPulse(double x, double y, double z, int fadeIn, int fadeOut, float rad_large,
                                 float rad_small, float r, float g, float b) {
        if (this.lightPulsesEnabled) {
    ...
    public void registerFluidModelsForFluidBlock(Block b) {
        ...
        final ModelResourceLocation modelResourceLocation = new ModelResourceLocation(
                new ResourceLocation(Techguns.MODID, "fluid"), f.getFluid().getName());
        ...
        if (player.world.isRemote) {
            ...
            if (props.isGliding) {
                if (props.gliderLoop == null) {
                    props.gliderLoop = new TGSound(TGSounds.GLIDER_LOOP, player, 0.75f, 1.0f, true, true, false,
                            TGSoundCategory.PLAYER_EFFECT);
