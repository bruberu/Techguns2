...
public class ItemRenderHack {
    ...
    /*
     * public static float getAttackStrengthForRendering(EntityPlayer ply, float adjustTicks, ItemStack mainhand,
     * ItemStack offhand) {
    ...
    public static boolean renderItem(ItemStack stack, EntityLivingBase elb,
     ...
     * @return
     */
    protected static boolean JEI_Fix(ItemCameraTransforms.TransformType type, boolean leftHanded, IItemTGRenderer item,
                                     ItemStack stack) {
    ...
    protected static boolean shouldRenderItem(ItemStack stack, EntityLivingBase elb,
                                              ItemCameraTransforms.TransformType transform, boolean leftHanded) {
        ...
        boolean mainhand = transform == TransformType.FIRST_PERSON_RIGHT_HAND ||
                transform == TransformType.THIRD_PERSON_RIGHT_HAND;
