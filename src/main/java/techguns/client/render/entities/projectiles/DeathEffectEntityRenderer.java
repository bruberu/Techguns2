...
public class DeathEffectEntityRenderer {
    ...
    private static final ResourceLocation RES_LASER_EFFECT = new ResourceLocation(Techguns.MODID,
            "textures/fx/laserdeath.png");
    private static final int MAX_DEATH_TIME = 20;

    public static Field RLB_mainModel = ReflectionHelper.findField(RenderLivingBase.class, "mainModel",
            "field_77045_g");
    protected static Method RLB_preRenderCallback = ReflectionHelper.findMethod(RenderLivingBase.class,
            "preRenderCallback", "func_77041_b", EntityLivingBase.class, float.class);
    protected static Method R_bindEntityTexture = ReflectionHelper.findMethod(Render.class, "bindEntityTexture",
            "func_180548_c", Entity.class);

    public static Field R_renderManager = ReflectionHelper.findField(Render.class, "renderManager", "field_76990_c");

    protected static Method R_bindTexture = ReflectionHelper.findMethod(Render.class, "bindTexture", "func_110776_a",
            ResourceLocation.class);
    protected static Method RLB_getColorMultiplier = ReflectionHelper.findMethod(RenderLivingBase.class,
            "getColorMultiplier", "func_77030_a", EntityLivingBase.class, float.class, float.class);

    public static void preRenderCallback(RenderLivingBase<? extends EntityLivingBase> renderer, EntityLivingBase elb,
                                         float ptt) throws IllegalAccessException, IllegalArgumentException,
                                                    InvocationTargetException {
        RLB_preRenderCallback.invoke(renderer, elb, ptt);
    }

    public static void bindEntityTexture(Render<? extends Entity> renderer,
                                         Entity entity) throws IllegalAccessException, IllegalArgumentException,
                                                        InvocationTargetException {
     ...
     */
    public static void doRender(RenderLivingBase renderer, EntityLivingBase entity, double x, double y, double z,
                                float ptt, DeathType deathType) {
     ...
     */
    static void renderModelDeathBio(RenderLivingBase renderer, EntityLivingBase entity, float f7, float f6, float f4,
                                    float p_77036_5_, float f13, float f5) {
     ...
     * Renders the model in RenderLiving
     */
    static void renderModelDeathLaser(RenderLivingBase renderer, EntityLivingBase entity, float f7, float f6, float f4,
                                      float p_77036_5_, float f13, float f5) {
        float prog = ((float) entity.deathTime / (float) MAX_DEATH_TIME);
    ...
    /*
     * static void renderModelDeathDismember(RenderLivingBase renderer, EntityLivingBase entity, float f7, float f6,
     * float f4, float p_77036_5_, float f13, float f5, float ptt)
     * {
     ...
     * Renders the model in RenderLiving
     */
    static void renderModel(RenderLivingBase renderer, EntityLivingBase entity, float f7, float f6, float f4,
                            float p_77036_5_, float f13, float f5, ResourceLocation texture, RenderType renderType) {
        ModelBase mainModel = null;
        ModelBase renderPassModel;
        RenderManager renderManager = null;
        try {
    ...
    /*
     * static void renderExtraPasses(RenderLivingBase renderer, EntityLivingBase entity, float f7, float f6, float f4,
     * float f3f2, float f13, float f5, float ptt) {
     * ModelBase mainModel = null;
     * ModelBase renderPassModel = null;
     * try {
     * mainModel = (ModelBase)RLB_mainModel.get(renderer);
    ...
    /*
     * static void biped_renderEquippedItems(RendererLivingEntity renderer, RenderManager renderManager, ModelBiped
     * modelBipedMain, EntityLiving p_77029_1_, float p_77029_2_)
     * {
     ...
     * net.minecraftforge.client.MinecraftForgeClient.getItemRenderer(itemstack1,
     * net.minecraftforge.client.IItemRenderer.ItemRenderType.EQUIPPED);
     * boolean is3D = (customRenderer != null &&
     * customRenderer.shouldUseRenderHelper(net.minecraftforge.client.IItemRenderer.ItemRenderType.EQUIPPED, itemstack1,
     ...
     * }
     * 
     * TileEntitySkullRenderer.field_147536_b.func_152674_a(-0.5F, 0.0F, -0.5F, 1, 180.0F, itemstack1.getItemDamage(),
     * gameprofile);
     * }
     * 
     * GL11.glPopMatrix();
     ...
     * 
     * net.minecraftforge.client.IItemRenderer customRenderer =
     * net.minecraftforge.client.MinecraftForgeClient.getItemRenderer(itemstack,
     * net.minecraftforge.client.IItemRenderer.ItemRenderType.EQUIPPED);
     * boolean is3D = (customRenderer != null &&
     * customRenderer.shouldUseRenderHelper(net.minecraftforge.client.IItemRenderer.ItemRenderType.EQUIPPED, itemstack,
     * net.minecraftforge.client.IItemRenderer.ItemRendererHelper.BLOCK_3D));
     * 
     * if (item instanceof ItemBlock && (is3D ||
