...
public class RenderFragGrenadeProjectile extends Render<FragGrenadeProjectile> {
    ...
    private ResourceLocation textureLoc = new ResourceLocation(Techguns.MODID,
            "textures/guns/frag_grenade_texture.png");
    ...
    @Override
    public void doRender(FragGrenadeProjectile entity, double x, double y, double z, float entityYaw,
                         float partialTicks) {
