...
public class RenderTeslaProjectile extends Render<TeslaProjectile> {
    ...
    @Override
    public void doRender(TeslaProjectile laser, double posX, double posY, double posZ, float entityYaw,
                         float partialTicks) {
    ...
    void drawSegment(double x1, double y1, double z1, double x2, double y2, double z2, double width1, double width2,
                     double a1, double a2) {
