...
public class RenderRocketProjectile extends Render {
    ...
    public void doRender(Entity par1Entity, double par2, double par4,
        ...
        GlStateManager.rotate(
                par1Entity.prevRotationYaw + (par1Entity.rotationYaw - par1Entity.prevRotationYaw) * par9 - 90.0F, 0.0F,
                1.0F, 0.0F);
        GlStateManager.rotate(
                par1Entity.prevRotationPitch + (par1Entity.rotationPitch - par1Entity.prevRotationPitch) * par9, 0.0F,
                0.0F, 1.0F);
