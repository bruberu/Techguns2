...
public class RenderNPCTurret extends RenderLiving<NPCTurret> {
    ...
    protected void renderEquippedItems(NPCTurret turret) {
        ...
        if (!gunstack.isEmpty()) {
            ...
            GlStateManager.translate(gun.turretPosOffsetX + Keybinds.X,
                    gun.turretPosOffsetY + this.gunOffsetY + Keybinds.Y, gun.turretPosOffsetZ + Keybinds.Z);
             ...
             */
            Minecraft.getMinecraft().getItemRenderer().renderItemSide(turret, gunstack,
                    TransformType.THIRD_PERSON_RIGHT_HAND, false);
            GlStateManager.popMatrix();
        }
    }
}
