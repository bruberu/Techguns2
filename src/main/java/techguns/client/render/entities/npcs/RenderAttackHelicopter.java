...
public class RenderAttackHelicopter extends RenderLiving<AttackHelicopter> {
    ...
    private static final ModelResourceLocation modelLoc0 = new ModelResourceLocation(
            new ResourceLocation(Techguns.MODID, "helicopter0"), "inventory");
    private static final ModelResourceLocation modelLoc1 = new ModelResourceLocation(
            new ResourceLocation(Techguns.MODID, "helicopter1"), "inventory");
    private static final ModelResourceLocation modelLoc2 = new ModelResourceLocation(
            new ResourceLocation(Techguns.MODID, "helicopter2"), "inventory");
    ...
    public static IBakedModel loadAndBakedModel(ModelResourceLocation model_loc, ResourceLocation tex) {
        ...
        IBakedModel bakedModel = model.bake(TRSRTransformation.identity(), DefaultVertexFormats.ITEM, r -> {
            ...
            try {
                PngSizeInfo png = PngSizeInfo
                        .makeFromResource(Minecraft.getMinecraft().getResourceManager().getResource(tex));
    ...
    public void doRender(AttackHelicopter entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        GlStateManager.rotate(-interp(entity.rotationYaw, entity.prevRotationYaw, partialTicks) - 90f, 0.0F, 1.0F,
                0.0F);
