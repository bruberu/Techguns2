    ...
    public void render(FabricatorTileEntMaster te, double x, double y, double z, float partialTicks, int destroyStage,
        ...
        if (te != null && te.isFormed()) {
            ...
            if (!itemStack.isEmpty()) {
                ...
                // Minecraft.getMinecraft().getRenderManager().doRenderEntity(this.entItem, 0.6, /*-1.25D +0.625D +0.9*/
                // 0.275, -0.5, 93.5F, 0.0f, false);
                Minecraft.getMinecraft().getRenderManager().renderEntity(this.entItem, -0.5f, 0f, -0.6f, 93.5F, 0.0f,
                        false);
