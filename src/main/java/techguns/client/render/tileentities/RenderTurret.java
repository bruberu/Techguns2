...
public class RenderTurret extends TileEntitySpecialRenderer<TurretTileEnt> {
    ...
    protected static final ResourceLocation defaultTexture = new ResourceLocation(Techguns.MODID,
            "textures/blocks/turret_base.png");
    ...
    @Override
    public void render(TurretTileEnt te, double x, double y, double z, float partialTicks, int destroyStage,
                       float alpha) {
