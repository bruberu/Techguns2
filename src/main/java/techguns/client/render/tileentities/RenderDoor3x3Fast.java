...
public class RenderDoor3x3Fast extends FastTESR<Door3x3TileEntity> {
    ...
    // protected static final ResourceLocation doorframe_loc = new
    // ResourceLocation(Techguns.MODID,"block/techdoor3x3_frame");
    protected static final ResourceLocation door_left_loc = new ResourceLocation(Techguns.MODID,
            "block/techdoor3x3_left");
    protected static final ResourceLocation door_right_loc = new ResourceLocation(Techguns.MODID,
            "block/techdoor3x3_right");
    protected static final ResourceLocation door_left_loc_nether = new ResourceLocation(Techguns.MODID,
            "block/techdoor3x3_left_nether");
    protected static final ResourceLocation door_right_loc_nether = new ResourceLocation(Techguns.MODID,
            "block/techdoor3x3_right_nether");

    // protected static final ResourceLocation hangar_up_upper_loc = new
    // ResourceLocation(Techguns.MODID,"block/hangar_door_upperj");
    protected static final ResourceLocation hangar_up_mid_loc = new ResourceLocation(Techguns.MODID,
            "block/hangar_door_mid1j");
    protected static final ResourceLocation hangar_up_mid2_loc = new ResourceLocation(Techguns.MODID,
            "block/hangar_door_mid2j");
    protected static final ResourceLocation hangar_up_mid3_loc = new ResourceLocation(Techguns.MODID,
            "block/hangar_door_mid3j");
    protected static final ResourceLocation hangar_up_lower_loc = new ResourceLocation(Techguns.MODID,
            "block/hangar_door_lower.obj");
    protected static final ResourceLocation hangar_down_upper_loc = new ResourceLocation(Techguns.MODID,
            "block/hangar_door_down_upper.obj");

    public static IBakedModel loadBakedModel(ResourceLocation model_loc, IModelState transform) {
        IModel model = ModelLoaderRegistry.getModelOrLogError(model_loc,
                "Could not load model:" + model_loc.toString());
        return model.bake(transform, DefaultVertexFormats.ITEM/* Attributes.DEFAULT_BAKED_FORMAT */,
    ...
    public void renderTileEntityFast(Door3x3TileEntity te, double x, double y, double z, float partialTicks,
        ...
        if (state.getValue(BlockTGDoor3x3.STATE) == EnumDoorState.OPENED ||
                state.getValue(BlockTGDoor3x3.STATE) == EnumDoorState.CLOSED) {
            return;
        }
        ...
        switch (te.getDoorType()) {
            case 0:
                this.renderDoor0(world, state, buffer, pos, zplane, px, py, pz, prog, doorsegment_l, doorsegment_r,
                        doorsegment_l_90, doorsegment_r_90);
                break;
            case 1:
            ...
            case 2:
                ...
                break;
            case 3:
                this.renderDoor0(world, state, buffer, pos, zplane, px, py, pz, prog, doorsegment_l_nether,
                        doorsegment_r_nether, doorsegment_l_90_nether, doorsegment_r_90_nether);
                break;
        }
    ...
    protected void renderDoor0(IBlockAccess world, IBlockState state, BufferBuilder buffer, BlockPos pos,
                               boolean zplane, double px, double py, double pz, float prog, IBakedModel L,
                               IBakedModel R, IBakedModel L90, IBakedModel R90) {
     ...
     * HangarDoor up
     */
    protected void renderDoor1(IBlockAccess world, IBlockState state, BufferBuilder buffer, BlockPos pos,
                               boolean zplane, double px, double py, double pz, float prog) {
     ...
     * HangarDoor down
     */
    protected void renderDoor2(IBlockAccess world, IBlockState state, BufferBuilder buffer, BlockPos pos,
                               boolean zplane, double px, double py, double pz, float prog) {
        IBakedModel model_segment = hangar_up_mid;
        IBakedModel model_segment2 = hangar_up_mid2;
        IBakedModel model_segment3 = hangar_up_mid3;
