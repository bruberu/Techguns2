...
public class GunAnimation {
    ...
    public static GunAnimation genericRecoil = new GunAnimation().addTranslate(0, 0, 1.0f).addRotate(1.0f, 1.0f, 0, 0)
            .addSegment(0, 0.25f, C_FAST, 0f, 1f).addSegment(0.25f, 1f, C_SMOOTH, 1f, 0f);
    public static GunAnimation swayRecoil = new GunAnimation().addTranslate(1.0f, 0.75f, 0.50f)
            .addRotate(1.0f, 1.0f, -0.75f, 0.25f).addSegment(0, 1.0f, C_SINUS, 0.0f, 1.0f);

    public static GunAnimation genericReload = new GunAnimation().addTranslate(-0.15f, -0.05f, 0.15f)
            .addRotate(1.0f, -0.5f, 1.0f, -0.25f).addSegment(0, 0.2f, C_SMOOTH, 0f, 1f)
            .addSegment(0.2f, 0.8f, C_LINEAR, 1.0f, 1.0f).addSegment(0.8f, 1.0f, C_SMOOTH, 1.0f, 0.0f);
    public static GunAnimation breechReload = new GunAnimation().addTranslate(0, 1.0f, -1.0f)
            .addRotate(1.0f, -1.0f, 0f, 0f).addSegment(0, 0.25f, C_SMOOTH, 0f, 1f)
            .addSegment(0.25f, 0.5f, C_LINEAR, 1f, 1f).addSegment(0.5f, 0.85f, C_SMOOTH, 1.0f, -0.25f)
            .addSegment(0.85f, 1f, C_SMOOTH, -0.25f, 0f);

    public static GunAnimation scopeRecoil = new GunAnimation().addTranslate(0.25f, 1.0f, 0.75f)
            .addRotate(1.0f, 1.0f, 0, 0).addSegment(0, 0.25f, C_FAST, 0f, 1f).addSegment(0.25f, 1f, C_SMOOTH, 1f, 0f);
    public static GunAnimation scopeRecoilAdv = new GunAnimation().addTranslate(1.0f, 0f, 0f).addTranslate(0.0f, 1f, 0f)
            .addTranslate(0.0f, 0f, 1f).addRotate(1.0f, 1.0f, 0, 0).addSegment(0, 0.25f, C_FAST, 0f, 1f)
            .addSegment(0.25f, 1f, C_SMOOTH, 1f, 0f);

    public static GunAnimation pulseRifleRecoil = new GunAnimation().addTranslate(0, 0, 1.0f)
            .addRotate(1.0f, 1.0f, 0, 0).addSegment(0, 0.1f, C_FAST, 0f, 0.4f)
            .addSegment(0.1f, 0.2f, C_SMOOTH, 0.4f, 0.3f).addSegment(0.2f, 0.40f, C_FAST, 0.3f, 1f)
            .addSegment(0.40f, 1f, C_SMOOTH, 1f, 0f);

    public static GunAnimation swordSweepRecoil = new GunAnimation().addRotate(1.0f, 0, 0, 1.0f)
            .addSegment(0, 0.25f, C_FAST, 0f, 1f).addSegment(0.25f, 1f, C_SMOOTH, 1f, 0f);
