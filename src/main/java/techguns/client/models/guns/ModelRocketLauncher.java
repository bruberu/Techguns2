...
public class ModelRocketLauncher extends ModelMultipart {
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        if (part == 0) {
            ...
            if ((reloadProgress == 0 && ammoLeft > 0) || (reloadProgress > 0.5f)) {
                this.rocket.render(entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale,
                        ammoLeft, reloadProgress, transformType, part, fireProgress, chargeProgress);
            }
        }
    }
    ...
    protected static class ModelRocket extends ModelMultipart {
        ...
        public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
                           ...
                           TransformType transformType, int part,
