    ...
    public void render(float scale, Entity entityIn) {
        ...
        if (entityIn != null && entityIn instanceof EntityPlayer) {
            ...
            if (showFlames) {
                 ...
                 * }
                 */
                ClientProxy.get().createFX("FlamethrowerTrailFlames", entityPlayer.world, entityPlayer.posX + offsetX,
                        entityPlayer.posY + offsetY, entityPlayer.posZ + offsetZ, 0, motiony, 0);
                ClientProxy.get().createFX("FlamethrowerTrailFlames", entityPlayer.world, entityPlayer.posX + offsetX2,
                        entityPlayer.posY + offsetY, entityPlayer.posZ + offsetZ2, 0, motiony, 0);
            }
        }
    }
