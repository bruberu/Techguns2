...
public class PacketSpawnParticleOnEntity implements IMessage {
    ...
    public PacketSpawnParticleOnEntity(String name, Entity ent, float offsetX, float offsetY, float offsetZ,
    ...
    public static class Handler implements IMessageHandler<PacketSpawnParticleOnEntity, IMessage> {
        ...
        private void handle(PacketSpawnParticleOnEntity m, MessageContext ctx) {
            ...
            if (ent != null) {
                ...
                // }else {
                ClientProxy.get().createFXOnEntityWithOffset(m.name, ent, m.offsetX, m.offsetY, m.offsetZ,
                        m.attachToHead, m.condition);
                // }
            } else {
