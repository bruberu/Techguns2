...
public class DeatomizerProjectile extends GenericProjectile {
    ...
    protected void doImpactEffects(Material mat, RayTraceResult rayTraceResult, SoundType sound) {
         ...
         * 
         * TGPackets.network.sendToAllAround(new PacketSpawnParticle("BlueBlasterExplosion",x,y,z),
         * TGPackets.targetPointAroundEnt(this, 32.0f));
         * }
         */
        Techguns.proxy.createFX("BlueBlasterExplosion", world, rayTraceResult.hitVec.x, rayTraceResult.hitVec.y,
    ...
    public static class Factory implements IProjectileFactory<DeatomizerProjectile> {
        ...
        @Override
        public DeatomizerProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
            ...
            return new DeatomizerProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin,
