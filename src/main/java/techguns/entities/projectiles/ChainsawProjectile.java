...
public class ChainsawProjectile extends GenericProjectile {
    ...
    public static class Factory implements IChargedProjectileFactory<ChainsawProjectile> {
        ...
        @Override
        public ChainsawProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
            ...
            return new ChainsawProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin,
