...
public class StoneBulletProjectile extends GenericProjectile {
    ...
    public StoneBulletProjectile(World worldIn, double posX, double posY, double posZ, float yaw, float pitch,
    ...
    public StoneBulletProjectile(World par2World, EntityLivingBase p, float damage, float speed, int TTL, float spread,
    ...
    public static class Factory implements IProjectileFactory<StoneBulletProjectile> {
        ...
        @Override
        public StoneBulletProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
            ...
            return new StoneBulletProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin,
