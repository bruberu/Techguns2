...
public class GaussProjectile extends AdvancedBulletProjectile implements ILightProvider {
    ...
    protected void onHitEffect(EntityLivingBase ent, RayTraceResult rayTraceResult) {
         ...
         * TGPackets.network.sendToAllAround(new PacketSpawnParticle("GaussRifleImpact_Block", x,y,z),
    ...
    public static class Factory implements IProjectileFactory<GaussProjectile> {
        ...
        @Override
        public GaussProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
            ...
            TGPackets.network.sendToAllAround(
                    new PacketSpawnParticleOnEntity("GaussFireFX", p, offsetX, offsetY, offsetZ, true),
                    TGPackets.targetPointAroundEnt(p, 25.0f));
            return new GaussProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin,
