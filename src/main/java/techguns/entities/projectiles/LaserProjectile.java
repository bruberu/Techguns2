...
public class LaserProjectile extends AbstractBeamProjectile {
    ...
    public static class Factory implements IProjectileFactory<LaserProjectile> {
        ...
        @Override
        public LaserProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
                                                float speed,
                                                ...
                                                double gravity) {
            return new LaserProjectile(world, p, damage, speed, 7, spread, dmgDropStart, dmgDropEnd, dmgMin,
