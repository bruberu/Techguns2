...
public class FlyingGibs extends Entity {
    ...
    public FlyingGibs(World world, EntityLivingBase entity, GoreData data, double posX, double posY, double posZ,
                      double motionX, double motionY, double motionZ, float size, int bodypart) {
        super(world);
    ...
    public void onUpdate() {
        ...
        if (this.onGround) {
            ...
            f = (float) (this.world.getBlockState(new BlockPos(this.posX, this.posY, this.posZ))
                    .getBlock().slipperiness * 0.98);
