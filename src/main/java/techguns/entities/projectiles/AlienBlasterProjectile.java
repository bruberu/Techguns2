...
public class AlienBlasterProjectile extends GenericProjectile implements ILightProvider {
    ...
    protected void doImpactEffects(Material mat, RayTraceResult rayTraceResult, SoundType sound) {
         ...
         * TGPackets.network.sendToAllAround(new PacketSpawnParticle("AlienExplosion", x,y,z),
         * TGPackets.targetPointAroundEnt(this, 32.0f));
         * }
         */
        Techguns.proxy.createFX("AlienExplosion", world, rayTraceResult.hitVec.x, rayTraceResult.hitVec.y,
    ...
    public static class Factory implements IProjectileFactory<AlienBlasterProjectile> {
        ...
        @Override
        public AlienBlasterProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
            ...
            return new AlienBlasterProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin,
