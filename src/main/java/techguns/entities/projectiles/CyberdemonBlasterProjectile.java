...
public class CyberdemonBlasterProjectile extends GenericProjectile {
    ...
    protected void doImpactEffects(Material mat, RayTraceResult rayTraceResult, SoundType sound) {
         ...
         * 
         * TGPackets.network.sendToAllAround(new PacketSpawnParticle("CyberdemonBlasterImpact", x,y,z),
         * TGPackets.targetPointAroundEnt(this, 32.0f));
         * }
         */
        Techguns.proxy.createFX("CyberdemonBlasterImpact", world, rayTraceResult.hitVec.x, rayTraceResult.hitVec.y,
    ...
    public static class Factory implements IProjectileFactory<CyberdemonBlasterProjectile> {
        ...
        @Override
        public CyberdemonBlasterProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p,
                                                            float damage, float speed, int TTL, float spread,
                                                            float dmgDropStart, float dmgDropEnd,
                                                            float dmgMin, float penetration, boolean blockdamage,
                                                            EnumBulletFirePos firePos, float radius, double gravity) {
            return new CyberdemonBlasterProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd,
