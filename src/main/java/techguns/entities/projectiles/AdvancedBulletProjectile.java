...
public class AdvancedBulletProjectile extends GenericProjectile {
    ...
    public AdvancedBulletProjectile(World world, EntityLivingBase p, float damage, float speed, int TTL, float spread,
        ...
        super(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin, penetration, blockdamage,
                leftGun);
    }
    ...
    public static class Factory implements IProjectileFactory<AdvancedBulletProjectile> {
        ...
        @Override
        public AdvancedBulletProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
            ...
            return new AdvancedBulletProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin,
