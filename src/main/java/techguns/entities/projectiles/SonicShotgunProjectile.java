...
public class SonicShotgunProjectile extends GenericProjectile implements IEntityAdditionalSpawnData {
        ...
        if (mainProjectile) {
            if (!this.world.isRemote) {
                TGPackets.network.sendToAllAround(
                        new PacketSpawnParticle("SonicShotgunImpact", this.posX, this.posY, this.posZ),
    ...
    public static class Factory implements IProjectileFactory<SonicShotgunProjectile> {
        ...
        @Override
        public SonicShotgunProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
            ...
            return new SonicShotgunProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin,
