...
public class RocketProjectileHV extends RocketProjectile {
    ...
    public static class Factory implements IProjectileFactory<RocketProjectileHV> {
        ...
        @Override
        public RocketProjectileHV createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
            ...
            return new RocketProjectileHV(world, p, mod.getDamage(damage), mod.getVelocity(speed), mod.getTTL(TTL),
                    spread, mod.getRange(dmgDropStart), mod.getRange(dmgDropEnd), mod.getDamage(dmgMin), penetration,
