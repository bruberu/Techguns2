...
public class Grenade40mmProjectile extends GrenadeProjectile {
    ...
    public Grenade40mmProjectile(World worldIn, double posX, double posY, double posZ, float yaw, float pitch,
                                 float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
                                 float dmgMin, float penetration,
                                 boolean blockdamage, EnumBulletFirePos leftGun, double gravity, float radius,
                                 int bounces) {
    ...
    public Grenade40mmProjectile(World par2World, EntityLivingBase p, float damage, float speed, int TTL, float spread,
        ...
        super(par2World, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin, penetration, blockdamage,
                leftGun, gravity, radius, bounces);
    }
    ...
    public static class Factory implements IProjectileBounceFactory<Grenade40mmProjectile> {
        ...
        @Override
        public Grenade40mmProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
                                                      ...
                                                      double gravity) {
            return new Grenade40mmProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin,
                    penetration, blockdamage, firePos, gravity, radius, 2);
        }

        @Override
        public Grenade40mmProjectile createBounceProjectile(Grenade40mmProjectile proj, double bounceX, double bounceY,
                                                            double bounceZ) {
