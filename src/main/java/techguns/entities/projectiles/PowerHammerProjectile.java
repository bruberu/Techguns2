...
public class PowerHammerProjectile extends GenericProjectile {
    ...
    public static class Factory implements IChargedProjectileFactory<PowerHammerProjectile> {
        ...
        @Override
        public PowerHammerProjectile createProjectile(GenericGun gun, World world, EntityLivingBase p, float damage,
            ...
            return new PowerHammerProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin,
        ...
        public PowerHammerProjectile createChargedProjectile(World world, EntityLivingBase p, float damage, float speed,
                                                             int TTL, float spread, float dmgDropStart,
                                                             float dmgDropEnd, float dmgMin, float penetration,
                                                             boolean blockdamage, EnumBulletFirePos firePos,
                                                             float radius, double gravity, float charge,
                                                             int ammoConsumed) {
            // TODO check Charged Damage
            return new PowerHammerProjectile(world, p, damage * ammoConsumed, speed, TTL, spread, dmgDropStart,
                    dmgDropEnd, dmgMin * ammoConsumed, penetration, blockdamage, firePos);
        }
    }
}
