...
public class FragGrenadeProjectile extends GrenadeProjectile {
    ...
    public static class Factory implements IGrenadeProjectileFactory<FragGrenadeProjectile> {
        ...
        @Override
        public FragGrenadeProjectile createProjectile(World world, EntityLivingBase p, float damage, float speed,
            ...
            return new FragGrenadeProjectile(world, p, damage, speed, TTL, spread, dmgDropStart, dmgDropEnd, dmgMin,
        ...
        @Override
        public FragGrenadeProjectile createBounceProjectile(FragGrenadeProjectile proj, double bounceX, double bounceY,
                                                            double bounceZ) {
