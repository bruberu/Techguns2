...
public class NPCTurret extends EntityCreature implements IAnimals, IRangedAttackMob, INPCTechgunsShooter, ITGNpcTeam {
    ...
    // private EntityAIAttackOnCollide aiAttackOnCollide = new EntityAIAttackOnCollide(this, EntityMob.class, 1.2D,
    // false);
    ...
    public void onUpdate() {
        ...
        if (!world.isRemote) {
             ...
             * if (this.mountedTileEnt == null && networkUpdateRequestDelay <=0 &&
             * Techguns.proxy.clientInRangeSquared(this.posX, this.posZ, 4096)){
    ...
    public void setAITasks() {
        ...
        if (aiTarget == null) {
            this.aiTarget = new TurretEntityAINearestAttackableTarget(this, EntityLivingBase.class, 0, true, false,
                                ...
                                if (pvp != 0 && owner != null) {
                                    ...
                                    if (entity instanceof NPCTurret) {
                                        ...
                                        if (otherTurret.mountedTileEnt != null) {
                                            ...
                                            return TGNpcFactions.shouldAttack(owner, otherOwner,
                                                    NPCTurret.this.mountedTileEnt.getPvpSetting());
                                        }
                                        ...
                                        if (ply != null) {
                                            ...
                                            return TGNpcFactions.shouldAttack(owner, ply,
                                                    NPCTurret.this.mountedTileEnt.getPvpSetting());
                                        }
                                    }

                                }
                                if (NPCTurret.this.mountedTileEnt.attackAnimals && entity instanceof IAnimals &&
                                        !(entity instanceof NPCTurret)) {
