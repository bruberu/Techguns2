...
public class AlienBug extends EntitySpider implements ITGNpcTeam, INpcTGDamageSystem, ITGSpawnerNPC {
    ...
    protected static final ResourceLocation LOOT = null; // TODO //new ResourceLocation(Techguns.MODID,
                                                         // "entities/alienbug");
        ...
        public void startExecuting() {
            ...
            if (!this.taskOwner.world.isRemote) {
                TGPackets.network.sendToAllAround(
                        new PacketPlaySound(TGSounds.ALIENBUG_AGGRO, this.taskOwner, 1.0f, 1.0f,
                                false, false, TGSoundCategory.HOSTILE),
                        TGPackets.targetPointAroundEnt(taskOwner, 24.0f));
            }
        }
    }
    ...
    public boolean attackEntityAsMob(Entity ent) {
        ...
        if (!this.world.isRemote) {
            TGPackets.network.sendToAllAround(new PacketPlaySound(TGSounds.ALIENBUG_BITE, this, 2.0f, 1.0f, false,
                    false, TGSoundCategory.HOSTILE), TGPackets.targetPointAroundEnt(this, 24.0f));
        }
