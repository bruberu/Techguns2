...
public abstract class GenericFlyingMob extends EntityFlying
                                       implements IMob, INpcTGDamageSystem, INPCTechgunsShooter, ITGSpawnerNPC {
    ...
    protected static class AIRandomFly extends EntityAIBase {
        ...
        public void startExecuting() {
            ...
            this.parentEntity.getMoveHelper().setMoveTo(d0,
                    getGroundLevel(this.parentEntity) + this.parentEntity.getTargetFlyHeight(), d2, 1.0D);
        }
