...
public class TurretEntityAIWatchClosest extends EntityAIBase {
    ...
    public TurretEntityAIWatchClosest(EntityLiving entityIn, Class<? extends Entity> watchTargetClass,
                                      float maxDistance, double yOffset) {
    ...
    public TurretEntityAIWatchClosest(EntityLiving entityIn, Class<? extends Entity> watchTargetClass,
                                      float maxDistance, float chanceIn, double yOffset) {
        this.entity = entityIn;
        this.watchedClass = watchTargetClass;
        this.maxDistanceForPlayer = maxDistance;
    ...
    public boolean shouldExecute() {
        if (this.entity.getRNG().nextFloat() >= this.chance) {
            ...
            if (this.watchedClass == EntityPlayer.class) {
                ...
                this.closestEntity = this.entity.world.findNearestEntityWithinAABB(this.watchedClass,
                        this.entity.getEntityBoundingBox().grow((double) this.maxDistanceForPlayer, this.yOffset,
    ...
    public void updateTask() {
        this.entity.getLookHelper().setLookPosition(this.closestEntity.posX,
