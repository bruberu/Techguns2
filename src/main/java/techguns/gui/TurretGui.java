...
public class TurretGui extends PoweredTileEntGui {
    ...
    public static final ResourceLocation texture = new ResourceLocation(Techguns.MODID,
            "textures/gui/turret_base_gui.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (this.isInRect(mx, my, 115, 73, 53, 5)) {
            if (this.tile.turretDeath) {
                this.drawHoveringText(
                        TextUtil.trans("techguns.container.repair") + " " + this.tile.repairTime / 20 + "s", my, my);
            } else {
                if (tile.mountedTurret != null) {
                    this.drawHoveringText(TextUtil.trans("techguns.turret.health") + ": " +
                            tile.mountedTurret.getHealth() + "/" + tile.mountedTurret.getMaxHealth(), mx, my);
                }
            }
        }
        ...
        if (this.isInRect(mx, my, -22, 70, 20, 20)) {
            this.drawHoveringText(TextUtil.trans("techguns.turret.targetAnimals") + ": " +
                    (this.tile.attackAnimals ? ChatFormatting.RED + TextUtil.trans("techguns.yes") :
                            ChatFormatting.GREEN + TextUtil.trans("techguns.no")),
                    mx, my);
            ...
            tooltip.add(TextUtil.trans("techguns.turret.pvpsetting") + ": " +
                    TextUtil.trans("techguns.turret.pvpsetting." + tile.getPvpSetting()));
    ...
    public void initGui() {
        super.initGui();
        this.buttonList.add(new GuiButtonTargetAnimals(TurretTileEnt.BUTTON_ID_TARGET_ANIMALS, this.guiLeft - 22,
                this.guiTop + 70, 20, 20, this.tile));
        this.buttonList.add(new GuiButtonPvPSetting(TurretTileEnt.BUTTON_ID_PVP_SETTING, this.guiLeft - 22,
                this.guiTop + 100, 20, 20, this.tile));
    }
}
