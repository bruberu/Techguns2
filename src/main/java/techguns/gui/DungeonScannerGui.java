...
public class DungeonScannerGui extends OwnedTileEntGui {
    ...
    public static final ResourceLocation texture = new ResourceLocation(Techguns.MODID,
            "textures/gui/dungeon_scanner_gui.png");// new
    ...
    protected void actionPerformed(GuiButton guibutton) {
        if (textInput.length() > 0 && (guibutton.id == DungeonScannerTileEnt.BUTTON_ID_SCAN ||
                guibutton.id == DungeonScannerTileEnt.BUTTON_ID_PLACE)) {
    ...
    public void initGui() {
        super.initGui();
        this.buttonList.add(new GuiButtonExt(DungeonScannerTileEnt.BUTTON_ID_GHOST, this.guiLeft + 5, this.guiTop + 5,
                12, 12, "G"));

        this.buttonList.add(new GuiButtonExt(DungeonScannerTileEnt.BUTTON_ID_SIZE_XZ_MINUS, this.guiLeft + 5,
                this.guiTop + 27, 12, 12, "-"));
        this.buttonList.add(new GuiButtonExt(DungeonScannerTileEnt.BUTTON_ID_SIZE_XZ_PLUS, this.guiLeft + 18,
                this.guiTop + 27, 12, 12, "+"));

        this.buttonList.add(new GuiButtonExt(DungeonScannerTileEnt.BUTTON_ID_SIZE_Y_MINUS, this.guiLeft + 5,
                this.guiTop + 50, 12, 12, "-"));
        this.buttonList.add(new GuiButtonExt(DungeonScannerTileEnt.BUTTON_ID_SIZE_Y_PLUS, this.guiLeft + 18,
                this.guiTop + 50, 12, 12, "+"));

        this.buttonList.add(new GuiButtonExt(DungeonScannerTileEnt.BUTTON_ID_SCAN, this.guiLeft + 5, this.guiTop + 81,
                31, 12, "scan"));
        this.buttonList.add(new GuiButtonExt(DungeonScannerTileEnt.BUTTON_ID_PLACE, this.guiLeft + 38, this.guiTop + 81,
                31, 12, "load"));

        this.buttonList.add(new GuiButtonExt(DungeonScannerTileEnt.BUTTON_ID_CLEAR, this.guiLeft + 5, this.guiTop + 149,
                12, 12, "C"));

        this.buttonList.add(new GuiButtonExt(DungeonScannerTileEnt.BUTTON_ID_COPY_FIRST, this.guiLeft + 5,
                this.guiTop + 97, 64, 12, "Copy 1st Segment"));
