...
public class OreDrillGui extends PoweredTileEntGui {
    ...
    public static final ResourceLocation texture = new ResourceLocation(Techguns.MODID,
            "textures/gui/ore_drill_gui.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (this.isInRect(mx, my, 74, 16, 27, 39)) {
            ...
            tooltip.add(TextUtil.trans("techguns.gui.oredrill.orehour") + ": " +
                    String.format("%.2f", 1200.0 / this.tile.totaltime * 60.0));
            ...
            // tooltip.add(TextUtil.trans("techguns.oredrill.enginesize")+":
            // "+tile.getEngines()+"x"+(tile.getRadius()*2+1)+"x"+(tile.getRadius()*2+1)+":
            // "+(tile.getEngines()*(tile.getRadius()*2+1)*(tile.getRadius()*2+1)));
            ...
            List<String> tooltip = new ArrayList<String>();
            tooltip.add(info.fluid != null ? (info.fluid.getFluid().getLocalizedName(info.fluid)) :
                    TextUtil.trans("techguns.gui.empty"));
            ...
            if (this.tile.getCurrentFuelBufferMax() > 0) {
                ...
                tooltip.add(TextUtil.trans("techguns.oredrill.remaining") + ": " + ticksLeft + " " +
                        TextUtil.trans("techguns.oredrill.ticks"));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (this.tile.outputTank.getFluidAmount() > 0) {
            ...
            TextureAtlasSprite tex = mc.getTextureMapBlocks()
                    .getTextureExtry(tile.outputTank.getFluid().getFluid().getStill().toString());
