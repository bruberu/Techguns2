...
public class Door3x3Gui extends RedstoneTileEntGui {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.fontRenderer.drawString((tile.getDoormode() == 0 ? "" : ChatFormatting.STRIKETHROUGH) +
                TextUtil.trans(Techguns.MODID + ".container.door3x3.autoclose"), 44, 20 + 20, color);

        if (tile.getDoormode() == 1 && tile.getRedstoneBehaviour() == 0) {
            this.fontRenderer.drawString(
                    ChatFormatting.RED + TextUtil.trans(Techguns.MODID + ".container.door3x3.redstonewarning"), 44,
                    20 + 40, color);
        }
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonExt(Door3x3TileEntity.BUTTON_ID_DOORMODE, this.guiLeft + 8, this.guiTop + 16,
                32, 16, TextUtil.trans(Techguns.MODID + ".mode")));
        this.buttonList.add(new GuiButtonDoorRightClickSetting(Door3x3TileEntity.BUTTON_ID_AUTOCLOSE, this.guiLeft + 8,
                this.guiTop + 16 + 20, 32, 16, tile, 1));
    }
}
