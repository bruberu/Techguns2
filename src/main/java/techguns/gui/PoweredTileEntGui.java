...
public abstract class PoweredTileEntGui extends RedstoneTileEntGui {
    ...
    public static final ResourceLocation power_texture = new ResourceLocation(Techguns.MODID,
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        // draw power bar
        int power = (int) (this.poweredTileEnt.getEnergyStorage().getEnergyStored() * 48 /
                this.poweredTileEnt.getEnergyStorage().getMaxEnergyStored());
        int diff = 48 - power;
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (isInRect(mx, my, 7, 17, 5, 49)) {
            if (TGConfig.machinesNeedNoPower) {
                ...
                this.drawHoveringText(TextUtil.trans("techguns.container.power") + ": " +
                        this.poweredTileEnt.getEnergyStorage().getEnergyStored() + "/" +
                        this.poweredTileEnt.getEnergyStorage().getMaxEnergyStored() + " " + POWER_UNIT, mx, my);
            }
        }
    }
}
