...
public class AmmoPressGui extends PoweredTileEntGui {
    ...
    public static final ResourceLocation texture = new ResourceLocation(Techguns.MODID,
            "textures/gui/ammo_press_gui.png");// new
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.fontRenderer.drawString(TextUtil.trans(Techguns.MODID + ".gui.ammopress.build") + ":", x + 20, y + 30,
                color);
    ...
    public void initGui() {
        ...
        this.buttonList.add(
                new GuiButtonExt(AmmoPressTileEnt.BUTTON_ID_NEXT, this.guiLeft + 40, this.guiTop + 50, 20, 20, ">"));
        this.buttonList.add(
                new GuiButtonExt(AmmoPressTileEnt.BUTTON_ID_PREV, this.guiLeft + 20, this.guiTop + 50, 20, 20, "<"));
    }
}
