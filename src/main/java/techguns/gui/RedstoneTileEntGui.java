...
public class RedstoneTileEntGui extends OwnedTileEntGui {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (isInRect(mx, my, 6, 5, 10, 5) || isInRect(mx, my, -22, 10, 20, 20)) {
            ...
            tooltip.add(TextUtil.trans("techguns.container.redstone.mode") + ": " +
                    TextUtil.trans(redstoneTileEnt.getRedstoneModeText()));
            tooltip.add(TextUtil.trans("techguns.container.redstone.signal") + ": " +
                    TextUtil.trans(redstoneTileEnt.getSignalStateText()));
    ...
    public void initGui() {
        super.initGui();
        this.buttonList.add(new GuiButtonRedstoneState(BUTTON_ID_REDSTONE, this.guiLeft - 22, this.guiTop + 10, 20, 20,
                "", redstoneTileEnt));
    }
}
