...
public class UpgradeBenchGui extends OwnedTileEntGui {
    ...
    public static final ResourceLocation texture = new ResourceLocation(Techguns.MODID,
            "textures/gui/upgrade_bench_gui.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (!this.container.outputSlot.getStackInSlot(0).isEmpty()) {
            ...
            this.drawTexturedModalRect(k + 37, l + 40, 0 + x, 167 + y, 89, 31, c.getRed(), c.getGreen(), c.getBlue(),
                    255);
        }
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        int color = (this.mc.player.capabilities.isCreativeMode || xp <= this.mc.player.experienceTotal) ? 8453920 :
                16736352; // same colors as anvil.
