...
public class GuiButtonRedstoneState extends GuiButtonExt {
    ...
    public static final ResourceLocation texture_redstonestates = new ResourceLocation(Techguns.MODID,
            "textures/gui/ammo_press_gui.png");

    public GuiButtonRedstoneState(int id, int xPos, int yPos, int width, int height, String displayString,
