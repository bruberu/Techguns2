...
public class DungeonGeneratorGui extends OwnedTileEntGui {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonExt(DungeonGeneratorTileEnt.BUTTON_ID_GHOST, this.guiLeft + 5, this.guiTop + 5,
                12, 12, "G"));

        this.buttonList.add(new GuiButtonExt(DungeonGeneratorTileEnt.BUTTON_ID_GENERATE, this.guiLeft + 5,
                this.guiTop + 81, 64, 12, "generate"));

        this.buttonList.add(new GuiButtonExt(DungeonGeneratorTileEnt.BUTTON_ID_CLEAR, this.guiLeft + 5,
                this.guiTop + 149, 12, 12, "C"));
    }
}
