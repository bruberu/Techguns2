...
public class MetalPressGui extends PoweredTileEntGui {
    ...
    public static final ResourceLocation texture = new ResourceLocation(Techguns.MODID,
            "textures/gui/metal_press_gui.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.fontRenderer.drawString(TextUtil.trans("techguns.container.metalpress.autosplit") + ":", x + 20, y + 30,
                color);
    ...
    public void initGui() {
        super.initGui();
        this.buttonList.add(new GuiButtonExt(MetalPressTileEnt.BUTTON_ID_AUTOSPLIT, this.guiLeft + 20, this.guiTop + 50,
                40, 20, TextUtil.trans("techguns.button.switch")));
    }
}
