...
public abstract class OwnedTileEntGui extends TGBaseGui {
    ...
    public static final ResourceLocation security_texture = new ResourceLocation(Techguns.MODID,
            "textures/gui/ammo_press_gui.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (isInRect(mx, my, -22, heightSecurityButton, 20, 20)) {
            ...
            if (owner != null) {
                own = TextUtil.trans("techguns.container.security.tooltip.owner") + ": " +
                        ClientProxy.get().resolvePlayerNameFromUUID(owner);
            }
            ...
            tooltip.add(TextUtil.trans("techguns.container.security.tooltip") + ": " + color +
                    TextUtil.trans("techguns.container.security.tooltip." + type));
    ...
    public void initGui() {
        super.initGui();
        this.buttonList.add(new GuiButtonSecurity(BUTTON_ID_SECURITY, this.guiLeft - 22,
                this.guiTop + heightSecurityButton, 20, 20, "", ownedTile));
    }
}
