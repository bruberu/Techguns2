...
public class ReactionChamberGui extends PoweredTileEntGui {
    ...
    public static final ResourceLocation texture = new ResourceLocation(Techguns.MODID,
            "textures/gui/reaction_chamber_gui.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (this.tile.inputTank.getFluidAmount() > 0) {
            ...
            TextureAtlasSprite tex = mc.getTextureMapBlocks()
                    .getTextureExtry(tile.inputTank.getFluid().getFluid().getStill().toString());

            this.drawFluidWithTesselator(tex, k + ChemLabGui.INPUT_TANK_X + 1, l + ChemLabGui.TANK_Y, ChemLabGui.TANK_W,
                    ChemLabGui.TANK_H, px);
        }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (this.isInRect(mx, my, 18, 16, 11, 51)) {
            ...
            tooltip.add(TextUtil.trans(
                    info.fluid != null ? info.fluid.getFluid().getUnlocalizedName() : Techguns.MODID + ".gui.empty"));
    ...
    public void initGui() {
        ...
        int left = 33;
        this.buttonList.add(new GuiButtonExt(ReactionChamberTileEntMaster.BUTTON_ID_LIQUIDLEVEL_INC,
                this.guiLeft + left, this.guiTop + 58, 10, 10, "+"));
        this.buttonList.add(new GuiButtonExt(ReactionChamberTileEntMaster.BUTTON_ID_LIQUIDLEVEL_DEC,
                this.guiLeft + left + 10, this.guiTop + 58, 10, 10, "-"));

        left = 91;
        this.buttonList.add(new GuiButtonExt(ReactionChamberTileEntMaster.BUTTON_ID_INTENSITY_INC, this.guiLeft + left,
                this.guiTop + 36, 10, 10, "+"));
        this.buttonList.add(new GuiButtonExt(ReactionChamberTileEntMaster.BUTTON_ID_INTENSTIY_DEC,
                this.guiLeft + left + 10, this.guiTop + 36, 10, 10, "-"));

        this.buttonList.add(new GuiButtonExt(ReactionChamberTileEntMaster.BUTTON_ID_DUMPTANK, this.guiLeft + 20,
                this.guiTop + 7, 8, 8, "x"));
    }
}
