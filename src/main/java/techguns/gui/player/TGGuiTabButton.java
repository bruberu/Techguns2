...
public class TGGuiTabButton extends GuiButton {
    ...
    // private static final ResourceLocation tabButtonTextures = new
    // ResourceLocation(Techguns.MODID,"textures/gui/tgplayerinventory.png");
    private static final ResourceLocation tabs_texture = new ResourceLocation("minecraft",
