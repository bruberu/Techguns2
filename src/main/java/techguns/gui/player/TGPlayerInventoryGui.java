...
public class TGPlayerInventoryGui extends TGBaseGui {
    ...
    private List<String> getTooltipForToggleButton(int index) {
        ...
        if (index == 0) {
            ...
            tooltip.add(trans("tgguitooltip.current") + ": " + (!state ? "\u00A7c" : "\u00A7a") +
                    trans("tgguitooltip." + (state ? "on" : "off")));
    ...
    private List<String> getTooltipTotalArmorValues() {
        ...
        tooltip.add(ChatFormatting.DARK_GRAY + trans("TGDamageType.PHYSICAL") + ": " + GenericArmor
                .formatAV(DamageSystem.getTotalArmorAgainstType(ply, DamageType.PHYSICAL), DamageType.PHYSICAL));
        tooltip.add(ChatFormatting.GRAY + trans("TGDamageType.PROJECTILE") + ": " + GenericArmor
                .formatAV(DamageSystem.getTotalArmorAgainstType(ply, DamageType.PROJECTILE), DamageType.PROJECTILE));

        tooltip.add(ChatFormatting.DARK_RED + trans("TGDamageType.EXPLOSION") + ": " + GenericArmor
                .formatAV(DamageSystem.getTotalArmorAgainstType(ply, DamageType.EXPLOSION), DamageType.EXPLOSION));

        tooltip.add(ChatFormatting.DARK_AQUA + trans("TGDamageType.ENERGY") + ": " + GenericArmor
                .formatAV(DamageSystem.getTotalArmorAgainstType(ply, DamageType.ENERGY), DamageType.ENERGY));

        tooltip.add(ChatFormatting.RED + trans("TGDamageType.FIRE") + ": " +
                GenericArmor.formatAV(DamageSystem.getTotalArmorAgainstType(ply, DamageType.FIRE), DamageType.FIRE));
        tooltip.add(ChatFormatting.AQUA + trans("TGDamageType.ICE") + ": " +
                GenericArmor.formatAV(DamageSystem.getTotalArmorAgainstType(ply, DamageType.ICE), DamageType.ICE));
        tooltip.add(ChatFormatting.YELLOW + trans("TGDamageType.LIGHTNING") + ": " + GenericArmor
                .formatAV(DamageSystem.getTotalArmorAgainstType(ply, DamageType.LIGHTNING), DamageType.LIGHTNING));

        tooltip.add(ChatFormatting.DARK_GRAY + trans("TGDamageType.DARK") + ": " +
                GenericArmor.formatAV(DamageSystem.getTotalArmorAgainstType(ply, DamageType.DARK), DamageType.DARK));

        tooltip.add(ChatFormatting.DARK_GREEN + trans("TGDamageType.POISON") + ": " + GenericArmor
                .formatAV(DamageSystem.getTotalArmorAgainstType(ply, DamageType.POISON), DamageType.POISON));

        tooltip.add(ChatFormatting.GREEN + trans("TGDamageType.RADIATION") + ": " + GenericArmor
                .formatAV(DamageSystem.getTotalArmorAgainstType(ply, DamageType.RADIATION), DamageType.RADIATION));
    ...
    private List<String> getTooltipRadiationBar() {
        ...
        if (displayedRad < TGRadiationSystem.MINOR_POISONING) {
            tooltip.add(trans("tgguitooltip.radeffects") + ": " + ChatFormatting.GREEN +
                    trans("tgguitooltip.radeffects.none"));
        } else {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTickTime, int mouseX, int mouseY) {
        ...
        GuiInventory.drawEntityOnScreen(k + 51, l + 75, 30, (float) (k + 51) - this.sizex,
                (float) (l + 75 - 50) - this.sizey, this.mc.player);
    }
    ...
    public void initGui() {
         ...
         * this.buttonList.add(new TGGuiTabButton(index, this.guiLeft-26, this.guiTop+5, true, new
         * ItemStack(Blocks.crafting_table,1),0));
         * this.buttonList.add(new TGGuiTabButton(index, this.guiLeft-26, this.guiTop+5+26,
         * false,TGItems.newStack(TGItems.bullets9mm,1),TGConfig.GUI_ID_tgplayerInventory));
         * } else {
         * ((TechgunsTConstructIntegrationClient)Techguns.pluginTConstructIntegration).addTabs(this.guiLeft,
         * this.guiTop, this.buttonList);
         * 
         * }
         */
        // this.buttonList.add(new TGGuiTabButton(index, this.guiLeft+5, this.guiTop-26, true, new
        // ItemStack(Blocks.CRAFTING_TABLE,1),-1));
        // this.buttonList.add(new TGGuiTabButton(index, this.guiLeft+5+28, this.guiTop-26,
        // false,TGItems.newStack(TGItems.PISTOL_ROUNDS,1),0));
        ...
        for (int x = 0; x < 5; x++) {
            this.buttonList.add(new TGGuiToggleButton(++index, this.guiLeft + togglebuttons_xpos/* +173 */,
                    this.guiTop + 7 + (x * 11), x));
        }
    }
}
