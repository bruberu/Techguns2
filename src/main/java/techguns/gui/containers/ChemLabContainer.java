...
public class ChemLabContainer extends BasicMachineContainer {
    ...
    public ChemLabContainer(InventoryPlayer player, ChemLabTileEnt ent) {
        ...
        if (inventory instanceof ItemStackHandlerPlus) {
            ...
            this.addSlotToContainer(
                    new SlotMachineInput(handler, ChemLabTileEnt.SLOT_INPUT1, SLOT_INPUT1_X, SLOTS_ROW1_Y));
            this.addSlotToContainer(
                    new SlotMachineInput(handler, ChemLabTileEnt.SLOT_INPUT2, SLOT_INPUT2_X, SLOTS_ROW1_Y));
            this.addSlotToContainer(
                    new SlotMachineInput(handler, ChemLabTileEnt.SLOT_BOTTLE, SLOT_INPUT1_X, SLOTS_ROW2_Y) {
            ...
            this.addSlotToContainer(
                    new SlotItemHandlerOutput(inventory, ChemLabTileEnt.SLOT_OUTPUT, SLOT_OUTPUT_X, SLOTS_ROW1_Y));
            this.addSlotToContainer(
                    new SlotMachineUpgrade(handler, ChemLabTileEnt.SLOT_UPGRADE, SLOT_UPGRADE_X, SLOT_UPGRADE_Y));
        }
    ...
    public void detectAndSendChanges() {
        ...
        // }
        /*
         * this.lastInputtank = this.tile.getCurrentInputFluid() != null ? this.tile.getCurrentInputFluid().copy() :
         * null;
