    ...
    public FabricatorContainer(InventoryPlayer player, FabricatorTileEntMaster ent) {
        ...
        if (inventory instanceof ItemStackHandlerPlus) {
            ...
            this.addSlotToContainer(
                    new SlotMachineInput(handler, FabricatorTileEntMaster.SLOT_INPUT1, SLOT_INPUT1_X, SLOTS_ROW1_Y));
            this.addSlotToContainer(new SlotFabricator(handler, FabricatorTileEntMaster.SLOT_WIRES, SLOT_WIRES_X,
                    SLOTS_ROW1_Y, FabricatorRecipe.items_wireslot, SlotFabricator.FABRICATOR_SLOTTEX_WIRES));
            this.addSlotToContainer(new SlotFabricator(handler, FabricatorTileEntMaster.SLOT_POWDER, SLOT_POWDER_X,
                    SLOTS_ROW1_Y, FabricatorRecipe.items_powderslot, SlotFabricator.FABRICATOR_SLOTTEX_POWDER));
            this.addSlotToContainer(new SlotFabricator(handler, FabricatorTileEntMaster.SLOT_PLATE, SLOT_PLATE_X,
                    SLOTS_ROW1_Y, FabricatorRecipe.items_plateslot, SlotFabricator.FABRICATOR_SLOTTEX_PLATE));

            this.addSlotToContainer(new SlotItemHandlerOutput(inventory, FabricatorTileEntMaster.SLOT_OUTPUT,
                    SLOT_OUTPUT_X, SLOT_OUTPUT_Y));
            this.addSlotToContainer(new SlotMachineUpgrade(handler, FabricatorTileEntMaster.SLOT_UPGRADE,
