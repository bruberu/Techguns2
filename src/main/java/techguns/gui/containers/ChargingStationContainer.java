    ...
    public ChargingStationContainer(InventoryPlayer player, ChargingStationTileEnt ent) {
        ...
        if (inventory instanceof ItemStackHandlerPlus) {
            ...
            this.addSlotToContainer(
                    new SlotMachineInput(handler, ChargingStationTileEnt.SLOT_INPUT, SLOT_INPUT_X, SLOTS_ROW1_Y));

            this.addSlotToContainer(new SlotItemHandlerOutput(inventory, ChargingStationTileEnt.SLOT_OUTPUT,
                    SLOT_OUTPUT_X, SLOTS_ROW1_Y));
            this.addSlotToContainer(new SlotMachineUpgrade(handler, ChargingStationTileEnt.SLOT_UPGRADE, SLOT_UPGRADE_X,
                    SLOT_UPGRADE_Y));
        }
