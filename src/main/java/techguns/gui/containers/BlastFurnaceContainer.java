...
public class BlastFurnaceContainer extends BasicMachineContainer {
    ...
    public BlastFurnaceContainer(InventoryPlayer player, BlastFurnaceTileEnt ent) {
        ...
        if (inventory instanceof ItemStackHandlerPlus) {
            ...
            this.addSlotToContainer(new SlotMachineInputBG(handler, BlastFurnaceTileEnt.SLOT_INPUT1, SLOT_INPUT1_X,
                    SLOTS_ROW1_Y, SlotTG.INGOTSLOT_TEX));
            this.addSlotToContainer(new SlotMachineInputBG(handler, BlastFurnaceTileEnt.SLOT_INPUT2, SLOT_INPUT2_X,
                    SLOTS_ROW1_Y, SlotFabricator.FABRICATOR_SLOTTEX_POWDER));

            this.addSlotToContainer(new SlotItemHandlerOutput(inventory, BlastFurnaceTileEnt.SLOT_OUTPUT, SLOT_OUTPUT_X,
                    SLOT_OUTPUT_Y));
            this.addSlotToContainer(
                    new SlotMachineUpgrade(handler, BlastFurnaceTileEnt.SLOT_UPGRADE, SLOT_UPGRADE_X, SLOT_UPGRADE_Y));
        }
