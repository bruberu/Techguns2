...
public class UpgradeBenchContainer extends OwnedTileContainer {
    ...
    public UpgradeBenchContainer(InventoryPlayer player, UpgradeBenchTileEnt ent) {
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, SLOT_OUTPUT_X, SLOT_Y) {
            ...
            public ItemStack onTake(EntityPlayer thePlayer, ItemStack stack) {
                ...
                UpgradeBenchContainer.this.tile.getWorld().playSound(thePlayer, thePlayer.posX, thePlayer.posY,
                        thePlayer.posZ, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, SoundCategory.PLAYERS, 1f, 1f);
            ...
            public boolean canTakeStack(EntityPlayer playerIn) {
                if (!this.inventory.getStackInSlot(0).isEmpty()) {
                    return playerIn.capabilities.isCreativeMode ||
                            playerIn.experienceTotal >= UpgradeBenchContainer.this.xp_needed;
                } else {
                    return false;
                }
            }
    ...
    public void updateOutput() {
        UpgradeBenchRecipe r = UpgradeBenchRecipes.getUpgradeRecipeFor(this.inputSlots.getStackInSlot(0),
