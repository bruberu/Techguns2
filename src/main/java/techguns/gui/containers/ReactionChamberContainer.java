...
public class ReactionChamberContainer extends BasicMachineContainer {
    ...
    public ReactionChamberContainer(InventoryPlayer player, ReactionChamberTileEntMaster ent) {
        ...
        if (inventory instanceof ItemStackHandlerPlus) {
            ...
            this.addSlotToContainer(
                    new SlotMachineInput(handler, ReactionChamberTileEntMaster.SLOT_INPUT, SLOT_INPUT_X, SLOTS_ROW1_Y));

            this.addSlotToContainer(
                    new SlotRCFocus(handler, ReactionChamberTileEntMaster.SLOT_FOCUS, SLOT_FOCUS_X, SLOTS_ROW1_Y));

            this.addSlotToContainer(new SlotItemHandlerOutput(inventory, ReactionChamberTileEntMaster.SLOT_OUTPUT,
                    SLOT_OUTPUT_X, SLOT_OUTPUT_Y));
            this.addSlotToContainer(new SlotItemHandlerOutput(inventory, ReactionChamberTileEntMaster.SLOT_OUTPUT + 1,
                    SLOT_OUTPUT_X + 18, SLOT_OUTPUT_Y));
            this.addSlotToContainer(new SlotItemHandlerOutput(inventory, ReactionChamberTileEntMaster.SLOT_OUTPUT + 2,
                    SLOT_OUTPUT_X, SLOT_OUTPUT_Y + 18));
            this.addSlotToContainer(new SlotItemHandlerOutput(inventory, ReactionChamberTileEntMaster.SLOT_OUTPUT + 3,
                    SLOT_OUTPUT_X + 18, SLOT_OUTPUT_Y + 18));
        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer ply, int id) {
        int HIGHEST_MACHINE_SLOT = ReactionChamberTileEntMaster.SLOT_OUTPUT +
                ReactionChamberTileEntMaster.OUTPUT_SLOTS_COUNT - 1;
