    ...
    public CamoBenchContainer(InventoryPlayer player, CamoBenchTileEnt ent) {
        ...
        if (props != null) {
            ...
            this.addSlotToContainer(
                    new SlotTG(props.tg_inventory, TGPlayerInventory.SLOT_FACE, 44, 18, TGSlotType.FACESLOT));
            this.addSlotToContainer(
                    new SlotTG(props.tg_inventory, TGPlayerInventory.SLOT_BACK, 62, 18, TGSlotType.BACKSLOT));
            this.addSlotToContainer(
                    new SlotTG(props.tg_inventory, TGPlayerInventory.SLOT_HAND, 80, 18, TGSlotType.HANDSLOT));
