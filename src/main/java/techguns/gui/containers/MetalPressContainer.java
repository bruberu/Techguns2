    ...
    public MetalPressContainer(InventoryPlayer player, MetalPressTileEnt ent) {
        ...
        if (inventory instanceof ItemStackHandlerPlus) {
            ...
            this.addSlotToContainer(
                    new SlotMachineInput(handler, MetalPressTileEnt.SLOT_INPUT1, SLOT_INPUT1_X, SLOT_INPUTS_Y));
            this.addSlotToContainer(
                    new SlotMachineInput(handler, MetalPressTileEnt.SLOT_INPUT2, SLOT_INPUT2_X, SLOT_INPUTS_Y));

            this.addSlotToContainer(
                    new SlotItemHandlerOutput(inventory, MetalPressTileEnt.SLOT_OUTPUT, SLOT_OUTPUT_X, SLOT_OUTPUTS_Y));
            this.addSlotToContainer(
                    new SlotMachineUpgrade(handler, MetalPressTileEnt.SLOT_UPGRADE, SLOT_UPGRADE_X, SLOT_OUTPUTS_Y));
        }
