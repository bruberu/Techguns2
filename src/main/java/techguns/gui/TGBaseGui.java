...
public abstract class TGBaseGui extends GuiContainer {
    ...
    protected void drawTexturedModelRectFromIconFluidTank(int x, int y, TextureAtlasSprite icon, int w, int h) {
        ...
        buffer.pos((double) (x + 0), (double) (y + h), (double) this.zLevel)
                .tex((double) icon.getMinU(), (double) icon.getMaxV()).endVertex();
        buffer.pos((double) (x + w), (double) (y + h), (double) this.zLevel)
                .tex((double) icon.getMaxU(), (double) icon.getMaxV()).endVertex();
        buffer.pos((double) (x + w), (double) (y + 0), (double) this.zLevel)
                .tex((double) icon.getMaxU(), (double) icon.getInterpolatedV(icon.getIconHeight() - h)).endVertex();
        buffer.pos((double) (x + 0), (double) (y + 0), (double) this.zLevel)
                .tex((double) icon.getMinU(), (double) icon.getInterpolatedV(icon.getIconHeight() - h)).endVertex();
        tessellator.draw();
    }
     ...
     */
    public void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height, int r, int g,
                                      int b, int a) {
        float f = 0.00390625F;
