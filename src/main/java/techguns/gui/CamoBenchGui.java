...
public class CamoBenchGui extends OwnedTileEntGui {
    ...
    public static final ResourceLocation texture = new ResourceLocation(Techguns.MODID,
            "textures/gui/camo_bench_gui.png");// new
    ...
    public void initGui() {
        ...
        this.buttonList
                .add(new GuiButtonExt(id++, this.guiLeft + posX + offsetX, this.guiTop + offsetY + 10, 10, 10, "-"));

        this.buttonList
                .add(new GuiButtonExt(id++, this.guiLeft + posX + offsetX * 2, this.guiTop + offsetY, 10, 10, "+"));
        this.buttonList.add(
                new GuiButtonExt(id++, this.guiLeft + posX + offsetX * 2, this.guiTop + offsetY + 10, 10, 10, "-"));

        this.buttonList
                .add(new GuiButtonExt(id++, this.guiLeft + posX + offsetX * 3, this.guiTop + offsetY, 10, 10, "+"));
        this.buttonList.add(
                new GuiButtonExt(id++, this.guiLeft + posX + offsetX * 3, this.guiTop + offsetY + 10, 10, 10, "-"));
