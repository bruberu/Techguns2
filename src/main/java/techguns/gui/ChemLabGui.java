...
public class ChemLabGui extends PoweredTileEntGui {
    ...
    public static final ResourceLocation texture = new ResourceLocation(Techguns.MODID,
            "textures/gui/chem_lab_gui.png");// new
    ...
    public void initGui() {
        super.initGui();
        this.buttonList.add(
                new GuiButtonExt(ChemLabTileEnt.BUTTON_ID_DUMP_INPUT, this.guiLeft + 20, this.guiTop + 7, 8, 8, "x"));
        this.buttonList.add(
                new GuiButtonExt(ChemLabTileEnt.BUTTON_ID_DUMP_OUTPUT, this.guiLeft + 159, this.guiTop + 7, 8, 8, "x"));
        this.buttonList.add(new GuiButtonToggleDrainTank(ChemLabTileEnt.BUTTON_ID_TOGGLE_DRAIN, this.guiLeft + 156,
                this.guiTop + 68, 14, 14, this.tile));
    }
}
