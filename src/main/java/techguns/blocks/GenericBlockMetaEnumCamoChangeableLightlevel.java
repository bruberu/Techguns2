...
public class GenericBlockMetaEnumCamoChangeableLightlevel<T extends Enum<T> & IStringSerializable & IEnumLightlevel>
                                                         extends GenericBlockMetaEnumCamoChangeable<T> {
