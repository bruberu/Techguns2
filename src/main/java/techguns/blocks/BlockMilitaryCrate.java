...
public class BlockMilitaryCrate extends GenericBlockMetaEnum<EnumMilitaryCrateType> {
    ...
    protected static final ResourceLocation loottable_ammo = new ResourceLocation(Techguns.MODID,
            "blocks/military_crate_ammo");
    protected static final ResourceLocation loottable_gun = new ResourceLocation(Techguns.MODID,
            "blocks/military_crate_gun");
    protected static final ResourceLocation loottable_armor = new ResourceLocation(Techguns.MODID,
            "blocks/military_crate_armor");
    protected static final ResourceLocation loottable_medical = new ResourceLocation(Techguns.MODID,
            "blocks/military_crate_medical");
    protected static final ResourceLocation loottable_explosives = new ResourceLocation(Techguns.MODID,
            "blocks/military_crate_explosives");
    protected static final ResourceLocation loottable_generic = new ResourceLocation(Techguns.MODID,
            "blocks/military_crate_generic");
