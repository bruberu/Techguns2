...
public class BlockTGLadder<T extends Enum<T> & IStringSerializable> extends GenericBlock implements ICamoChangeable {
    ...
    protected static final AxisAlignedBB LADDER_EAST_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, LADDER_SIZE, 1.0D,
            1.0D);
    protected static final AxisAlignedBB LADDER_WEST_AABB = new AxisAlignedBB(1.0D - LADDER_SIZE, 0.0D, 0.0D, 1.0D,
            1.0D, 1.0D);
    protected static final AxisAlignedBB LADDER_SOUTH_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 1.0D,
            LADDER_SIZE);
    protected static final AxisAlignedBB LADDER_NORTH_AABB = new AxisAlignedBB(0.0D, 0.0D, 1.0D - LADDER_SIZE, 1.0D,
            1.0D, 1.0D);
