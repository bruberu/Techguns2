...
public class GenericBlockMetaEnumCamoChangeable<T extends Enum<T> & IStringSerializable> extends GenericBlockMetaEnum<T>
    ...
    public String getCurrentCamoName(ItemStack item) {
        return "tile." + Techguns.MODID + "." + this.getRegistryName().getPath() + "." + getCurrentCamoIndex(item) +
                ".name";
    }
}
