...
public class BlockTGStairs extends GenericBlock {
        ...
        if (p_193383_4_.getAxis() == EnumFacing.Axis.Y) {
            ...
            if (blockstairs$enumshape != BlockStairs.EnumShape.OUTER_LEFT &&
                ...
                switch (blockstairs$enumshape) {
                    ...
                    case INNER_LEFT:
                        return enumfacing != p_193383_4_ && enumfacing != p_193383_4_.rotateY() ?
                                BlockFaceShape.UNDEFINED : BlockFaceShape.SOLID;
                    case STRAIGHT:
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(TYPE2, (meta & 8) > 0)
                .withProperty(HALF, EnumHalf.values()[(meta & 4) >> 2])
    ...
    public int getMetaFromState(IBlockState state) {
        return ((state.getValue(TYPE2) ? 1 : 0) << 3) + (state.getValue(HALF).ordinal() << 2) +
    ...
    public void registerItemBlockModels() {
        ...
        ModelLoader.setCustomModelResourceLocation(this.itemblock, this.getMetaFromState(state2),
                new ModelResourceLocation(getRegistryName(), BlockUtils.getBlockStateVariantString(state2)));
    }
}
