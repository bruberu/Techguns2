...
public enum EnumMultiBlockMachineType implements IStringSerializable, IMachineType<EnumMultiBlockMachineType> {
    ...
    REACTIONCHAMBER_GLASS(4, ReactionChamberTileEntSlave.class, false, EnumBlockRenderType.MODEL,
            BlockRenderLayer.CUTOUT, SoundType.GLASS),
    REACTIONCHAMBER_CONTROLLER(5, ReactionChamberTileEntMaster.class, true, EnumBlockRenderType.MODEL,
            BlockRenderLayer.CUTOUT, SoundType.METAL);
    ...
    EnumMultiBlockMachineType(int id, Class<? extends TileEntity> tile, boolean isFullCube,
                              EnumBlockRenderType renderType) {
        this(id, tile, isFullCube, renderType, BlockRenderLayer.SOLID, SoundType.METAL);
    }

    EnumMultiBlockMachineType(int id, Class<? extends TileEntity> tile, boolean isFullCube,
                              EnumBlockRenderType renderType, BlockRenderLayer layer, SoundType sound) {
        this.id = id;
