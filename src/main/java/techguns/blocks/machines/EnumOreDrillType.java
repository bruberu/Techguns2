...
public enum EnumOreDrillType implements IStringSerializable, IMachineType<EnumOreDrillType> {
    ...
    SCAFFOLD(1, OreDrillTileEntSlave.class, false, EnumBlockRenderType.MODEL, BlockRenderLayer.CUTOUT, SoundType.METAL,
            false),
    ...
    SCAFFOLD_HIDDEN(5, OreDrillTileEntSlave.class, false, EnumBlockRenderType.INVISIBLE, BlockRenderLayer.CUTOUT,
            SoundType.METAL, true);
    ...
    EnumOreDrillType(int id, Class<? extends TileEntity> tile, boolean isFullCube, EnumBlockRenderType renderType,
                     BlockRenderLayer layer, SoundType sound, boolean hideInCreative) {
        this.id = id;
