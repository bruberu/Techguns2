...
public class BlockTGCamoNet extends GenericBlockMetaEnumCamoChangeable<EnumCamoNetType> {
    ...
    public static PropertyEnum<EnumConnectionType> CONNECTION = PropertyEnum.create("connection",
            EnumConnectionType.class);
    ...
    public void registerItemBlockModels() {
        for (int i = 0; i < clazz.getEnumConstants().length; i++) {
            ModelLoader.setCustomModelResourceLocation(this.itemblock, i, new ModelResourceLocation(
                    getRegistryName() + "_inventory", "type=" + clazz.getEnumConstants()[i].getName()));
        }
    }
}
