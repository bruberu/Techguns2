...
public class BlockTGDoor2x1 extends BlockDoor implements IGenericBlock {
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
        ...
        if (iblockstate.getBlock() != this) {
            ...
            if (offsetState.getBlock() == iblockstate.getBlock() &&
                    offsetState.getValue(OPEN) == iblockstate.getValue(OPEN)) {
            ...
            worldIn.playSound(pos.getX(), pos.getY(), pos.getZ(), TGSounds.BUNKER_DOOR_OPEN, SoundCategory.BLOCKS, 1.0f,
                    1.0f, false);
            return true;
        }
    }
