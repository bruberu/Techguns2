...
public class BlockOreCluster<T extends Enum<T> & IEnumOreClusterType> extends GenericBlockMetaEnum<T> {
    ...
    // public static java.lang.reflect.Field chunkCacheWorld = ObfuscationReflectionHelper.findField(ChunkCache.class,
    // "field_72815_e");
    ...
    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
        ...
        if (ore != null) {
            ...
            tooltip.add(TextUtil.trans("techguns.orecluster.powermult") + ": x" +
                    String.format("%.1f", ore.getMultiplier_power()));
            tooltip.add(TextUtil.trans("techguns.orecluster.amountmult") + ": x" +
                    String.format("%.1f", ore.getMultiplier_amount()));
        }
    }
