...
public class BlastFurnaceTweaker {
    ...
    @ZenMethod
    public static void addRecipe(String input1, int amount1, String input2, int amount2, IItemStack output, int power,
                                 int duration) {
        CraftTweakerAPI.apply(new addInputAction(new ItemStackOreDict(input1), amount1, new ItemStackOreDict(input2),
                amount2, output, power, duration));
    }

    @ZenMethod
    public static void addRecipe(IItemStack input1, String input2, int amount2, IItemStack output, int power,
                                 int duration) {
        CraftTweakerAPI
                .apply(new addInputAction(input1, new ItemStackOreDict(input2), amount2, output, power, duration));
    }

    @ZenMethod
    public static void addRecipe(String input1, int amount1, IItemStack input2, IItemStack output, int power,
                                 int duration) {
        CraftTweakerAPI
                .apply(new addInputAction(new ItemStackOreDict(input1), amount1, input2, output, power, duration));
    }
    ...
    private static class addInputAction implements IAction {
        ...
        public addInputAction(ItemStackOreDict input1, int amount1, ItemStackOreDict input2, int amount2,
                              IItemStack output, int power, int duration) {
            super();
            this.input1 = input1;
            this.input2 = input2;
            this.output = CraftTweakerMC.getItemStack(output);
        ...
        public addInputAction(IItemStack input1, ItemStackOreDict input2, int amount2, IItemStack output, int power,
                              int duration) {
            super();
        ...
        public addInputAction(ItemStackOreDict input1, int amount1, IItemStack input2, IItemStack output, int power,
                              int duration) {
            super();
            this.input1 = input1;
        ...
        public void apply() {
            if (this.isValid()) {
                ...
                if (input1.isOreDict() && input2.isOreDict()) {
                    BlastFurnaceRecipes.addRecipe(input1.oreDictName, amount1, input2.oreDictName, amount2, output,
                            powerPerTick, duration);
