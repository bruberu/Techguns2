...
public class FabricatorTweaker {
    ...
    @ZenMethod
    public static void addRecipe(IItemStack input, int amount, IItemStack wire, int amount_wire, IItemStack powder,
                                 int amount_powder, IItemStack plate, int amount_plate, IItemStack output) {
    ...
    @ZenMethod
    public static void addRecipe(IItemStack input, int amount, IItemStack wire, int amount_wire, IItemStack powder,
                                 int amount_powder, String plate, int amount_plate, IItemStack output) {
        CraftTweakerAPI.apply(new addInputAction(
                TGCraftTweakerHelper.toItemStackOreDict(input), amount,
                TGCraftTweakerHelper.toItemStackOreDict(wire), amount_wire,
                TGCraftTweakerHelper.toItemStackOreDict(powder), amount_powder,
    ...
    @ZenMethod
    public static void addRecipe(IItemStack input, int amount, IItemStack wire, int amount_wire, String powder,
                                 int amount_powder, IItemStack plate, int amount_plate, IItemStack output) {
        CraftTweakerAPI.apply(new addInputAction(
                TGCraftTweakerHelper.toItemStackOreDict(input), amount,
                TGCraftTweakerHelper.toItemStackOreDict(wire), amount_wire,
    ...
    @ZenMethod
    public static void addRecipe(IItemStack input, int amount, String wire, int amount_wire, IItemStack powder,
                                 int amount_powder, IItemStack plate, int amount_plate, IItemStack output) {
        CraftTweakerAPI.apply(new addInputAction(
                TGCraftTweakerHelper.toItemStackOreDict(input), amount,
                TGCraftTweakerHelper.toItemStackOreDict(wire), amount_wire,
    ...
    @ZenMethod
    public static void addRecipe(IItemStack input, int amount, String wire, int amount_wire, String powder,
                                 int amount_powder, IItemStack plate, int amount_plate, IItemStack output) {
        CraftTweakerAPI.apply(new addInputAction(
                TGCraftTweakerHelper.toItemStackOreDict(input), amount,
                TGCraftTweakerHelper.toItemStackOreDict(wire), amount_wire,
    ...
    @ZenMethod
    public static void addRecipe(String input, int amount, IItemStack wire, int amount_wire, IItemStack powder,
                                 int amount_powder, IItemStack plate, int amount_plate, IItemStack output) {
        CraftTweakerAPI.apply(new addInputAction(
                TGCraftTweakerHelper.toItemStackOreDict(input), amount,
                TGCraftTweakerHelper.toItemStackOreDict(wire), amount_wire,
    ...
    @ZenMethod
    public static void addRecipe(String input, int amount, IItemStack wire, int amount_wire, String powder,
                                 int amount_powder, IItemStack plate, int amount_plate, IItemStack output) {
        CraftTweakerAPI.apply(new addInputAction(
                TGCraftTweakerHelper.toItemStackOreDict(input), amount,
                TGCraftTweakerHelper.toItemStackOreDict(wire), amount_wire,
    ...
    @ZenMethod
    public static void addRecipe(String input, int amount, String wire, int amount_wire, IItemStack powder,
                                 int amount_powder, IItemStack plate, int amount_plate, IItemStack output) {
        CraftTweakerAPI.apply(new addInputAction(
                TGCraftTweakerHelper.toItemStackOreDict(input), amount,
                TGCraftTweakerHelper.toItemStackOreDict(wire), amount_wire,
    ...
    @ZenMethod
    public static void addRecipe(String input, int amount, String wire, int amount_wire, String powder,
                                 int amount_powder, IItemStack plate, int amount_plate, IItemStack output) {
        CraftTweakerAPI.apply(new addInputAction(
                TGCraftTweakerHelper.toItemStackOreDict(input), amount,
                TGCraftTweakerHelper.toItemStackOreDict(wire), amount_wire,
    ...
    private static boolean checkLists(ItemStackOreDict item, byte slotId) {
        ...
        if (!checkWire && !checkPowder && !checkPlate) {
            ...
            return true;
        } else if ((checkWire && slotId == 0 && !checkPowder && !checkPlate) ||
                (checkPowder && slotId == 1 && !checkWire && !checkPlate) ||
                (checkPlate && slotId == 2 && !checkWire && !checkPowder)) {
                    return true;
                } else {
                    return false;
                }
    ...
    private static class addInputAction implements IAction {
        ...
        public addInputAction(ItemStackOreDict input, int amount, ItemStackOreDict input_wire, int amount_wire,
                              ItemStackOreDict input_powder, int amount_powder, ItemStackOreDict input_plate,
                              int amount_plate, IItemStack output) {
            super();
            this.input = input;
            this.amount = amount;
        ...
        @Override
        public void apply() {
            added_recipe = new FabricatorRecipe(input, amount, input_wire, amount_wire, input_powder, amount_powder,
                    input_plate, amount_plate, output, output.getCount());
        ...
        public String describe() {
            if (!warning) {
                ...
                return "WARNING while adding Fabricator Recipe for " + output +
                        ": One input already in use in another slot by other recipes! THIS WILL NOT WORK!";
            }
        }
    }
