...
public class ChargingStationTweaker {
    ...
    public static void addRecipe(IItemStack input, IItemStack output, int RFAmount) {
        CraftTweakerAPI.apply(new addInputAction(new ItemStackOreDict(CraftTweakerMC.getItemStack(input)),
                CraftTweakerMC.getItemStack(output), RFAmount));
    }

    @ZenMethod
    public static void addRecipe(String input, IItemStack output, int RFAmount) {
        CraftTweakerAPI
                .apply(new addInputAction(new ItemStackOreDict(input), CraftTweakerMC.getItemStack(output), RFAmount));
    }
