...
public class MetalPressTweaker {
    ...
    public static void addRecipe(IItemStack input1, IItemStack input2, IItemStack output, boolean allowSwap) {
        CraftTweakerAPI.apply(new addInputAction(TGCraftTweakerHelper.toItemStackOreDict(input1),
                TGCraftTweakerHelper.toItemStackOreDict(input2), allowSwap, output));
    }
    ...
    public static void removeRecipe(String input1, String input2, IItemStack output) {
        CraftTweakerAPI.apply(new removeInputAction(TGCraftTweakerHelper.toItemStackOreDict(input1),
                TGCraftTweakerHelper.toItemStackOreDict(input2), output));
    }
