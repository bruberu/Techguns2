...
public class OreDrillMachineRecipe implements IMachineRecipe {
    ...
    public List<List<ItemStack>> getItemInputs() {
        ...
        list.add(getDrills());
        list.add(NonNullList.withSize(1, new ItemStack(TGBlocks.ORE_CLUSTER, 1, TGBlocks.ORE_CLUSTER.getMetaFromState(
                TGBlocks.ORE_CLUSTER.getDefaultState().withProperty(TGBlocks.ORE_CLUSTER.TYPE, type)))));
