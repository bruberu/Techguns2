...
public class AmmoPressRecipeCategory extends BasicRecipeCategory<AmmoPressJeiRecipe> {
    ...
    public void setRecipe(IRecipeLayout recipeLayout, AmmoPressJeiRecipe recipeWrapper, IIngredients ingredients) {
        ...
        guiItemStacks.init(AmmoPressTileEnt.SLOT_METAL1, true, SLOT_METAL1_X + JEI_OFFSET_X,
                SLOTS_INPUT_Y + JEI_OFFSET_Y);
        guiItemStacks.init(AmmoPressTileEnt.SLOT_METAL2, true, SLOT_METAL2_X + JEI_OFFSET_X,
                SLOTS_INPUT_Y + JEI_OFFSET_Y);
        guiItemStacks.init(AmmoPressTileEnt.SLOT_POWDER, true, SLOT_POWDER_X + JEI_OFFSET_X,
                SLOTS_INPUT_Y + JEI_OFFSET_Y);

        guiItemStacks.init(AmmoPressTileEnt.SLOT_OUTPUT, false, SLOT_OUTPUT_X + JEI_OFFSET_X,
                SLOTS_OUTPUT_Y + JEI_OFFSET_Y);
