...
public class CamoBenchJeiRecipeCategory extends BasicRecipeCategory<CamoBenchJeiRecipe> {
    ...
    public CamoBenchJeiRecipeCategory(IGuiHelper guiHelper) {
        ...
        background = guiHelper.createDrawable(CamoBenchGui.texture, 7 - CAMO_BENCH_OFFSET_X, 15 - CAMO_BENCH_OFFSET_Y,
                162, 63);
    }
    ...
    public void setRecipe(IRecipeLayout recipeLayout, CamoBenchJeiRecipe recipeWrapper, IIngredients ingredients) {
        ...
        guiItemStacks.init(0, true, CamoBenchContainer.SLOT_INPUT_X + JEI_OFFSET_X + CAMO_BENCH_OFFSET_X,
                CamoBenchContainer.SLOT_INPUT_Y + JEI_OFFSET_Y + CAMO_BENCH_OFFSET_Y);
