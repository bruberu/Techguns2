...
public class ChargingStationJeiRecipeCategory extends BasicRecipeCategory<ChargingStationJeiRecipe> {
    ...
    public void setRecipe(IRecipeLayout recipeLayout, ChargingStationJeiRecipe recipeWrapper,
        ...
        guiItemStacks.init(ChargingStationTileEnt.SLOT_INPUT, true, SLOT_INPUT_X + JEI_OFFSET_X,
                SLOTS_ROW1_Y + JEI_OFFSET_Y);

        guiItemStacks.init(ChargingStationTileEnt.SLOT_OUTPUT, false, SLOT_OUTPUT_X + JEI_OFFSET_X,
                SLOTS_ROW1_Y + JEI_OFFSET_Y);
