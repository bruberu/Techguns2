...
public class BlastFurnaceJeiRecipe extends BasicRecipeWrapper {
    ...
    public List<String> getTooltipStrings(int mouseX, int mouseY) {
        if (TGBaseGui.isInRect(mouseX, mouseY, 22 + BasicRecipeCategory.JEI_OFFSET_X,
                54 + BasicRecipeCategory.JEI_OFFSET_Y, 102, 12)) {

            List<String> tooltip = new ArrayList<>();
            tooltip.add(TextUtil.transTG("tooltip.duration") + ": " + recipe.duration + " " +
                    TextUtil.transTG("tooltip.ticks"));
