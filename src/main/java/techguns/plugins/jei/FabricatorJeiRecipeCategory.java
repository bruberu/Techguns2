...
public class FabricatorJeiRecipeCategory extends BasicRecipeCategory<FabricatorJeiRecipe> {
    ...
    public FabricatorJeiRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.progress = guiHelper.createAnimatedDrawable(progress_static, 100, IDrawableAnimated.StartDirection.LEFT,
                false);
    }
    ...
    public void setRecipe(IRecipeLayout recipeLayout, FabricatorJeiRecipe recipeWrapper, IIngredients ingredients) {
        ...
        guiItemStacks.init(FabricatorTileEntMaster.SLOT_INPUT1, true, SLOT_INPUT1_X + JEI_OFFSET_X,
                SLOTS_ROW1_Y + JEI_OFFSET_Y);
        guiItemStacks.init(FabricatorTileEntMaster.SLOT_WIRES, true, SLOT_WIRES_X + JEI_OFFSET_X,
                SLOTS_ROW1_Y + JEI_OFFSET_Y);
        guiItemStacks.init(FabricatorTileEntMaster.SLOT_POWDER, true, SLOT_POWDER_X + JEI_OFFSET_X,
                SLOTS_ROW1_Y + JEI_OFFSET_Y);
        guiItemStacks.init(FabricatorTileEntMaster.SLOT_PLATE, true, SLOT_PLATE_X + JEI_OFFSET_X,
                SLOTS_ROW1_Y + JEI_OFFSET_Y);

        guiItemStacks.init(FabricatorTileEntMaster.SLOT_OUTPUT, false, SLOT_OUTPUT_X + JEI_OFFSET_X,
                SLOT_OUTPUT_Y + JEI_OFFSET_Y);
