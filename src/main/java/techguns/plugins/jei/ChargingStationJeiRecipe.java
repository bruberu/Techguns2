...
public class ChargingStationJeiRecipe extends BasicRecipeWrapper {
    ...
    public List<String> getTooltipStrings(int mouseX, int mouseY) {
        if (TGBaseGui.isInRect(mouseX, mouseY, 8 + BasicRecipeCategory.JEI_OFFSET_X,
            ...
            tooltip.add(TextUtil.trans("techguns.container.chargingstation.duration") + ": " +
                    String.format("%.2f", duration / 20.0f) + "s");
