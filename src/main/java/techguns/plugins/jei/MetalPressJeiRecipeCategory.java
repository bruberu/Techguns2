...
public class MetalPressJeiRecipeCategory extends BasicRecipeCategory<MetalPressJeiRecipe> {
    ...
    public void setRecipe(IRecipeLayout recipeLayout, MetalPressJeiRecipe recipeWrapper, IIngredients ingredients) {
        ...
        guiItemStacks.init(MetalPressTileEnt.SLOT_INPUT1, true, SLOT_INPUT1_X + JEI_OFFSET_X,
                SLOT_INPUTS_Y + JEI_OFFSET_Y);
        guiItemStacks.init(MetalPressTileEnt.SLOT_INPUT2, true, SLOT_INPUT2_X + JEI_OFFSET_X,
                SLOT_INPUTS_Y + JEI_OFFSET_Y);

        guiItemStacks.init(MetalPressTileEnt.SLOT_OUTPUT, false, SLOT_OUTPUT_X + JEI_OFFSET_X,
                SLOT_OUTPUTS_Y + JEI_OFFSET_Y);
