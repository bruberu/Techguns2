...
public class ChemLabJeiRecipeCategory extends BasicRecipeCategory<ChemLabJeiRecipe> {
    ...
    public void setRecipe(IRecipeLayout recipeLayout, ChemLabJeiRecipe recipeWrapper, IIngredients ingredients) {
        ...
        guiItemStacks.init(ChemLabTileEnt.SLOT_OUTPUT, false, SLOT_OUTPUT_X + JEI_OFFSET_X,
        ...
        guiFluidStacks.init(0, true, ChemLabGui.INPUT_TANK_X + 2 + JEI_OFFSET_X, ChemLabGui.TANK_Y + 1 + JEI_OFFSET_Y,
                ChemLabGui.TANK_W, ChemLabGui.TANK_H, ChemLabTileEnt.CAPACITY_INPUT_TANK, false, tank_overlay);
        guiFluidStacks.init(1, false, ChemLabGui.OUTPUT_TANK_X + 2 + JEI_OFFSET_X, ChemLabGui.TANK_Y + 1 + JEI_OFFSET_Y,
                ChemLabGui.TANK_W, ChemLabGui.TANK_H, ChemLabTileEnt.CAPACITY_OUTPUT_TANK, false, tank_overlay);
