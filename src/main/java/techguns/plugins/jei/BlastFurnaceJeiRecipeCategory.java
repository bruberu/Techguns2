...
public class BlastFurnaceJeiRecipeCategory extends BasicRecipeCategory<BlastFurnaceJeiRecipe> {
    ...
    public void setRecipe(IRecipeLayout recipeLayout, BlastFurnaceJeiRecipe recipeWrapper, IIngredients ingredients) {
        ...
        guiItemStacks.init(BlastFurnaceTileEnt.SLOT_INPUT1, true, SLOT_INPUT1_X + JEI_OFFSET_X,
                SLOTS_ROW1_Y + JEI_OFFSET_Y);
        guiItemStacks.init(BlastFurnaceTileEnt.SLOT_INPUT2, true, SLOT_INPUT2_X + JEI_OFFSET_X,
                SLOTS_ROW1_Y + JEI_OFFSET_Y);

        guiItemStacks.init(BlastFurnaceTileEnt.SLOT_OUTPUT, false, SLOT_OUTPUT_X + JEI_OFFSET_X,
