...
public class GenericCity { // City Type
    ...
    static {
        testCity = new GenericCity(20, 80, 12, 30, -1, new int[] { 6, 4, 4, 2, 1 },
                new CityRoad(new MBlock(TGBlocks.CONCRETE, 3), new MBlock(TGBlocks.CONCRETE, 2)), 0.5f);
    ...
    public void createCity(World world, int posX, int posY, int posZ, int sizeX, int sizeY, int sizeZ,
        ...
        GenericCitySegment rootSegment = new GenericCitySegment(this, posX, posY, posZ, sizeX, sizeZ, roadWidth[0], 0,
                colorType, rnd, null);
    ...
    private void setBlocks(World world, int posX, int posY, int posZ, int sizeX, int sizeY, int sizeZ,
                           BiomeColorType colorType, GenericCitySegment rootSegment, Random rnd) {
    ...
    public void placeStructure(World world, GenericCitySegment segment, Random rnd) {
        ...
        BlockUtils.fillBlocksAir(world, segment.x, segment.y + 1, segment.z, segment.sizeX, SET_AIR_HEIGHT,
                segment.sizeZ);
        ...
        structure.setBlocks(world, segment.x, segment.y, segment.z, segment.sizeX, height, segment.sizeZ,
                segment.direction, segment.colorType, rnd);
    }
