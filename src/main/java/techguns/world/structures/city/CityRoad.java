...
public class CityRoad implements IRoad {
    ...
    public void setRoadBlocks(World world, int x, int y, int z, int roadWidth, int roadLength, int heightDif,
                              boolean alignment, BiomeColorType colorType) {
        ...
        // BlockUtils.flattenArea(world, x, z , alignment ? roadLength : roadWidth, !alignment ? roadLength : roadWidth,
        // 1);
