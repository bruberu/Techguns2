...
public class Staircase {
    ...
    public static void placeStaircase(World world, int posX, int posY, int posZ, int size, int direction,
                                      boolean inverted, BiomeColorType colorType, MBlock stairs, MBlock support) {
        int dx = 0, dz = 0;
