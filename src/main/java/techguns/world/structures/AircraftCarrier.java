...
public class AircraftCarrier extends WorldgenStructure {
    ...
    static {
        ...
        blockList.add(new MBlockChestLoottable(Blocks.CHEST, 5, LOOT_TABLE)); // TGBlocks.tgchest, 5, true,
                                                                              // BlockType.CHEST));
        ...
        blockList.add(MBlockRegister.SUPPLY_CRATES);// Blocks.CHEST,3));//TGBlocks.tgchest_weapon, 3, true,
                                                    // BlockType.CHEST));
        blockList.add(MBlockRegister.SUPPLY_CRATES);// Blocks.CHEST,2)); //TGBlocks.tgchest_weapon, 2, true,
                                                    // BlockType.CHEST));
        ...
        blockList.add(MBlockRegister.ALUMINIUM_STAIRS_WEST);// new MBlock(ChiselBlocks.aluminumStairs[1], 1, true,
                                                            // BlockType.STAIRS));
        blockList.add(MBlockRegister.ALUMINIUM_STAIRS_EAST);// new MBlock(ChiselBlocks.aluminumStairs[1], 0, true,
                                                            // BlockType.STAIRS));
        ...
        blockList.add(new MBlockChestLoottable(Blocks.CHEST, 3, LOOT_TABLE));// TGBlocks.tgchest, 3, true,
                                                                             // BlockType.CHEST));
        blockList.add(MBlockRegister.TECHNICAL2_FAN);// new MBlock(ChiselBlocks.technical2, 1));
        blockList.add(new MBlockChestLoottable(Blocks.CHEST, 4, LOOT_TABLE));// TGBlocks.tgchest, 4, true,
                                                                             // BlockType.CHEST));
        blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.HOLE, 6, 2, 150, 2).addMobType(ArmySoldier.class, 1)
                .addMobType(Commando.class, 1));
        blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.SOLDIER_SPAWN, 1, 1, 200, 0)
                .addMobType(AttackHelicopter.class, 1));
    ...
    public void setBlocks(World world, int posX, int posY, int posZ, int sizeX, int sizeY, int sizeZ, int direction,
        ...
        BlockUtils.placeScannedStructure(world, blocks, blockList, posX, posY, posZ, centerX, centerZ, direction, 0,
                this.lootTier, colorType);
        BlockUtils.placeScannedStructure(world, blocks, blockList, posX, posY, posZ, centerX, centerZ, direction, 1,
                this.lootTier, colorType);

        // Place flag
        // BlockUtils.setBlockRotated(world, new MBlock(TGBlocks.basicMachine, 7), posX, posY+8, posZ, 24, 9, centerX,
        // centerZ, direction, this.lootTier);
        // int[] pos = Structure.rotatePoint(24,9,direction,centerX,centerZ);

        // spawn points
        /*
         * BlockUtils.setBlockRotated(world, new MBlock(Blocks.lapis_block, 0), posX, posY+8, posZ, 22, 9, centerX,
         * centerZ, direction, this.lootTier);
         * 
         * BlockUtils.setBlockRotated(world, new MBlock(Blocks.lapis_block, 0), posX, posY+12, posZ, 28, 6, centerX,
         * centerZ, direction, this.lootTier);
         * BlockUtils.setBlockRotated(world, new MBlock(Blocks.lapis_block, 0), posX, posY+16, posZ, 28, 6, centerX,
         * centerZ, direction, this.lootTier);
         * 
         * BlockUtils.setBlockRotated(world, new MBlock(Blocks.lapis_block, 0), posX, posY+8, posZ, 43, 6, centerX,
         * centerZ, direction, this.lootTier);
         * BlockUtils.setBlockRotated(world, new MBlock(Blocks.lapis_block, 0), posX, posY+12, posZ, 43, 6, centerX,
         * centerZ, direction, this.lootTier);
         * 
         * BlockUtils.setBlockRotated(world, new MBlock(Blocks.lapis_block, 0), posX, posY+4, posZ, 18, 9, centerX,
         * centerZ, direction, this.lootTier);
         * 
         * BlockUtils.setBlockRotated(world, new MBlock(Blocks.lapis_block, 0), posX, posY+1, posZ, 18, 9, centerX,
         * centerZ, direction, this.lootTier);
         * 
         * BlockUtils.setBlockRotated(world, new MBlock(Blocks.lapis_block, 0), posX, posY+4, posZ, 43, 9, centerX,
         * centerZ, direction, this.lootTier);
         * 
         * BlockUtils.setBlockRotated(world, new MBlock(Blocks.lapis_block, 0), posX, posY+1, posZ, 39, 9, centerX,
         * centerZ, direction, this.lootTier);
         */
