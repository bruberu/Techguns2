...
public class OreClusterMeteorBasis extends WorldgenStructure {
    ...
    static short[][] blocks;
    static EnumOreClusterType[] types = { EnumOreClusterType.COAL, EnumOreClusterType.COMMON_METAL,
            EnumOreClusterType.COMMON_GEM, EnumOreClusterType.RARE_METAL, EnumOreClusterType.SHINY_METAL,
            EnumOreClusterType.SHINY_GEM, EnumOreClusterType.URANIUM, EnumOreClusterType.NETHER_CRYSTAL };
    static MBlock[] ores = { new MBlock(Blocks.COAL_ORE, 0),
            new MultiMBlock(new Block[] { Blocks.IRON_ORE, TGBlocks.TG_ORE, TGBlocks.TG_ORE },
                    new int[] { 0, EnumOreType.ORE_COPPER.ordinal(), EnumOreType.ORE_TIN.ordinal() },
                    new int[] { 1, 1, 1 }),
            new MultiMBlock(new Block[] { Blocks.REDSTONE_ORE, Blocks.LAPIS_ORE }, new int[] { 0, 0 },
                    new int[] { 1, 1 }),
            new MBlock(TGBlocks.TG_ORE, EnumOreType.ORE_LEAD.ordinal()),
            new MultiMBlock(new Block[] { Blocks.GOLD_ORE, TGBlocks.TG_ORE },
                    new int[] { 0, EnumOreType.ORE_TITANIUM.ordinal() }, new int[] { 1, 1 }),
            new MultiMBlock(new Block[] { Blocks.DIAMOND_ORE, Blocks.EMERALD_ORE, Blocks.STONE }, new int[] { 0, 0, 0 },
                    new int[] { 2, 1, 3 }),
            new MultiMBlock(new Block[] { TGBlocks.TG_ORE, Blocks.STONE },
                    new int[] { EnumOreType.ORE_URANIUM.ordinal(), 0 }, new int[] { 1, 1 }),
            new MultiMBlock(new Block[] { Blocks.NETHERRACK, Blocks.QUARTZ_ORE, Blocks.GLOWSTONE },
                    new int[] { 0, 0, 0 }, new int[] { 2, 1, 1 }),
    };
    ...
    static {
        ...
        blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.HOLE, 2, 1, 200, 1).addMobType(ArmySoldier.class, 4)
                .addMobType(Commando.class, 1));
        blockList.add(new MBlock(TGBlocks.METAL_PANEL, TGMetalPanelType.PANEL_LARGE_BORDER.ordinal()));
        blockList.add(
                new MultiMBlock(new Block[] { Blocks.MAGMA, Blocks.STONE }, new int[] { 0, 0 }, new int[] { 1, 1 }));
    ...
    public void setBlocks(World world, int posX, int posY, int posZ, int sizeX, int sizeY, int sizeZ, int direction,
        ...
        BlockUtils.placeScannedStructure(world, blocks, blockList, posX, posY - 5, posZ, centerX, centerZ, direction, 0,
                this.lootTier, colorType, indexRoll, rnd);
        BlockUtils.placeScannedStructure(world, blocks, blockList, posX, posY - 5, posZ, centerX, centerZ, direction, 1,
