...
public class SmallMine extends WorldgenStructure {
    ...
    static EnumOreClusterType[] types = { EnumOreClusterType.COAL, EnumOreClusterType.COMMON_METAL,
            ...
            EnumOreClusterType.SHINY_GEM, EnumOreClusterType.URANIUM };
    ...
    static {
        ...
        blockList.add(new MBlockBiomeColorType(
                new Block[] { Blocks.GRASS, Blocks.SNOW, Blocks.SAND, Blocks.NETHERRACK }, new int[] { 0, 0, 0, 0 }));
        blockList.add(new MBlock(Blocks.LOG, 8));
        blockList.add(new MultiMMBlock(new MBlock[] {
                new MBlockBiomeColorType(new Block[] { Blocks.GRASS, Blocks.GRASS, Blocks.SAND, Blocks.NETHERRACK },
                        new int[] { 0, 0, 0, 0 }),
                new MBlock(Blocks.AIR, 0) }, new int[] { 4, 1 }));
