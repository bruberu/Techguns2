...
public class DesertOilCluster extends WorldgenStructure {
    ...
    static {
        ...
        blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.SOLDIER_SPAWN, 3, 1, 200, 1)
                .addMobType(ArmySoldier.class, 4).addMobType(Commando.class, 1));
    ...
    public void setBlocks(World world, int posX, int posY, int posZ, int sizeX, int sizeY, int sizeZ, int direction,
        ...
        BlockUtils.placeScannedStructure(world, blocks, blockList, posX, posY - 4, posZ, centerX, centerZ, direction, 0,
                this.lootTier, colorType, indexRoll, rnd);
        BlockUtils.placeScannedStructure(world, blocks, blockList, posX, posY - 4, posZ, centerX, centerZ, direction, 1,
