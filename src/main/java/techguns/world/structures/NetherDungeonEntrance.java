...
public class NetherDungeonEntrance extends WorldgenStructure {
    ...
    public void setBlocks(World world, int posX, int posY, int posZ, int sizeX, int sizeY, int sizeZ, int direction,
        ...
        BlockUtils.placeScannedStructure(world, blocks, blockList, posX, posY, posZ, centerX - 2, centerZ, direction, 0,
                this.lootTier, colorType);
        // BlockUtils.placeScannedStructure(world, blocks, blockList, posX, posY, posZ, centerX, centerZ, direction,
        // 1,this.lootTier,colorType);
    }
}
