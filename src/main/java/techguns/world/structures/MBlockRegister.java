...
public class MBlockRegister {
    ...
    public static MultiMBlock SUPPLY_CRATES = new MultiMBlock(
            new Block[] { TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE,
                    TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE,
                    TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE },
            new int[] { 0, 1, 2, 3, 4, 5, 6, 7, 8 }, new int[] { 1, 1, 1, 1, 1, 1, 1, 1, 1 });

    public static MultiMBlock SUPPLY_CRATES_CHANCE = new MultiMBlock(
            new Block[] { TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE,
                    TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE,
                    TGBlocks.MILITARY_CRATE, TGBlocks.MILITARY_CRATE, Blocks.AIR },
    ...
    public static MBlock FACTORY_CRATE = new MBlock(TGBlocks.METAL_PANEL.getDefaultState()
            .withProperty(TGBlocks.METAL_PANEL.TYPE, TGMetalPanelType.CONTAINER_RED));
    ...
    public static MBlock FACTORY_SHINY_METAL = new MBlock(TGBlocks.METAL_PANEL,
            TGMetalPanelType.PANEL_LARGE_BORDER.ordinal());

    public static MBlock TECHNICAL_CONCRETE = new MBlock(TGBlocks.CONCRETE, 1); // new
                                                                                // MBlock(Blocks.CONCRETE,EnumDyeColor.GRAY.ordinal());
    public static MBlock TECHNICAL_BLOCK_SCAFFOLD = new MBlock(TGBlocks.METAL_PANEL.getDefaultState()
            .withProperty(TGBlocks.METAL_PANEL.TYPE, TGMetalPanelType.STEELFRAME_SCAFFOLD));
    public static MBlock TECHNICAL_PIPES = new MBlock(TGBlocks.CONCRETE,
            EnumConcreteType.CONCRETE_BROWN_PIPES.ordinal());
    public static MBlock TECHNICAL_GRATE = new MBlock(TGBlocks.METAL_PANEL, TGMetalPanelType.STEELFRAME_DARK.ordinal());

    public static MBlock TECHNICAL2_SCAFFOLD_TRANSPARENT = new MBlock(TGBlocks.METAL_PANEL,
            TGMetalPanelType.STEELFRAME_SCAFFOLD.ordinal());
    ...
    public static MBlock ALUMINIUM_STAIRS_WEST = new MBlock(
            TGBlocks.METAL_STAIRS.getDefaultState().withProperty(TGBlocks.METAL_STAIRS.FACING, EnumFacing.WEST)
                    .withProperty(TGBlocks.METAL_STAIRS.HALF, EnumHalf.BOTTOM));
    public static MBlock ALUMINIUM_STAIRS_EAST = new MBlock(
            TGBlocks.METAL_STAIRS.getDefaultState().withProperty(TGBlocks.METAL_STAIRS.FACING, EnumFacing.EAST)
                    .withProperty(TGBlocks.METAL_STAIRS.HALF, EnumHalf.BOTTOM));
    ...
    public static MBlock MILBASE_ROADBLOCK_SECONDARY = new MBlock(TGBlocks.CONCRETE, 2); // new
                                                                                         // MBlock(Blocks.CONCRETE.getDefaultState().withProperty(BlockColored.COLOR,
                                                                                         // EnumDyeColor.GRAY));
    ...
    // cobblestone
    public static MultiMBlock COBBLESTONE_MOSSY_RND = new MultiMBlock(
            new Block[] { Blocks.COBBLESTONE, Blocks.MOSSY_COBBLESTONE }, new int[] { 0, 0 }, new int[] { 2, 1 });
    public static MBlock COBBLESTONE_FLOOR = new MBlock(Blocks.STONE.getDefaultState());

    // limestone
    public static MBlock STONEBRICK_STAIRS_NORTH_INV = new MBlock(Blocks.STONE_BRICK_STAIRS.getDefaultState()
            .withProperty(BlockHorizontal.FACING, EnumFacing.NORTH).withProperty(BlockStairs.HALF, EnumHalf.TOP)); // new
                                                                                                                   // MultiMBlock(new
                                                                                                                   // Block[]{ChiselBlocks.limestoneStairs[0],
                                                                                                                   // ChiselBlocks.limestoneStairs[3]},new
                                                                                                                   // int[]{8,0},
                                                                                                                   // new
                                                                                                                   // int[]{1,1})
    public static MBlock STONEBRICK_STAIRS_SOUTH_INV = new MBlock(Blocks.STONE_BRICK_STAIRS.getDefaultState()
            .withProperty(BlockHorizontal.FACING, EnumFacing.SOUTH).withProperty(BlockStairs.HALF, EnumHalf.TOP)); // new
                                                                                                                   // MultiMBlock(new
                                                                                                                   // Block[]{ChiselBlocks.limestoneStairs[0],
                                                                                                                   // ChiselBlocks.limestoneStairs[3]},new
                                                                                                                   // int[]{8,0},
    ...
    public static MBlock STONEBRICK_STAIRS_EAST_CRACKED_RND = new MultiMBlock(
            new Block[] { Blocks.STONE_BRICK_STAIRS, Blocks.AIR },
            new int[] { Blocks.STONE_BRICK_STAIRS.getMetaFromState(
                    Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(BlockHorizontal.FACING, EnumFacing.EAST)),
                    0 },
            new int[] { 4, 1 });
    public static MBlock STONEBRICK_STAIRS_WEST_CRACKED_RND = new MultiMBlock(
            new Block[] { Blocks.STONE_BRICK_STAIRS, Blocks.AIR },
            new int[] { Blocks.STONE_BRICK_STAIRS.getMetaFromState(
                    Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(BlockHorizontal.FACING, EnumFacing.WEST)),
                    0 },
            new int[] { 4, 1 });

    public static MBlock STONEBRICK_STAIRS_EAST_CRACKED_INV_RND = new MultiMBlock(
            new Block[] { Blocks.STONE_BRICK_STAIRS, Blocks.AIR },
            new int[] { Blocks.STONE_BRICK_STAIRS.getMetaFromState(
                    Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(BlockHorizontal.FACING, EnumFacing.EAST)
                    ...
                    0 },
            new int[] { 4, 1 });
    public static MBlock STONEBRICK_STAIRS_WEST_CRACKED_INV_RND = new MultiMBlock(
            new Block[] { Blocks.STONE_BRICK_STAIRS, Blocks.AIR },
            new int[] { Blocks.STONE_BRICK_STAIRS.getMetaFromState(
                    Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(BlockHorizontal.FACING, EnumFacing.WEST)
                            .withProperty(BlockStairs.HALF, EnumHalf.TOP)),
    ...
    public static MBlock STONEBRICK_CRACKED_RND = new MultiMBlock(
            new Block[] { Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.STONEBRICK, Blocks.AIR },
            new int[] { 0, 1, 2, 0 }, new int[] { 3, 3, 3, 2 }); // new MultiMBlock(new
                                                                 // Block[]{ChiselBlocks.limestone,ChiselBlocks.limestone,Blocks.AIR},new
                                                                 // int[]{1,6,0}, new int[]{2,2,1})

    // bricks
    public static MBlock BRICKS_CRACKED_RND = new MBlock(Blocks.BRICK_BLOCK, 0); // new MultiMBlock(new
                                                                                 // Block[]{ChiselBlocks.brickCustom,ChiselBlocks.brickCustom},new
                                                                                 // int[]{3,5}, new int[]{2,2})
