...
public class SurvivorHideout extends WorldgenStructure {
    ...
    static {
        ...
        blockList.add(new MultiMMBlockIndexRoll(
                new MBlock[] { new MBlock(TGBlocks.METAL_PANEL, 0), new MBlock(TGBlocks.METAL_PANEL, 1),
                        new MBlock(TGBlocks.METAL_PANEL, 2), new MBlock(TGBlocks.METAL_PANEL, 3) },
                new int[] { 1, 1, 1, 1 }));// new MBlock("techguns:metalpanel", 0));
        ...
        blockList.add(new MBlockTGSpawner(EnumMonsterSpawnerType.HOLE, 2, 1, 200, 1).addMobType(Bandit.class, 1)
                .setWeaponOverride(new ItemStack(TGuns.boltaction)));
