...
public class FactoryHouseSmall extends WorldgenStructure {
    ...
    static {
        ...
        blockList.add(new MBlock(
                TGBlocks.BUNKER_DOOR.getDefaultState().withProperty(TGBlocks.BUNKER_DOOR.FACING, EnumFacing.SOUTH)
                        .withProperty(TGBlocks.BUNKER_DOOR.HINGE, EnumHingePosition.LEFT)
                        .withProperty(TGBlocks.BUNKER_DOOR.HALF, EnumDoorHalf.LOWER)));// TGBlocks.BUNKER_DOOR, 7));
        blockList.add(new MBlock(
                TGBlocks.BUNKER_DOOR.getDefaultState().withProperty(TGBlocks.BUNKER_DOOR.FACING, EnumFacing.SOUTH)
                        .withProperty(TGBlocks.BUNKER_DOOR.HINGE, EnumHingePosition.LEFT)
                        .withProperty(TGBlocks.BUNKER_DOOR.HALF, EnumDoorHalf.UPPER)));// TGBlocks.BUNKER_DOOR, 8));
        ...
        blockList.add(new MBlock(
                TGBlocks.LADDER_0.getDefaultState().withProperty(TGBlocks.LADDER_0.FACING, EnumFacing.SOUTH)));
