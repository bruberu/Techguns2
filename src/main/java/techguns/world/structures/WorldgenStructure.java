...
public abstract class WorldgenStructure {
    ...
    public static BiomeDictionary.Type[] sandTypes = { BiomeDictionary.Type.SANDY, BiomeDictionary.Type.SAVANNA.BEACH,
     ...
     * @param rnd       TODO
     */
    public abstract void setBlocks(World world, int posX, int posY, int posZ, int sizeX, int sizeY, int sizeZ,
                                   int direction, BiomeColorType colorType, Random rnd);
    ...
    public void spawnStructureWorldgen(World world, int chunkX, int chunkZ, int sizeX, int sizeY, int sizeZ, Random rnd,
        ...
        int y = BlockUtils.getValidSpawnYArea(world, x + offsetX, z + offsetZ, sizeXr, sizeZr, this.heightdiffLimit,
                getStep());
    ...
    public void spawnStructureCaveWorldgen(World world, int chunkX, int chunkZ, int sizeX, int sizeY, int sizeZ,
                                           Random rnd, Biome biome) {
        int direction = rnd.nextInt(4);
        ...
        // int y =BlockUtils.getValidSpawnYArea(world, x+offsetX, z+offsetZ, sizeXr,
        // sizeZr,this.heightdiffLimit,getStep());
        int y = BlockUtils.getCaveHeight(world, chunkX, chunkZ, 10, WorldGenTGStructureSpawn.NETHER_STRUCT_MIN_Y,
                WorldGenTGStructureSpawn.NETHER_STRUCT_MAX_y);
