...
public class SmallTrainstation extends WorldgenStructure {
    ...
    static {
        ...
        blockList.add(
                new MultiMBlock(new Block[] { Blocks.GLASS_PANE, Blocks.AIR }, new int[] { 4, 0 }, new int[] { 1, 1 }));

        blockList.add(MBlockRegister.STONEBRICK_STAIRS_WEST_CRACKED_INV_RND);// new MultiMBlock(new
                                                                             // Block[]{ChiselBlocks.limestoneStairs[0],
                                                                             // ChiselBlocks.limestoneStairs[3],
                                                                             // Blocks.AIR},new int[]{13,5,0}, new
                                                                             // int[]{2,2,1}));
        ...
        blockList.add(MBlockRegister.STONEBRICK_STAIRS_SOUTH_INV); // new MultiMBlock(new
                                                                   // Block[]{ChiselBlocks.limestoneStairs[0],
                                                                   // ChiselBlocks.limestoneStairs[3], Blocks.air},new
                                                                   // int[]{14,6,0}, new int[]{2,2,1}, new
                                                                   // BlockType[]{BlockType.STAIRS2_CHISEL,BlockType.STAIRS,
                                                                   // BlockType.TG}, new boolean[]{true,true,false}));

        // blockList.add(new MBlock(Block.getBlockFromName("tile.chisel.limestone_stairs.0"), 15));
        blockList.add(MBlockRegister.STONEBRICK_STAIRS_NORTH_INV);// new MultiMBlock(new
                                                                  // Block[]{ChiselBlocks.limestoneStairs[0],
                                                                  // ChiselBlocks.limestoneStairs[3], Blocks.AIR},new
                                                                  // int[]{15,7,0}, new int[]{2,2,1}, new
                                                                  // BlockType[]{BlockType.STAIRS2_CHISEL,BlockType.STAIRS,
                                                                  // BlockType.TG}, new boolean[]{true,true,false}));
        ...
        blockList.add(MBlockRegister.STONEBRICK_STAIRS_EAST_CRACKED_INV_RND);// new MultiMBlock(new
                                                                             // Block[]{ChiselBlocks.limestoneStairs[0],
                                                                             // ChiselBlocks.limestoneStairs[3],
                                                                             // Blocks.AIR},new int[]{12,4,0}, new
                                                                             // int[]{2,2,1}, new
                                                                             // BlockType[]{BlockType.STAIRS2_CHISEL,BlockType.STAIRS,
                                                                             // BlockType.TG}, new
        ...
        blockList.add(MBlockRegister.STONEBRICK_STAIRS_WEST_CRACKED_RND); // new MultiMBlock(new
                                                                          // Block[]{ChiselBlocks.limestoneStairs[0],
                                                                          // ChiselBlocks.limestoneStairs[3],
                                                                          // Blocks.AIR},new int[]{9,1,0}, new
                                                                          // int[]{2,2,1}, new
                                                                          // BlockType[]{BlockType.STAIRS2_CHISEL,BlockType.STAIRS,
                                                                          // BlockType.TG}, new
                                                                          // boolean[]{true,true,false}));
