...
public class NetherOreClusterSmall extends WorldgenStructure {
    ...
    static {
        ...
        blockList.add(new MultiMBlock(new Block[] { TGBlocks.ORE_CLUSTER, Blocks.NETHERRACK }, new int[] { 7, 0 },
                new int[] { 50, 50 }));
        blockList.add(new MBlock(TGBlocks.ORE_CLUSTER, 7));
        blockList.add(new MultiMBlock(new Block[] { TGBlocks.ORE_CLUSTER, Blocks.AIR }, new int[] { 7, 0 },
                new int[] { 50, 50 }));
    ...
    public void setBlocks(World world, int posX, int posY, int posZ, int sizeX, int sizeY, int sizeZ, int direction,
        ...
        BlockUtils.placeFoundationNether(world, blocks, blockList, posX, posY + hoffset, posZ, centerX, centerZ,
                direction, 0, 2);
        BlockUtils.placeScannedStructure(world, blocks, blockList, posX, posY + hoffset, posZ, centerX, centerZ,
                direction, 0, this.lootTier, colorType);
        BlockUtils.placeScannedStructure(world, blocks, blockList, posX, posY + hoffset, posZ, centerX, centerZ,
                direction, 1, this.lootTier, colorType);
    }
}
