...
public class TGStructureSpawnRegister {
    ...
    static {
        ...
        spawns_small.add(new TGStructureSpawn(new FactoryHouseSmall(8, 0, 7, 9, 5, 10).setXZSize(11, 10), 10, null,
                OVERWORLD, LAND, StructureSize.SMALL));
        spawns_small.add(new TGStructureSpawn(new SmallTrainstation(0, 0, 0, 0, 0, 0).setXZSize(11, 12), 10, null,
                OVERWORLD, LAND, StructureSize.SMALL));
        spawns_small.add(new TGStructureSpawn(new SmallMine().setXZSize(17, 11), 10, null, OVERWORLD, LAND,
                StructureSize.SMALL));
        spawns_small.add(new TGStructureSpawn(new GasStation(), 10, null, OVERWORLD, LAND, StructureSize.SMALL));

        // spawns_medium.add(new TGStructureSpawn(new HouseMedium(16, 12, 16, 16, 12, 16).setXZSize(16,
        // 16),1,null,OVERWORLD,LAND,StructureSize.MEDIUM));
        spawns_medium.add(new TGStructureSpawn(new AlienBugNestStructure().setXZSize(4, 4), 20, DESERTS_ONLY, OVERWORLD,
                LAND, StructureSize.MEDIUM));
        ...
        if (TGConfig.spawnOreClusterStructures) {
            spawns_medium.add(new TGStructureSpawn(new OreClusterSpike().setXZSize(8, 8), 10, null, OVERWORLD, LAND,
                    StructureSize.MEDIUM));
            spawns_medium.add(new TGStructureSpawn(new OreClusterMeteorBasis().setXZSize(17, 17), 5, null, OVERWORLD,
                    LAND, StructureSize.MEDIUM));

            if (TGFluids.OIL_WORLDSPAWN != null) {
                spawns_medium.add(new TGStructureSpawn(new DesertOilCluster().setXZSize(11, 11), 15, DESERTS_ONLY,
                        OVERWORLD, LAND, StructureSize.MEDIUM));
            }
        }

        // spawns_medium.add(new TGStructureSpawn(new BigBunker(32,14,17,32,14,17).setXZSize(32, 17), 1, null,
        // OVERWORLD, LAND, StructureSize.MEDIUM));

        spawns_big.add(new TGStructureSpawn(new MilitaryBaseStructure(0, 0, 0, 0, 0, 0), 1, null, OVERWORLD, LAND,
                StructureSize.BIG));

        spawns_big.add(new TGStructureSpawn(new CastleStructure(), 1, null, OVERWORLD, LAND, StructureSize.BIG));

        spawns_big.add(new TGStructureSpawn(new AircraftCarrier(54, 24, 21, 54, 24, 21).setXZSize(54, 21), 1, null,
                OVERWORLD, WATER, StructureSize.BIG));

        // NETHER

        spawns_small.add(new TGStructureSpawn(new NetherAltarSmall().setXZSize(11, 11), 10, null, NETHER, LAND,
                StructureSize.SMALL));
        spawns_small.add(new TGStructureSpawn(new NetherSoulPlatform().setXZSize(11, 11), 10, null, NETHER, LAND,
                StructureSize.SMALL));
        spawns_small.add(
                new TGStructureSpawn(new NetherLoot01().setXZSize(6, 6), 10, null, NETHER, LAND, StructureSize.SMALL));
        spawns_small.add(new TGStructureSpawn(new NetherAcidHole().setXZSize(9, 9), 10, null, NETHER, LAND,
                StructureSize.SMALL));

        if (TGConfig.spawnOreClusterStructures) {
            spawns_small.add(new TGStructureSpawn(new NetherOreClusterSmall().setXZSize(3, 3), 10, null, NETHER, LAND,
                    StructureSize.SMALL));
        }

        spawns_medium.add(new TGStructureSpawn(new NetherAltarMedium().setXZSize(16, 16), 10, null, NETHER, LAND,
                StructureSize.MEDIUM));
        spawns_medium.add(new TGStructureSpawn(new NetherGhastSpawner().setXZSize(10, 10), 10, null, NETHER, LAND,
                StructureSize.MEDIUM));

        if (TGConfig.spawnOreClusterStructures) {
            spawns_medium.add(new TGStructureSpawn(new NetherOreClusterCastle().setXZSize(11, 11), 1000, null, NETHER,
                    LAND, StructureSize.MEDIUM));
        }
        ...
        // spawns_big.add(new TGStructureSpawn(new Submarine().setXZSize(33, 7),1,null, OVERWORLD, WATER,
        // StructureSize.BIG));
