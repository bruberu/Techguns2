...
public class TGStructureSpawn {
    ...
    public TGStructureSpawn(WorldgenStructure structure, int spawnWeight,
                            ArrayList<BiomeDictionary.Type> biomeWhitelist, ArrayList<Integer> dimensionIDs,
                            ArrayList<StructureLandType> allowedTypes, StructureSize size) {
        super();
