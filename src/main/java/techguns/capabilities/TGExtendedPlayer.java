...
public class TGExtendedPlayer implements ITGExtendedPlayer {
    ...
    public static final DataParameter<ItemStack> DATA_FACE_SLOT = EntityDataManager
            .<ItemStack>createKey(EntityPlayer.class, DataSerializers.ITEM_STACK);
    public static final DataParameter<ItemStack> DATA_BACK_SLOT = EntityDataManager
            .<ItemStack>createKey(EntityPlayer.class, DataSerializers.ITEM_STACK);
    public static final DataParameter<ItemStack> DATA_HAND_SLOT = EntityDataManager
            .<ItemStack>createKey(EntityPlayer.class, DataSerializers.ITEM_STACK);

    public static final DataParameter<Boolean> DATA_FLAG_CHARGING_WEAPON = EntityDataManager
            .<Boolean>createKey(EntityPlayer.class, DataSerializers.BOOLEAN);
    ...
    public void saveToNBT(NBTTagCompound tags) {
        ...
        byte data = DataUtil.compress(this.enableJetpack, this.enableNightVision, this.enableSafemode,
                this.enableStepAssist, this.showTGHudElements, this.enableHovermode);
    ...
    public void setJumpkeyPressed(boolean isJumpkeyPressed) {
         ...
         * jetPackLoop = new TGSound(TGSounds.JETPACK_LOOP, this.entity, 1.0f, 1.0f, true, true, false,
         * TGSoundCategory.PLAYER_EFFECT);
         * SoundUtil.playSoundAtEntityPos(this.entity.world, this.entity, TGSounds.JETPACK_START, 1.0f, 1.0f, false,
         * TGSoundCategory.PLAYER_EFFECT);
         ...
         * jetPackLoop=null;
         * SoundUtil.playSoundAtEntityPos(this.entity.world, this.entity, TGSounds.JETPACK_END, 1.0f, 1.0f, false,
         * TGSoundCategory.PLAYER_EFFECT);
         * }
         * }
         * 
            ...
            if (!player.world.getGameRules().getBoolean("keepInventory")) {
                ...
                for (i = 0; i < this.tg_inventory.inventory.size(); ++i) {
                    if (!this.tg_inventory.inventory.get(i).isEmpty()) {
                        // System.out.println("Dropping "+TG_inventory.inventory[i].getDisplayName()+"
                        // x"+TG_inventory.inventory[i].stackSize);
