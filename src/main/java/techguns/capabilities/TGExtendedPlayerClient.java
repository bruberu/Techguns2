    ...
    public void setJumpkeyPressed(boolean isJumpkeyPressed) {
        if (this.entity.world.isRemote) {
            if (isJumpkeyPressed == true && jetPackLoop == null) {
                jetPackLoop = new TGSound(TGSounds.JETPACK_LOOP, this.entity, 0.75f, 1.0f, true, true, false,
                        TGSoundCategory.PLAYER_EFFECT);
                SoundUtil.playSoundAtEntityPos(this.entity.world, this.entity, TGSounds.JETPACK_START, 0.75f, 1.0f,
                        false, TGSoundCategory.PLAYER_EFFECT);
            ...
            if (isJumpkeyPressed && !this.isJumpkeyPressed) {
                ...
                if (jetPackLoop != null) {
                    ...
                    jetPackLoop = null;
                    SoundUtil.playSoundAtEntityPos(this.entity.world, this.entity, TGSounds.JETPACK_END, 0.75f, 1.0f,
                            false, TGSoundCategory.PLAYER_EFFECT);
                }
            }
