...
public class TGBlocks implements ITGInitializer {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        MULTIBLOCK_MACHINE = new MultiBlockMachine<EnumMultiBlockMachineType>("multiblockmachine",
                EnumMultiBlockMachineType.class);
        ...
        LAMP_0 = (BlockTGLamp<EnumLampType>) new BlockTGLamp<EnumLampType>("lamp0", EnumLampType.class)
                .setHardness(4.0f);
        METAL_PANEL = (GenericBlockMetaEnum) new GenericBlockMetaEnumCamoChangeable<TGMetalPanelType>("metalpanel",
                Material.IRON, Material.IRON.getMaterialMapColor(), SoundType.METAL, TGMetalPanelType.class)
                        .setHardness(8.0f);
        NETHER_METAL = (GenericBlockMetaEnum) new GenericBlockMetaEnumCamoChangeableLightlevel<EnumNetherMetalType>(
                "nethermetal", Material.IRON, Material.IRON.getMaterialMapColor(), SoundType.METAL,
                EnumNetherMetalType.class).setHardness(8.0f);

        CONCRETE = (GenericBlockMetaEnum<EnumConcreteType>) new GenericBlockMetaEnumCamoChangeable<EnumConcreteType>(
                "concrete", Material.ROCK, EnumConcreteType.class).setHardness(8.0f);
        LADDER_0 = (BlockTGLadder<EnumLadderType>) new BlockTGLadder<EnumLadderType>("ladder0", EnumLadderType.class)
                .setHardness(6.0f);
        DOOR3x3 = (BlockTGDoor3x3<EnumDoorType>) new BlockTGDoor3x3<EnumDoorType>("door3x3", EnumDoorType.class,
                TGItems.DOOR3x3).setHardness(6.0f);
        ...
        METAL_STAIRS = (BlockTGStairs) new BlockTGStairs("stairs_metal", Material.IRON, SoundType.METAL)
                .setHardness(8.0f);
        CONCRETE_STAIRS = (BlockTGStairs) new BlockTGStairs("stairs_concrete", Material.ROCK, SoundType.STONE)
                .setHardness(6.0f);

        MONSTER_SPAWNER = new BlockTGSpawner("tg_spawner");

        NEONLIGHT_BLOCK = (GenericBlockMetaEnumCamoChangeable<EnumLightblockType>) new GenericBlockMetaEnumCamoChangeable<EnumLightblockType>(
                "neonlights", Material.GLASS, MapColor.YELLOW, SoundType.GLASS, EnumLightblockType.class)
                        .setLightLevel(1f).setHardness(4.0f);

        MILITARY_CRATE = (BlockMilitaryCrate) new BlockMilitaryCrate("military_crate", Material.WOOD).setHardness(4.0f);

        EXPLOSIVE_CHARGE = new BlockExplosiveCharge<EnumExplosiveChargeType>("explosive_charge",
                EnumExplosiveChargeType.class);
    ...
    public void init(FMLInitializationEvent event) {
        ...
        for (EnumLadderType t : EnumLadderType.values()) {
            ChiselIMCHelper.addChiselVariation("techguns:metalladder", TGBlocks.LADDER_0.getRegistryName(),
