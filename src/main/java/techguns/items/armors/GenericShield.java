...
public class GenericShield extends ItemShield implements ICamoChangeable {
    ...
    protected static DecimalFormat formatReduction = new DecimalFormat("#.##",
    ...
    public void initModel() {
        ModelLoader.setCustomModelResourceLocation(this, 0,
                new ModelResourceLocation(new ResourceLocation("minecraft:shield"), "inventory"));
    }
    ...
    public void addInformation(ItemStack item, World worldIn, List<String> list, ITooltipFlag flagIn) {
        ...
        if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) || Keyboard.isKeyDown(Keyboard.KEY_RSHIFT)) {
            ...
            list.add(ChatFormatting.DARK_GRAY + " AR: " +
                    formatReduction.format(s.getReductionPercentAgainstType(DamageType.PHYSICAL)) + "%");
            list.add(ChatFormatting.GRAY + " PR: " +
                    formatReduction.format(s.getReductionPercentAgainstType(DamageType.PROJECTILE)) + "%");
            list.add(ChatFormatting.DARK_RED + " EX: " +
                    formatReduction.format(s.getReductionPercentAgainstType(DamageType.EXPLOSION)) + "%");
            list.add(ChatFormatting.DARK_AQUA + " E: " +
                    formatReduction.format(s.getReductionPercentAgainstType(DamageType.ENERGY)) + "%");

            list.add(ChatFormatting.RED + " F: " +
                    formatReduction.format(s.getReductionPercentAgainstType(DamageType.FIRE)) + "%");
            list.add(ChatFormatting.AQUA + " I: " +
                    formatReduction.format(s.getReductionPercentAgainstType(DamageType.ICE)) + "%");
            list.add(ChatFormatting.YELLOW + " L: " +
                    formatReduction.format(s.getReductionPercentAgainstType(DamageType.LIGHTNING)) + "%");
            list.add(ChatFormatting.DARK_GREEN + " P: " +
                    formatReduction.format(s.getReductionPercentAgainstType(DamageType.POISON)) + "%");
            list.add(ChatFormatting.DARK_GRAY + " D: " +
                    formatReduction.format(s.getReductionPercentAgainstType(DamageType.DARK)) + "%");
            list.add(ChatFormatting.GREEN + " RAD: " +
                    formatReduction.format(s.getReductionPercentAgainstType(DamageType.RADIATION)) + "%");
