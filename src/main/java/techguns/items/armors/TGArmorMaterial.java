...
public class TGArmorMaterial {
     ...
     * 
     * Set the armor values with standard factors, phys and proj are equal to armor, rad/poison are 0, all others are
     * 0.75*armor;
     * 
     * @param armor
     * @return
     */
    public TGArmorMaterial(String name, int baseDurability, int enchantability, float armor, SoundEvent equipSound,
                           float toughness) {
     ...
     * @return
     */
    public TGArmorMaterial(String modid, String name, int baseDurability, int enchantability, float armor,
    ...
    public ArmorMaterial createVanillaMaterial() {
        ...
        return EnumHelper.addArmorMaterial(name, this.modid + ":" + this.texture, baseDur, new int[] { 0, 0, 0, 0 },
                enchantability, equipSound, toughness);
    }
