...
public class AmmoTypes implements ITGInitializer {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        ASSAULT_RIFLE_MAGAZINE = new AmmoType(TGItems.ASSAULTRIFLE_MAGAZINE, TGItems.ASSAULTRIFLE_MAGAZINE_EMPTY,
                TGItems.RIFLE_ROUNDS, 3);
        ASSAULT_RIFLE_MAGAZINE.addVariant(TYPE_INCENDIARY, TGItems.ASSAULTRIFLE_MAGAZINE_INCENDIARY,
                TGItems.RIFLE_ROUNDS_INCENDIARY);

        PISTOL_MAGAZINE = new AmmoType(TGItems.PISTOL_MAGAZINE, TGItems.PISTOL_MAGAZINE_EMPTY, TGItems.PISTOL_ROUNDS,
                3);
        PISTOL_MAGAZINE.addVariant(TYPE_INCENDIARY, TGItems.PISTOL_MAGAZINE_INCENDIARY,
                TGItems.PISTOL_ROUNDS_INCENDIARY);
        ...
        COMPRESSED_AIR_TANK = new AmmoType(TGItems.COMPRESSED_AIR_TANK, TGItems.COMPRESSED_AIR_TANK_EMPTY,
                ItemStack.EMPTY, 0);
        ...
        ADVANCED_MAGAZINE = new AmmoType(TGItems.ADVANCED_MAGAZINE, TGItems.ADVANCED_MAGAZINE_EMPTY,
                TGItems.ADVANCED_ROUNDS, 3);
        ...
        NUCLEAR_POWER_CELL = new AmmoType(TGItems.NUCLEAR_POWERCELL, TGItems.NUCLEAR_POWERCELL_EMPTY, ItemStack.EMPTY,
                0);

        AMMO_GAUSS_RIFLE = new AmmoType(new ItemStack[] { TGItems.GAUSSRIFLE_SLUGS, TGItems.ENERGY_CELL },
                new ItemStack[] { ItemStack.EMPTY, TGItems.ENERGY_CELL_EMPTY },
                new ItemStack[] { TGItems.GAUSSRIFLE_SLUGS, ItemStack.EMPTY }, 1);
    }
