        ...
        if (player.world.isRemote) {
            ...
            if (player instanceof EntityPlayer) {
                if (epc.lockOnTicks >= this.lockOnTicks) {
                    if (count % 4 == 0) SoundUtil.playSoundOnEntityGunPosition(player.world, player,
                            TGSounds.LOCKED_BEEP, SOUND_DISTANCE, 1.0F, false, false, TGSoundCategory.PLAYER_EFFECT);
                } else if (epc.lockOnTicks > 0) {
                    if (count % 4 == 0) SoundUtil.playSoundOnEntityGunPosition(player.world, player,
                            TGSounds.LOCKON_BEEP, SOUND_DISTANCE, 1.0F, false, false, TGSoundCategory.PLAYER_EFFECT);
                } else {
                    if (count % 12 == 0) SoundUtil.playSoundOnEntityGunPosition(player.world, player,
                            TGSounds.LOCKON_BEEP, SOUND_DISTANCE, 0.5F, false, false, TGSoundCategory.PLAYER_EFFECT);
                }
            }
        }
    }
