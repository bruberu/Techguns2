...
public class ItemRadpills extends GenericItemConsumable {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(ChatFormatting.BLUE + TextUtil.trans("techguns.radresistance") + " " +
                TextUtil.trans("potion.potency.2") + " (180s)");
        tooltip.add(ChatFormatting.BLUE + TextUtil.trans("techguns.radregeneration") + " " +
                TextUtil.trans("potion.potency.1") + " (-50)");
    }
}
