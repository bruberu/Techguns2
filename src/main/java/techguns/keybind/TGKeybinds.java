...
public class TGKeybinds {
    ...
    public static void init() {
        KEY_TOGGLE_NIGHTVISION = new KeyBinding("techguns.key.toggleNightvision", Keyboard.KEY_N,
                "techguns.key.categories.techguns");
        KEY_TOGGLE_SAFEMODE = new KeyBinding("techguns.key.toggleSafemode", Keyboard.KEY_B,
                "techguns.key.categories.techguns");
        KEY_TOGGLE_STEPASSIST = new KeyBinding("techguns.key.toggleStepassist", Keyboard.KEY_V,
                "techguns.key.categories.techguns");
        KEY_FORCE_RELOAD = new KeyBinding("techguns.key.forceReload", Keyboard.KEY_R,
                "techguns.key.categories.techguns");
        KEY_TOGGLE_JETPACK = new KeyBinding("techguns.key.toggleJetpack", Keyboard.KEY_J,
                "techguns.key.categories.techguns");
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        if (KEY_TOGGLE_NIGHTVISION.isPressed()) {
             ...
             * TechgunsExtendedPlayerProperties.get(Minecraft.getMinecraft().thePlayer);
             * if (props!=null){
            ...
            if (props != null) {
                ...
                boolean canReloadOffhand = GunManager.canUseOffhand(stack_main, stack_off, ply) &&
                        this.canReloadGun(props, ply, stack_off, EnumHand.OFF_HAND);
