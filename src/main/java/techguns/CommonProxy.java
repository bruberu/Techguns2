...
public abstract class CommonProxy implements ITGInitializer {
    ...
    public static void registerPotionTypes(RegistryEvent.Register<PotionType> event) {
        ...
        TGRadiationSystem.RAD_POTION_SEVERE = new PotionType(
                new PotionEffect(TGRadiationSystem.radiation_effect, 300, 24))
                        .setRegistryName(Techguns.MODID, "radpotion_severe");

        TGRadiationSystem.RAD_REGENERATION_POTION = new PotionType(
                new PotionEffect(TGRadiationSystem.radregen_effect, 400, 9))
                        .setRegistryName(Techguns.MODID, "radregenerationpotion");

        TGRadiationSystem.RAD_RESISTANCE_POTION = new PotionType(
                new PotionEffect(TGRadiationSystem.radresistance_effect, 900, 1))
    ...
    public void registerCapabilities() {
        CapabilityManager.INSTANCE.register(ITGExtendedPlayer.class, new TGExtendedPlayerStorage(),
                () -> new TGExtendedPlayer(null));
        CapabilityManager.INSTANCE.register(ITGShooterValues.class, new TGShooterValuesStorage(), TGShooterValues::new);
        CapabilityManager.INSTANCE.register(TGSpawnerNPCData.class, new TGSpawnerNPCDataStorage(),
                TGSpawnerNPCData::new);
    }
    ...
    public void handleSoundEvent(EntityPlayer ply, int entityId, SoundEvent soundname, float volume, float pitch,
                                 boolean repeat, boolean moving, boolean gunPosition, boolean playOnOwnPlayer,
                                 TGSoundCategory soundCategory, EntityCondition condition) {}
