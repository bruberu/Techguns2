...
public class MathUtil {
    ...
    public static Vec3d rotateVector(Vec3d vec, Vec3d axis, double theta) {
        ...
        double xPrime = u * (u * vec.x + v * vec.y + w * vec.z) * (1d - Math.cos(theta)) + vec.x * Math.cos(theta) +
                (-w * vec.y + v * vec.z) * Math.sin(theta);
        double yPrime = v * (u * vec.x + v * vec.y + w * vec.z) * (1d - Math.cos(theta)) + vec.y * Math.cos(theta) +
                (w * vec.x - u * vec.z) * Math.sin(theta);
        double zPrime = w * (u * vec.x + v * vec.y + w * vec.z) * (1d - Math.cos(theta)) + vec.z * Math.cos(theta) +
