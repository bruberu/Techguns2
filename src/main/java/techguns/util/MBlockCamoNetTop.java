...
public class MBlockCamoNetTop extends MBlock {
    ...
    protected static IBlockState DESERT = TGBlocks.CAMONET_TOP.getDefaultState().withProperty(TGBlocks.CAMONET_TOP.TYPE,
            EnumCamoNetType.DESERT);
    protected static IBlockState SNOW = TGBlocks.CAMONET_TOP.getDefaultState().withProperty(TGBlocks.CAMONET_TOP.TYPE,
            EnumCamoNetType.SNOW);;
