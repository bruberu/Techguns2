...
public class TabRegistry {
    ...
    public static int getPotionOffset() {
         ...
         * and in GuiRecipeBook.updateScreenPosition() it takes no account of potion offset even if the recipe book is
         * inactive.
         * 
    ...
    public static int getRecipeBookOffset(GuiInventory gui) {
        ...
        gui.func_194310_f().func_194303_a(gui.width, gui.height, mc, widthTooNarrow,
                ((ContainerPlayer) gui.inventorySlots).craftMatrix);
        return gui.func_194310_f().updateScreenPosition(widthTooNarrow, gui.width, gui.getXSize()) -
                (gui.width - 176) / 2;
    }
}
